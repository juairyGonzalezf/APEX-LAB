...
,p_authentication_id=>wwv_flow_imp.id(114626392810634814)
...
,p_security_scheme=>wwv_flow_imp.id(114921724132635768)
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(114627195165634819)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_imp.id(114791400989635075)
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(114916519111635697)
,p_nav_bar_list_template_id=>wwv_flow_imp.id(114790998415635074)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(114627195165634819)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>16354120
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(114931311558635857)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(114932869511635868)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(114951910364635963)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(92336453949309762)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115162201313636577)
,p_list_item_display_sequence=>10000
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=&APP_ID.:10000:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-user-wrench'
,p_security_scheme=>wwv_flow_imp.id(114921580695635768)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(114916519111635697)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
,p_version_scn=>9001590
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115158401073636572)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115158785384636572)
,p_list_item_display_sequence=>20
...
,p_required_patch=>wwv_flow_imp.id(114919096734635750)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115159113286636573)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'About'
,p_list_item_icon=>'fa-question-circle-o'
,p_list_text_02=>'icon-only'
,p_required_patch=>wwv_flow_imp.id(114919625294635750)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115159669223636575)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Page Help'
,p_list_item_link_target=>'f?p=&APP_ID.:10061:&APP_SESSION.::&DEBUG.::P10061_PAGE_ID:&APP_PAGE_ID.'
,p_list_item_icon=>'fa-question-circle-o'
,p_parent_list_item_id=>wwv_flow_imp.id(115159113286636573)
,p_list_text_02=>'icon-only'
,p_required_patch=>wwv_flow_imp.id(114919625294635750)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115159981734636575)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115160385680636575)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115160765935636575)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115188025676636640)
,p_list_item_display_sequence=>1
,p_list_item_link_text=>'Settings'
,p_list_item_link_target=>'f?p=&APP_ID.:20000:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-gear'
,p_parent_list_item_id=>wwv_flow_imp.id(115160765935636575)
,p_required_patch=>wwv_flow_imp.id(115181631389636628)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115161249796636576)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115161618113636576)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(114984581764636071)
,p_name=>'Page Navigation'
,p_list_status=>'PUBLIC'
,p_version_scn=>9001128
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(114984984747636071)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Project_form'
,p_list_item_link_target=>'f?p=&APP_ID.:2:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-table'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(114985415485636072)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Project_Grid'
,p_list_item_link_target=>'f?p=&APP_ID.:4:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-table-pointer'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115163294125636579)
,p_name=>'Application Configuration'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(114919351169635750)
,p_version_scn=>9001553
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115163729408636581)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115164029619636582)
,p_name=>'User Interface'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(114919703900635750)
,p_version_scn=>9001553
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115164400945636582)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115164747355636583)
,p_name=>'Activity Reports'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(114919046833635750)
,p_version_scn=>9001553
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115165104077636583)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115165490423636583)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115165966564636583)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115166313463636583)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115166774345636583)
,p_list_item_display_sequence=>50
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115167150706636584)
,p_list_item_display_sequence=>60
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115167470930636584)
,p_name=>'Access Control'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(114918976069635750)
,p_version_scn=>9001553
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115167865018636584)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115168257404636584)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115168505853636584)
,p_name=>'Feedback'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(114919096734635750)
,p_version_scn=>9001553
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115168897821636584)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115185201448636634)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(115185671075636634)
,p_list_item_display_sequence=>10
...
,p_required_patch=>wwv_flow_imp.id(115181296425636628)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(114917574422635738)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(114917851423635741)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(114918138450635742)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(114918408755635742)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(114918721114635746)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(80995061346546263)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>16758811
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114622218421634807)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114622542132634809)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114622829028634809)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>8999125
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114623090209634809)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114623447160634809)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114623720554634810)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114624042426634810)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>8999125
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114624315330634810)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114624583874634810)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114624961767634810)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114625243213634810)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114625484760634810)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(114625849409634810)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(114921580695635768)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(114921724132635768)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(114921806060635768)
...
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(114921200088635762)
...
begin
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(114921441119635767)
...
begin
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(114921557902635768)
,p_static_id=>'READER'
,p_name=>'Reader'
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(114922649261635798)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(114922880119635800)
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(115099903932636454)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(114998718488636125)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(115107419051636471)
,p_lov_name=>'EMAIL_USERNAME_FORMAT'
,p_lov_query=>'.'||wwv_flow_imp.id(115107419051636471)||'.'
,p_location=>'STATIC'
,p_version_scn=>9001500
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115107754979636472)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(115124740628636510)
,p_lov_name=>'FEEDBACK_RATING'
,p_lov_query=>'.'||wwv_flow_imp.id(115124740628636510)||'.'
,p_location=>'STATIC'
,p_version_scn=>9001508
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115124985409636510)
,p_lov_disp_sequence=>1
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115125474301636510)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115125837907636511)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(115137060467636527)
,p_lov_name=>'FEEDBACK_STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(115137060467636527)||'.'
,p_location=>'STATIC'
,p_version_scn=>9001509
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115137371370636527)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'No Action'
,p_lov_return_value=>'0'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115137740873636527)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Acknowledged'
,p_lov_return_value=>'1'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115138085874636527)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Open'
,p_lov_return_value=>'3'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115138524697636527)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(115018304515636244)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(114999413470636142)
,p_lov_name=>'USER_THEME_PREFERENCE'
,p_lov_query=>'.'||wwv_flow_imp.id(114999413470636142)||'.'
,p_location=>'STATIC'
,p_version_scn=>9001157
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(114999728422636143)
,p_lov_disp_sequence=>1
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(115066761787636386)
,p_lov_name=>'VIEW_AS_REPORT_CHART'
,p_lov_query=>'.'||wwv_flow_imp.id(115066761787636386)||'.'
,p_location=>'STATIC'
,p_version_scn=>9001475
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115066986616636386)
,p_lov_disp_sequence=>1
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(115067458343636386)
,p_lov_disp_sequence=>2
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(114923242246635801)
,p_group_name=>'Administration'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(115181177642636628)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(114626778068634816)
,p_name=>'Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(92337307376309765)
,p_short_name=>'Employees Information'
,p_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>6
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(114626919996634817)
,p_short_name=>'Home'
,p_link=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(114950698041635952)
,p_short_name=>'Project_form'
,p_link=>'f?p=&APP_ID.:2:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>2
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(114965600708636010)
,p_short_name=>'Project_Grid'
,p_link=>'f?p=&APP_ID.:4:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>4
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(115163123134636578)
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114627480759634843)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114627795501634859)
,p_page_template_id=>wwv_flow_imp.id(114627480759634843)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114628170944634861)
,p_page_template_id=>wwv_flow_imp.id(114627480759634843)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114628422498634861)
,p_page_template_id=>wwv_flow_imp.id(114627480759634843)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114630398269634871)
,p_theme_id=>42
,p_name=>'Marquee'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114630710057634875)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114631011758634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114631343825634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114631643321634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114631918115634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114632259892634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114632521217634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114632869335634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114633172164634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114633447554634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114633745418634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114634022255634880)
,p_page_template_id=>wwv_flow_imp.id(114630398269634871)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114634440583634881)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114634748176634883)
,p_page_template_id=>wwv_flow_imp.id(114634440583634881)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114635010117634883)
,p_page_template_id=>wwv_flow_imp.id(114634440583634881)
,p_name=>'Dialog Header'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114635367525634886)
,p_page_template_id=>wwv_flow_imp.id(114634440583634881)
,p_name=>'Dialog Footer'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114635956504634887)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114636185973634887)
,p_page_template_id=>wwv_flow_imp.id(114635956504634887)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114636522879634887)
,p_page_template_id=>wwv_flow_imp.id(114635956504634887)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114636846862634887)
,p_page_template_id=>wwv_flow_imp.id(114635956504634887)
,p_name=>'Body Header'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114637099692634887)
,p_page_template_id=>wwv_flow_imp.id(114635956504634887)
,p_name=>'Body Footer'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114638487541634888)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114638841801634888)
,p_page_template_id=>wwv_flow_imp.id(114638487541634888)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114639134587634888)
,p_page_template_id=>wwv_flow_imp.id(114638487541634888)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114639387406634889)
,p_page_template_id=>wwv_flow_imp.id(114638487541634888)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114640015847634892)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114640325476634897)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'After Logo'
,p_placeholder=>'AFTER_LOGO'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114640627169634897)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'After Navigation Bar'
,p_placeholder=>'AFTER_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114640960336634897)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'BEFORE_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114641273467634897)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114641527678634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114641832948634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114642113581634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Dialogs, Drawers and Popups'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114642393817634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114642754995634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Top Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114643006042634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Banner'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114643311310634898)
,p_page_template_id=>wwv_flow_imp.id(114640015847634892)
,p_name=>'Full Width Content'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114643732727634898)
,p_theme_id=>42
,p_name=>'Right Side Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114644068045634898)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'After Logo'
,p_placeholder=>'AFTER_LOGO'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114644317702634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'After Navigation Bar'
,p_placeholder=>'AFTER_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114644663241634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'BEFORE_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114644961707634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114645181426634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114645541703634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114645789347634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Dialogs, Drawers and Popups'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114646173043634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114646381433634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Top Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114646763289634899)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Banner'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114647032226634900)
,p_page_template_id=>wwv_flow_imp.id(114643732727634898)
,p_name=>'Full Width Content'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114647381869634900)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114647697555634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'After Logo'
,p_placeholder=>'AFTER_LOGO'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114647980575634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'After Navigation Bar'
,p_placeholder=>'AFTER_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114648350959634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'BEFORE_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114648619560634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114648938075634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114649262525634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114649487588634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114649797421634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Dialogs, Drawers and Popups'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114650117001634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114650454061634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Top Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114650703955634902)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Banner'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114651002075634903)
,p_page_template_id=>wwv_flow_imp.id(114647381869634900)
,p_name=>'Full Width Content'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114651402524634903)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114651720481634907)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'After Logo'
,p_placeholder=>'AFTER_LOGO'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114652037560634907)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'After Navigation Bar'
,p_placeholder=>'AFTER_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114652356425634907)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'BEFORE_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114652664114634908)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114652949003634908)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114653210458634908)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Dialogs, Drawers and Popups'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114653483379634908)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114653800769634908)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Top Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114654148092634908)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Banner'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114654478117634909)
,p_page_template_id=>wwv_flow_imp.id(114651402524634903)
,p_name=>'Full Width Content'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(114654854063634909)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114655099657634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'After Logo'
,p_placeholder=>'AFTER_LOGO'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114655476927634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'After Navigation Bar'
,p_placeholder=>'AFTER_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114655757305634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'BEFORE_NAVIGATION_BAR'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114656046004634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114656304471634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114656665131634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Dialogs, Drawers and Popups'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114656970369634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114657231484634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Top Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114657550965634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Banner'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114657787985634911)
,p_page_template_id=>wwv_flow_imp.id(114654854063634909)
,p_name=>'Full Width Content'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(114802929028635087)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(114803604149635089)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114658241706634917)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114658535920634921)
,p_plug_template_id=>wwv_flow_imp.id(114658241706634917)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114658828487634924)
,p_plug_template_id=>wwv_flow_imp.id(114658241706634917)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114659088301634924)
,p_plug_template_id=>wwv_flow_imp.id(114658241706634917)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114659446302634925)
,p_plug_template_id=>wwv_flow_imp.id(114658241706634917)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114659703532634925)
,p_plug_template_id=>wwv_flow_imp.id(114658241706634917)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114659995700634925)
,p_plug_template_id=>wwv_flow_imp.id(114658241706634917)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114663420892634928)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114663735746634932)
,p_plug_template_id=>wwv_flow_imp.id(114663420892634928)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114663997818634932)
,p_plug_template_id=>wwv_flow_imp.id(114663420892634928)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114664324198634933)
,p_plug_template_id=>wwv_flow_imp.id(114663420892634928)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114664587599634933)
,p_plug_template_id=>wwv_flow_imp.id(114663420892634928)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114664865481634933)
,p_layout=>'TABLE'
,p_template=>'<div id="#REGION_STATIC_ID#" class="#REGION_CSS_CLASSES#" #REGION_LANDMARK_ATTRIBUTES# #REGION_ATTRIBUTES#>#PREVIOUS##BODY##SUB_REGIONS##NEXT#</div>'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114665160286634933)
,p_plug_template_id=>wwv_flow_imp.id(114664865481634933)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114665455220634933)
,p_plug_template_id=>wwv_flow_imp.id(114664865481634933)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114665741796634933)
,p_plug_template_id=>wwv_flow_imp.id(114664865481634933)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114666075772634933)
,p_plug_template_id=>wwv_flow_imp.id(114664865481634933)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114666231652634933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114666570880634933)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114666785394634933)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114667131626634933)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114667405514634933)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114667683601634934)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114668048125634934)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114668298985634934)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114668633982634934)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114668979029634934)
,p_plug_template_id=>wwv_flow_imp.id(114666231652634933)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114670563894634934)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114670870926634934)
,p_plug_template_id=>wwv_flow_imp.id(114670563894634934)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114671114723634935)
,p_plug_template_id=>wwv_flow_imp.id(114670563894634934)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114671470972634935)
,p_plug_template_id=>wwv_flow_imp.id(114670563894634934)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114672436611634942)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114672738563634947)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114673031730634950)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114673338241634950)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114673625624634950)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114673911160634950)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114674249425634954)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114674505932634954)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114674877282634954)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114675131544634954)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114675449228634954)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114675726693634954)
,p_plug_template_id=>wwv_flow_imp.id(114672436611634942)
,p_name=>'Slides'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114682336616634960)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114682593278634960)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114682890920634960)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114683238346634960)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114683544492634960)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114683852175634960)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114684175450634961)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114684419662634961)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114684750868634961)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Sort Order'
,p_placeholder=>'ORDER_BY_ITEM'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114685078995634961)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114685308401634961)
,p_plug_template_id=>wwv_flow_imp.id(114682336616634960)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114692122764634966)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114692405173634967)
,p_plug_template_id=>wwv_flow_imp.id(114692122764634966)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114692689682634967)
,p_plug_template_id=>wwv_flow_imp.id(114692122764634966)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114693049429634967)
,p_plug_template_id=>wwv_flow_imp.id(114692122764634966)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114693344724634967)
,p_plug_template_id=>wwv_flow_imp.id(114692122764634966)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114693583637634967)
,p_plug_template_id=>wwv_flow_imp.id(114692122764634966)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114693950899634967)
,p_plug_template_id=>wwv_flow_imp.id(114692122764634966)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114696679933634968)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114697030536634970)
,p_plug_template_id=>wwv_flow_imp.id(114696679933634968)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114697313199634970)
,p_plug_template_id=>wwv_flow_imp.id(114696679933634968)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114697672320634970)
,p_plug_template_id=>wwv_flow_imp.id(114696679933634968)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114697902885634971)
,p_plug_template_id=>wwv_flow_imp.id(114696679933634968)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114698227209634971)
,p_plug_template_id=>wwv_flow_imp.id(114696679933634968)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114700213081634971)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114700483712634971)
,p_plug_template_id=>wwv_flow_imp.id(114700213081634971)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
,p_has_region_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114700801149634971)
,p_plug_template_id=>wwv_flow_imp.id(114700213081634971)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114705588304634984)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114705962703634984)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114706235120634984)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114706548840634984)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114706857530634984)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114707146461634984)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114707429781634984)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114707770537634985)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114708062548634985)
,p_plug_template_id=>wwv_flow_imp.id(114705588304634984)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114710253939634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#_parent">',
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114710571727634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114710852592634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114711152651634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114711434243634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114711751853634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114712043432634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114712330296634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114712624320634989)
,p_plug_template_id=>wwv_flow_imp.id(114710253939634989)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114714836123634990)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#_parent">',
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114715170871634990)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114715424673634990)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114715713450634991)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114716029940634991)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114716356432634991)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114716654192634991)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114716945477634991)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114717233478634992)
,p_plug_template_id=>wwv_flow_imp.id(114714836123634990)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114720261633634994)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114720573248634994)
,p_plug_template_id=>wwv_flow_imp.id(114720261633634994)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114720792827634994)
,p_plug_template_id=>wwv_flow_imp.id(114720261633634994)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114721137509634994)
,p_plug_template_id=>wwv_flow_imp.id(114720261633634994)
,p_name=>'Sort Order'
,p_placeholder=>'ORDER_BY_ITEM'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114721452009634994)
,p_plug_template_id=>wwv_flow_imp.id(114720261633634994)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114721756910634994)
,p_plug_template_id=>wwv_flow_imp.id(114720261633634994)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114722298807634995)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114722678488634995)
,p_plug_template_id=>wwv_flow_imp.id(114722298807634995)
,p_name=>'Item'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
,p_has_region_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114722901015634995)
,p_plug_template_id=>wwv_flow_imp.id(114722298807634995)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114723267771634995)
,p_plug_template_id=>wwv_flow_imp.id(114722298807634995)
,p_name=>'Button Start'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114724810584634995)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114725115489634996)
,p_plug_template_id=>wwv_flow_imp.id(114724810584634995)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114725425017634996)
,p_plug_template_id=>wwv_flow_imp.id(114724810584634995)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114725740935634996)
,p_plug_template_id=>wwv_flow_imp.id(114724810584634995)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114726045342634996)
,p_plug_template_id=>wwv_flow_imp.id(114724810584634995)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114726282842634996)
,p_plug_template_id=>wwv_flow_imp.id(114724810584634995)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114727360201634996)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114727653257634996)
,p_plug_template_id=>wwv_flow_imp.id(114727360201634996)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114727936503634996)
,p_plug_template_id=>wwv_flow_imp.id(114727360201634996)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114728225708634996)
,p_plug_template_id=>wwv_flow_imp.id(114727360201634996)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114730045758634998)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114730331397634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114730643514634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114730925036634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114731204053634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114731487104634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114731810794634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114732120246634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114732478290634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114732740567634998)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114733062790634999)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Sort Order'
,p_placeholder=>'ORDER_BY_ITEM'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114733326798634999)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114733630994634999)
,p_plug_template_id=>wwv_flow_imp.id(114730045758634998)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114739845161635004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114740115485635005)
,p_plug_template_id=>wwv_flow_imp.id(114739845161635004)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114740409440635005)
,p_plug_template_id=>wwv_flow_imp.id(114739845161635004)
,p_name=>'Tabs'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114742391945635005)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114742680281635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114743005034635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Change'
,p_placeholder=>'CHANGE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114743295877635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114743669070635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114743941637635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114744187406635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Delete'
,p_placeholder=>'DELETE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114744563274635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114744842858635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114745113616635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114745469292635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114745748652635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Search Field and Smart Filters'
,p_placeholder=>'SMART_FILTERS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114746057032635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114746315557635006)
,p_plug_template_id=>wwv_flow_imp.id(114742391945635005)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(114747540960635009)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114747852765635010)
,p_plug_template_id=>wwv_flow_imp.id(114747540960635009)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114748166087635010)
,p_plug_template_id=>wwv_flow_imp.id(114747540960635009)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114748451354635010)
,p_plug_template_id=>wwv_flow_imp.id(114747540960635009)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114748690178635010)
,p_plug_template_id=>wwv_flow_imp.id(114747540960635009)
,p_name=>'Previous'
,p_placeholder=>'PREVIOUS'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(114748999023635010)
,p_plug_template_id=>wwv_flow_imp.id(114747540960635009)
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114775408585635044)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114779458512635052)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114785027195635068)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114786583827635069)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114789461949635070)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114790428178635074)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114790998415635074)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114791400989635075)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114793242640635076)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114794873983635076)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114796784080635078)
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114797814762635078)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(114799439570635079)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114750000744635018)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114750206713635020)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114754237044635022)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114759672325635028)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114760846196635029)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114764063358635032)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114765258352635032)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114768210246635034)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114768426678635034)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114771001644635037)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114771460011635039)
...
begin
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(114773654940635039)
...
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114800804265635081)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114800922177635083)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114801032573635083)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114801084727635083)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114801249721635083)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114801964481635084)
...
begin
wwv_flow_imp_shared.create_field_template(
 p_id=>wwv_flow_imp.id(114802399590635084)
...
wwv_flow_imp_shared.create_menu_template(
 p_id=>wwv_flow_imp.id(114805227208635090)
,p_name=>'Breadcrumb'
...
wwv_flow_imp_shared.create_popup_lov_template(
 p_id=>wwv_flow_imp.id(114805437345635105)
,p_page_name=>'winlov'
...
wwv_flow_imp_shared.create_calendar_template(
 p_id=>wwv_flow_imp.id(114805335445635091)
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(114893706660635666)
,p_theme_id=>42
...
,p_is_locked=>false
,p_current_theme_style_id=>wwv_flow_imp.id(114892919236635656)
,p_default_page_template=>wwv_flow_imp.id(114654854063634909)
,p_default_dialog_template=>wwv_flow_imp.id(114634440583634881)
,p_error_template=>wwv_flow_imp.id(114635956504634887)
,p_printer_friendly_template=>wwv_flow_imp.id(114654854063634909)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_imp.id(114635956504634887)
,p_default_button_template=>wwv_flow_imp.id(114803604149635089)
,p_default_region_template=>wwv_flow_imp.id(114730045758634998)
,p_default_chart_template=>wwv_flow_imp.id(114730045758634998)
,p_default_form_template=>wwv_flow_imp.id(114730045758634998)
,p_default_reportr_template=>wwv_flow_imp.id(114730045758634998)
,p_default_tabform_template=>wwv_flow_imp.id(114730045758634998)
,p_default_wizard_template=>wwv_flow_imp.id(114730045758634998)
,p_default_menur_template=>wwv_flow_imp.id(114742391945635005)
,p_default_listr_template=>wwv_flow_imp.id(114730045758634998)
,p_default_irr_template=>wwv_flow_imp.id(114720261633634994)
,p_default_report_template=>wwv_flow_imp.id(114768426678635034)
,p_default_label_template=>wwv_flow_imp.id(114801084727635083)
,p_default_menu_template=>wwv_flow_imp.id(114805227208635090)
,p_default_calendar_template=>wwv_flow_imp.id(114805335445635091)
,p_default_list_template=>wwv_flow_imp.id(114785027195635068)
,p_default_nav_list_template=>wwv_flow_imp.id(114796784080635078)
,p_default_top_nav_list_temp=>wwv_flow_imp.id(114796784080635078)
,p_default_side_nav_list_temp=>wwv_flow_imp.id(114791400989635075)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_imp.id(114666231652634933)
,p_default_dialogr_template=>wwv_flow_imp.id(114663420892634928)
,p_default_option_label=>wwv_flow_imp.id(114801084727635083)
,p_default_required_label=>wwv_flow_imp.id(114802399590635084)
,p_default_navbar_list_template=>wwv_flow_imp.id(114790998415635074)
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(114892679662635655)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(114892919236635656)
,p_theme_id=>42
,p_name=>'Vita'
,p_is_public=>true
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(114893115440635657)
,p_theme_id=>42
,p_name=>'Vita - Dark'
,p_is_public=>true
,p_is_accessible=>false
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(114893331382635657)
,p_theme_id=>42
,p_name=>'Vita - Red'
,p_is_public=>true
,p_is_accessible=>false
...
wwv_flow_imp_shared.create_theme_style(
 p_id=>wwv_flow_imp.id(114893525041635657)
,p_theme_id=>42
,p_name=>'Vita - Slate'
,p_is_public=>true
,p_is_accessible=>false
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114628756349634865)
,p_theme_id=>42
,p_name=>'DIALOG_SIZE'
,p_display_name=>'Size'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114629688161634871)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114637403472634887)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114638248794634888)
,p_theme_id=>42
,p_name=>'PAGE_LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114660537623634926)
,p_theme_id=>42
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114660898074634926)
,p_theme_id=>42
,p_name=>'ALERT_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114661569411634926)
,p_theme_id=>42
,p_name=>'ALERT_ICONS'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114661887103634926)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114669244436634934)
,p_theme_id=>42
,p_name=>'STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114669642592634934)
,p_theme_id=>42
,p_name=>'BODY_PADDING'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114676033565634955)
,p_theme_id=>42
,p_name=>'TIMER'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114676816228634955)
,p_theme_id=>42
,p_name=>'BODY_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114678024499634956)
,p_theme_id=>42
,p_name=>'ACCENT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114679268813634956)
,p_theme_id=>42
,p_name=>'HEADER'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114679654391634956)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114681635871634957)
,p_theme_id=>42
,p_name=>'ANIMATION'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114689434627634962)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114689800534634964)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114690657688634965)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114694439470634967)
,p_theme_id=>42
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114695218144634968)
,p_theme_id=>42
,p_name=>'HEADING_FONT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114695997837634968)
,p_theme_id=>42
,p_name=>'BODY_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114698500951634971)
,p_theme_id=>42
,p_name=>'DISPLAY_ICON'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114699285593634971)
,p_theme_id=>42
,p_name=>'ICON_SHAPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114701092078634972)
,p_theme_id=>42
,p_name=>'IMAGE_FILTER'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114702708449634983)
,p_theme_id=>42
,p_name=>'IMAGE_RATIO'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114703902993634983)
,p_theme_id=>42
,p_name=>'IMAGE_SCALE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114704947075634984)
,p_theme_id=>42
,p_name=>'IMAGE_SHAPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114708713861634988)
,p_theme_id=>42
,p_name=>'DIALOG_SIZE'
,p_display_name=>'Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114714140408634990)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114717544873634992)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114723481190634995)
,p_theme_id=>42
,p_name=>'ALIGNMENT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114726611549634996)
,p_theme_id=>42
,p_name=>'LOGIN_HEADER'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114728700198634997)
,p_theme_id=>42
,p_name=>'ICON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114729534932634997)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114740755270635005)
,p_theme_id=>42
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114741129347635005)
,p_theme_id=>42
,p_name=>'TAB_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114741910101635005)
,p_theme_id=>42
,p_name=>'TABS_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114749323987635014)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114750571256635020)
,p_theme_id=>42
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114750936121635021)
,p_theme_id=>42
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114752929754635021)
,p_theme_id=>42
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114754713217635022)
,p_theme_id=>42
,p_name=>'BODY_TEXT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114756547936635024)
,p_theme_id=>42
,p_name=>'ANIMATION'
,p_display_name=>'Animation'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114757362484635026)
,p_theme_id=>42
,p_name=>'ICONS'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114758771543635027)
,p_theme_id=>42
,p_name=>'ICON_SHAPE'
,p_display_name=>'Icon Shape'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114759886645635028)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114761088212635031)
,p_theme_id=>42
,p_name=>'COL_ACTIONS'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114761485331635031)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114761929409635031)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114762340523635031)
,p_theme_id=>42
,p_name=>'COL_ICON'
,p_display_name=>'Icon'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114762722243635032)
,p_theme_id=>42
,p_name=>'COL_MISC'
,p_display_name=>'Misc'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114763175557635032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114763680064635032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114764340844635032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114764728249635032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114766906866635034)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114768696821635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114769332536635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114769761827635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114771744262635039)
,p_theme_id=>42
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114775768927635049)
,p_theme_id=>42
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114776938196635049)
,p_theme_id=>42
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114778142388635051)
,p_theme_id=>42
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114779908465635055)
,p_theme_id=>42
,p_name=>'BODY_TEXT'
,p_display_name=>'Body Text'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114781923338635067)
,p_theme_id=>42
,p_name=>'ANIMATION'
,p_display_name=>'Animation'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114782575912635067)
,p_theme_id=>42
,p_name=>'ICONS'
,p_display_name=>'Icons'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114783935252635068)
,p_theme_id=>42
,p_name=>'ICON_SHAPE'
,p_display_name=>'Icon Shape'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114786121888635069)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114788363808635069)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114792135200635075)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114798116724635079)
,p_theme_id=>42
,p_name=>'MOBILE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114798707294635079)
,p_theme_id=>42
,p_name=>'DESKTOP'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114799738464635079)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114801398993635083)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114803172895635089)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114804375844635089)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114893899294635674)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114895298820635674)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114895697273635675)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114897291028635675)
,p_theme_id=>42
,p_name=>'LEFT_MARGIN'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114897698440635675)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114899352268635678)
,p_theme_id=>42
,p_name=>'RIGHT_MARGIN'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114899717646635679)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114901339493635679)
,p_theme_id=>42
,p_name=>'TOP_MARGIN'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114901722420635679)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114903337390635680)
,p_theme_id=>42
,p_name=>'TYPE'
,p_display_name=>'Type'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114903706136635680)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114904086777635680)
,p_theme_id=>42
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114904578466635680)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114904944631635680)
,p_theme_id=>42
,p_name=>'SPACING_TOP'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114905301139635680)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114905686824635681)
,p_theme_id=>42
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114907088220635681)
,p_theme_id=>42
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114908544115635681)
,p_theme_id=>42
,p_name=>'WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114909688814635682)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114910111930635682)
,p_theme_id=>42
,p_name=>'ITEM_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114910530134635682)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114910955441635682)
,p_theme_id=>42
,p_name=>'ITEM_PADDING'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114911694985635683)
,p_theme_id=>42
,p_name=>'ITEM_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114912329060635684)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114912749178635684)
,p_theme_id=>42
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114913351008635684)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114913776175635684)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114914118871635684)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114914952852635687)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114915294462635687)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(114915923500635687)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114628907512634866)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114628756349634865)
,p_template_types=>'PAGE'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114629128309634868)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114629330079634871)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114629502592634871)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114629922243634871)
,p_theme_id=>42
,p_name=>'POSITION_END'
,p_display_name=>'End'
,p_display_sequence=>20
...
,p_group_id=>wwv_flow_imp.id(114629688161634871)
,p_template_types=>'PAGE'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114630138502634871)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114630363384634871)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114634281309634881)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114635648782634887)
,p_theme_id=>42
,p_name=>'REMOVE_BODY_PADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114635850608634887)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114637676890634887)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114637403472634887)
,p_template_types=>'PAGE'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114637845930634888)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114638039838634888)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114638423146634888)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114638248794634888)
,p_template_types=>'PAGE'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114639751692634892)
,p_theme_id=>42
,p_name=>'REMOVE_BODY_PADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114639965525634892)
,p_theme_id=>42
,p_name=>'STRETCH_TO_FIT_WINDOW'
,p_display_name=>'Stretch to Fit Window'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114643639617634898)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114647351783634900)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114651378050634903)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114654753838634909)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114658103005634912)
,p_theme_id=>42
,p_name=>'STICKY_HEADER_ON_MOBILE'
,p_display_name=>'Sticky Header on Mobile'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114660330842634926)
,p_theme_id=>42
,p_name=>'COLOREDBACKGROUND'
,p_display_name=>'Highlight Background'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(114658241706634917)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114660770320634926)
,p_theme_id=>42
,p_name=>'DANGER'
...
,p_group_id=>wwv_flow_imp.id(114660537623634926)
,p_template_types=>'REGION'
,p_help_text=>'Show an error or danger alert.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114661148073634926)
,p_theme_id=>42
,p_name=>'HIDDENHEADER'
...
,p_group_id=>wwv_flow_imp.id(114660898074634926)
,p_template_types=>'REGION'
,p_help_text=>'Visually hides the alert title, but assistive technologies can still read it.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114661287524634926)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114661751216634926)
,p_theme_id=>42
,p_name=>'HIDE_ICONS'
...
,p_group_id=>wwv_flow_imp.id(114661569411634926)
,p_template_types=>'REGION'
,p_help_text=>'Hides alert icons'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114662168639634926)
,p_theme_id=>42
,p_name=>'HORIZONTAL'
...
,p_group_id=>wwv_flow_imp.id(114661887103634926)
,p_template_types=>'REGION'
,p_help_text=>'Show horizontal alert with buttons to the right.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114662362802634926)
,p_theme_id=>42
,p_name=>'INFORMATION'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114662520346634927)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114662729972634927)
,p_theme_id=>42
,p_name=>'SUCCESS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114662913334634927)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114663159186634927)
,p_theme_id=>42
,p_name=>'WARNING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114663336995634928)
,p_theme_id=>42
,p_name=>'WIZARD'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114669431515634934)
,p_theme_id=>42
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(114666231652634933)
,p_css_classes=>'t-ButtonRegion--noBorder'
,p_group_id=>wwv_flow_imp.id(114669244436634934)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114669859980634934)
,p_theme_id=>42
,p_name=>'NOPADDING'
...
,p_group_id=>wwv_flow_imp.id(114669642592634934)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114670054813634934)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114670272406634934)
,p_theme_id=>42
,p_name=>'SLIMPADDING'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114670406418634934)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114671707846634935)
,p_theme_id=>42
,p_name=>'APPLY_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(114670563894634934)
,p_css_classes=>'u-colors'
,p_template_types=>'REGION'
,p_help_text=>'Applies the colors from the theme''s color palette to the icons or initials within cards.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114671939955634935)
,p_theme_id=>42
,p_name=>'STYLE_A'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114672126069634942)
,p_theme_id=>42
,p_name=>'STYLE_B'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114672361095634942)
,p_theme_id=>42
,p_name=>'STYLE_C'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114676229158634955)
,p_theme_id=>42
,p_name=>'10_SECONDS'
,p_display_name=>'10 Seconds'
,p_display_sequence=>20
,p_region_template_id=>wwv_flow_imp.id(114672436611634942)
,p_css_classes=>'js-cycle10s'
,p_group_id=>wwv_flow_imp.id(114676033565634955)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114676416051634955)
,p_theme_id=>42
,p_name=>'15_SECONDS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114676612589634955)
,p_theme_id=>42
,p_name=>'20_SECONDS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114677027308634955)
,p_theme_id=>42
,p_name=>'240PX'
...
,p_group_id=>wwv_flow_imp.id(114676816228634955)
,p_template_types=>'REGION'
,p_help_text=>'Sets region body height to 240px.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114677226219634955)
,p_theme_id=>42
,p_name=>'320PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114677479420634955)
,p_theme_id=>42
,p_name=>'480PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114677676365634955)
,p_theme_id=>42
,p_name=>'5_SECONDS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114677801847634956)
,p_theme_id=>42
,p_name=>'640PX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114678203492634956)
,p_theme_id=>42
,p_name=>'ACCENT_1'
...
,p_group_id=>wwv_flow_imp.id(114678024499634956)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114678428923634956)
,p_theme_id=>42
,p_name=>'ACCENT_2'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114678587392634956)
,p_theme_id=>42
,p_name=>'ACCENT_3'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114678803699634956)
,p_theme_id=>42
,p_name=>'ACCENT_4'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114679007827634956)
,p_theme_id=>42
,p_name=>'ACCENT_5'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114679465027634956)
,p_theme_id=>42
,p_name=>'HIDDENHEADERNOAT'
,p_display_name=>'Hidden'
,p_display_sequence=>10
...
,p_group_id=>wwv_flow_imp.id(114679268813634956)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114679782353634956)
,p_theme_id=>42
,p_name=>'HIDEOVERFLOW'
,p_display_name=>'Hide'
,p_display_sequence=>10
...
,p_group_id=>wwv_flow_imp.id(114679654391634956)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114680050970634957)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114680270455634957)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114680430992634957)
,p_theme_id=>42
,p_name=>'NOBORDER'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114680648074634957)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114680843903634957)
,p_theme_id=>42
,p_name=>'SCROLLBODY'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114681018226634957)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114681226223634957)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114681473068634957)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114681806841634957)
,p_theme_id=>42
,p_name=>'SLIDE'
...
,p_group_id=>wwv_flow_imp.id(114681635871634957)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114682022149634958)
,p_theme_id=>42
,p_name=>'SPIN'
,p_display_name=>'Spin'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114682195720634958)
,p_theme_id=>42
,p_name=>'STACKED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114685657921634961)
,p_theme_id=>42
,p_name=>'240PX'
,p_display_name=>'240px'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114682336616634960)
,p_css_classes=>'i-h240'
,p_group_id=>wwv_flow_imp.id(114676816228634955)
,p_template_types=>'REGION'
,p_help_text=>'Sets region body height to 240px.'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114685846194634961)
,p_theme_id=>42
,p_name=>'320PX'
,p_display_name=>'320px'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114685983517634961)
,p_theme_id=>42
,p_name=>'480PX'
,p_display_name=>'480px'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114686279430634961)
,p_theme_id=>42
,p_name=>'640PX'
,p_display_name=>'640px'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114686408211634961)
,p_theme_id=>42
,p_name=>'ACCENT_1'
,p_display_name=>'Accent 1'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114686673295634961)
,p_theme_id=>42
,p_name=>'ACCENT_10'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114686837600634961)
,p_theme_id=>42
,p_name=>'ACCENT_11'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114687068444634961)
,p_theme_id=>42
,p_name=>'ACCENT_12'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114687239820634961)
,p_theme_id=>42
,p_name=>'ACCENT_13'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114687434220634962)
,p_theme_id=>42
,p_name=>'ACCENT_14'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114687669447634962)
,p_theme_id=>42
,p_name=>'ACCENT_15'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114687839132634962)
,p_theme_id=>42
,p_name=>'ACCENT_2'
,p_display_name=>'Accent 2'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114688078477634962)
,p_theme_id=>42
,p_name=>'ACCENT_3'
,p_display_name=>'Accent 3'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114688180583634962)
,p_theme_id=>42
,p_name=>'ACCENT_4'
,p_display_name=>'Accent 4'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114688462073634962)
,p_theme_id=>42
,p_name=>'ACCENT_5'
,p_display_name=>'Accent 5'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114688604325634962)
,p_theme_id=>42
,p_name=>'ACCENT_6'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114688788420634962)
,p_theme_id=>42
,p_name=>'ACCENT_7'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114689054277634962)
,p_theme_id=>42
,p_name=>'ACCENT_8'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114689215536634962)
,p_theme_id=>42
,p_name=>'ACCENT_9'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114689615600634962)
,p_theme_id=>42
,p_name=>'COLLAPSED'
...
,p_group_id=>wwv_flow_imp.id(114689434627634962)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114690076113634965)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114689800534634964)
,p_template_types=>'REGION'
,p_help_text=>'Position the expand / collapse button to the end of the region header.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114690187426634965)
,p_theme_id=>42
,p_name=>'EXPANDED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114690447707634965)
,p_theme_id=>42
,p_name=>'HIDEOVERFLOW'
,p_display_name=>'Hide'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114690829527634965)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114690657688634965)
,p_template_types=>'REGION'
,p_help_text=>'Use the plus and minus icons for the expand and collapse button.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114691038058634965)
,p_theme_id=>42
,p_name=>'NOBODYPADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114691273010634965)
,p_theme_id=>42
,p_name=>'NOBORDER'
,p_display_name=>'Remove Borders'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114691416683634965)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114691655974634965)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114691820644634966)
,p_theme_id=>42
,p_name=>'SCROLLBODY'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114692016916634966)
,p_theme_id=>42
,p_name=>'STACKED'
,p_display_name=>'Stack Region'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114694181862634967)
,p_theme_id=>42
,p_name=>'ADD_BODY_PADDING'
,p_display_name=>'Add Body Padding'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114692122764634966)
,p_css_classes=>'t-ContentBlock--padded'
,p_template_types=>'REGION'
,p_help_text=>'Adds padding to the region''s body container.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114694675789634967)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114694439470634967)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114694815920634968)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114695075899634968)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114695437864634968)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114695218144634968)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114695610808634968)
,p_theme_id=>42
,p_name=>'HIDDENHEADERNOAT'
,p_display_name=>'Hidden'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114695844095634968)
,p_theme_id=>42
,p_name=>'HIDEREGIONHEADER'
,p_display_name=>'Hidden but accessible'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114696246235634968)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114695997837634968)
,p_template_types=>'REGION'
,p_help_text=>'Gives the region body a slightly lighter background.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114696431983634968)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114696611042634968)
,p_theme_id=>42
,p_name=>'SHOW_REGION_ICON'
,p_display_name=>'Show Region Icon'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114698779113634971)
,p_theme_id=>42
,p_name=>'DISPLAY_ICON_NO'
,p_display_name=>'No'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114696679933634968)
,p_css_classes=>'t-HeroRegion--hideIcon'
,p_group_id=>wwv_flow_imp.id(114698500951634971)
,p_template_types=>'REGION'
,p_help_text=>'Hide the Hero Region icon.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114698895046634971)
,p_theme_id=>42
,p_name=>'FEATURED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114699089764634971)
,p_theme_id=>42
,p_name=>'HEADING_FONT_ALTERNATIVE'
,p_display_name=>'Alternative'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114699556288634971)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114699285593634971)
,p_template_types=>'REGION'
,p_help_text=>'The icons are displayed within a circle.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114699715713634971)
,p_theme_id=>42
,p_name=>'ICONS_SQUARE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114699972357634971)
,p_theme_id=>42
,p_name=>'REMOVE_BODY_PADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114700116683634971)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114701344619634972)
,p_theme_id=>42
,p_name=>'FILTER_BLUR'
,p_display_name=>'Blur'
,p_display_sequence=>430
,p_region_template_id=>wwv_flow_imp.id(114700213081634971)
,p_css_classes=>'t-ImageRegion--blur'
,p_group_id=>wwv_flow_imp.id(114701092078634972)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114701568217634972)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114701777977634972)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114701930919634982)
,p_theme_id=>42
,p_name=>'FILTER_NONE'
,p_display_name=>'None'
,p_display_sequence=>400
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114702131946634982)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114702284909634983)
,p_theme_id=>42
,p_name=>'FILTER_SEPIA'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114702498597634983)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114702904502634983)
,p_theme_id=>42
,p_name=>'RATIO_16_9'
...
,p_group_id=>wwv_flow_imp.id(114702708449634983)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114703158468634983)
,p_theme_id=>42
,p_name=>'RATIO_1_1'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114703345930634983)
,p_theme_id=>42
,p_name=>'RATIO_2_1'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114703541421634983)
,p_theme_id=>42
,p_name=>'RATIO_4_3'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114703707378634983)
,p_theme_id=>42
,p_name=>'RATIO_AUTO'
,p_display_name=>'Auto'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114704148973634983)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114703902993634983)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114704369138634984)
,p_theme_id=>42
,p_name=>'SCALE_COVER'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114704482429634984)
,p_theme_id=>42
,p_name=>'SCALE_DOWN'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114704716995634984)
,p_theme_id=>42
,p_name=>'SCALE_FILL'
,p_display_name=>'Fill'
,p_display_sequence=>220
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114705141049634984)
,p_theme_id=>42
,p_name=>'SHAPE_CIRCLE'
,p_display_name=>'Circle'
...
,p_group_id=>wwv_flow_imp.id(114704947075634984)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114705313128634984)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114705541640634984)
,p_theme_id=>42
,p_name=>'SHAPE_SQUARE'
,p_display_name=>'Square'
,p_display_sequence=>300
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114708288839634985)
,p_theme_id=>42
,p_name=>'AUTO_HEIGHT_INLINE_DIALOG'
,p_display_name=>'Auto Height'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(114705588304634984)
,p_css_classes=>'js-dialog-autoheight'
,p_template_types=>'REGION'
,p_help_text=>'This option will set the height of the dialog to fit its contents.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114708505978634988)
,p_theme_id=>42
,p_name=>'DRAGGABLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114708889627634988)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114708713861634988)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114709096559634988)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114709339842634988)
,p_theme_id=>42
,p_name=>'MODAL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114709513906634988)
,p_theme_id=>42
,p_name=>'NONE'
,p_display_name=>'None'
,p_display_sequence=>5
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114709704772634988)
,p_theme_id=>42
,p_name=>'REMOVE_BODY_PADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>5
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114709906256634988)
,p_theme_id=>42
,p_name=>'RESIZABLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114710172444634989)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114712888419634989)
,p_theme_id=>42
,p_name=>'DRAWER_SIZE_EXTRA_LARGE'
,p_display_name=>'Extra Large'
,p_display_sequence=>40
,p_region_template_id=>wwv_flow_imp.id(114710253939634989)
,p_css_classes=>'js-dialog-class-t-Drawer--xl'
,p_group_id=>wwv_flow_imp.id(114708713861634988)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114713157106634990)
,p_theme_id=>42
,p_name=>'DRAWER_SIZE_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114713356422634990)
,p_theme_id=>42
,p_name=>'DRAWER_SIZE_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114713531864634990)
,p_theme_id=>42
,p_name=>'DRAWER_SIZE_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114713698995634990)
,p_theme_id=>42
,p_name=>'MODAL'
,p_display_name=>'Modal'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114713908441634990)
,p_theme_id=>42
,p_name=>'NONE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114714324780634990)
,p_theme_id=>42
,p_name=>'POSITION_END'
,p_display_name=>'End'
,p_display_sequence=>20
,p_region_template_id=>wwv_flow_imp.id(114710253939634989)
,p_css_classes=>'js-dialog-class-t-Drawer--pullOutEnd'
,p_group_id=>wwv_flow_imp.id(114714140408634990)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114714509111634990)
,p_theme_id=>42
,p_name=>'POSITION_START'
,p_display_name=>'Start'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114714741413634990)
,p_theme_id=>42
,p_name=>'REMOVE_BODY_PADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>5
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114717684428634992)
,p_theme_id=>42
,p_name=>'ABOVE'
,p_display_name=>'Above'
,p_display_sequence=>30
,p_region_template_id=>wwv_flow_imp.id(114714836123634990)
,p_css_classes=>'js-popup-pos-above'
,p_group_id=>wwv_flow_imp.id(114717544873634992)
,p_template_types=>'REGION'
,p_help_text=>'Positions the callout above or typically on top of the parent.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114717976918634992)
,p_theme_id=>42
,p_name=>'AFTER'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114718175929634992)
,p_theme_id=>42
,p_name=>'AUTO_HEIGHT_INLINE_DIALOG'
,p_display_name=>'Auto Height'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114718341928634992)
,p_theme_id=>42
,p_name=>'BEFORE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114718569295634992)
,p_theme_id=>42
,p_name=>'BELOW'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114718770098634993)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114718956982634994)
,p_theme_id=>42
,p_name=>'INSIDE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114719138821634994)
,p_theme_id=>42
,p_name=>'LARGE_720X480'
,p_display_name=>'Large (720x480)'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114719369503634994)
,p_theme_id=>42
,p_name=>'MEDIUM_600X400'
,p_display_name=>'Medium (600x400)'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114719496084634994)
,p_theme_id=>42
,p_name=>'NONE'
,p_display_name=>'None'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114719720190634994)
,p_theme_id=>42
,p_name=>'REMOVE_BODY_PADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114719938404634994)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114720118520634994)
,p_theme_id=>42
,p_name=>'SMALL_480X320'
,p_display_name=>'Small (480x320)'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114722015097634994)
,p_theme_id=>42
,p_name=>'REMOVEBORDERS'
,p_display_name=>'Remove Borders'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114720261633634994)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114722265527634995)
,p_theme_id=>42
,p_name=>'SHOW_MAXIMIZE_BUTTON'
,p_display_name=>'Show Maximize Button'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114723741895634995)
,p_theme_id=>42
,p_name=>'ALIGNMENT_CENTER'
,p_display_name=>'Center'
,p_display_sequence=>11
,p_region_template_id=>wwv_flow_imp.id(114722298807634995)
,p_css_classes=>'t-ItemContainer--alignCenter'
,p_group_id=>wwv_flow_imp.id(114723481190634995)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114723928494634995)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114724141540634995)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114724327966634995)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114724558195634995)
,p_theme_id=>42
,p_name=>'STACK_MOBILE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114724767340634995)
,p_theme_id=>42
,p_name=>'WRAP_ITEMS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114726799000634996)
,p_theme_id=>42
,p_name=>'LOGIN_HEADER_ICON'
,p_display_name=>'Icon'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114724810584634995)
,p_css_classes=>'t-Login-region--headerIcon'
,p_group_id=>wwv_flow_imp.id(114726611549634996)
,p_template_types=>'REGION'
,p_help_text=>'Displays only the Region Icon in the Login region.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114727018659634996)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114727275293634996)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114728518861634997)
,p_theme_id=>42
,p_name=>'APPLY_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(114727360201634996)
,p_css_classes=>'u-colors'
,p_template_types=>'REGION'
,p_help_text=>'Applies the colors from the theme''s color palette to the icons or initials within search results.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114728891701634997)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114728700198634997)
,p_template_types=>'REGION'
,p_help_text=>'Sets the icon size to large (64px).'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114729165803634997)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114729281900634997)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114729722725634997)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114729534932634997)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114729971797634997)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114733944985634999)
,p_theme_id=>42
,p_name=>'240PX'
,p_display_name=>'240px'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114730045758634998)
,p_css_classes=>'i-h240'
,p_group_id=>wwv_flow_imp.id(114676816228634955)
,p_template_types=>'REGION'
,p_help_text=>'Sets region body height to 240px.'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114734091073634999)
,p_theme_id=>42
,p_name=>'320PX'
,p_display_name=>'320px'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114734295401634999)
,p_theme_id=>42
,p_name=>'480PX'
,p_display_name=>'480px'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114734530160634999)
,p_theme_id=>42
,p_name=>'640PX'
,p_display_name=>'640px'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114734778290634999)
,p_theme_id=>42
,p_name=>'ACCENT_1'
,p_display_name=>'Accent 1'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114734890883634999)
,p_theme_id=>42
,p_name=>'ACCENT_10'
,p_display_name=>'Accent 10'
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114735124830635001)
,p_theme_id=>42
,p_name=>'ACCENT_11'
,p_display_name=>'Accent 11'
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114735326408635001)
,p_theme_id=>42
,p_name=>'ACCENT_12'
,p_display_name=>'Accent 12'
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114735541610635001)
,p_theme_id=>42
,p_name=>'ACCENT_13'
,p_display_name=>'Accent 13'
,p_display_sequence=>130
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114735772125635001)
,p_theme_id=>42
,p_name=>'ACCENT_14'
,p_display_name=>'Accent 14'
,p_display_sequence=>140
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114735936982635001)
,p_theme_id=>42
,p_name=>'ACCENT_15'
,p_display_name=>'Accent 15'
,p_display_sequence=>150
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114736153156635001)
,p_theme_id=>42
,p_name=>'ACCENT_2'
,p_display_name=>'Accent 2'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114736284650635001)
,p_theme_id=>42
,p_name=>'ACCENT_3'
,p_display_name=>'Accent 3'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114736481496635001)
,p_theme_id=>42
,p_name=>'ACCENT_4'
,p_display_name=>'Accent 4'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114736747684635001)
,p_theme_id=>42
,p_name=>'ACCENT_5'
,p_display_name=>'Accent 5'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114736895412635002)
,p_theme_id=>42
,p_name=>'ACCENT_6'
,p_display_name=>'Accent 6'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114737141925635002)
,p_theme_id=>42
,p_name=>'ACCENT_7'
,p_display_name=>'Accent 7'
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114737365563635002)
,p_theme_id=>42
,p_name=>'ACCENT_8'
,p_display_name=>'Accent 8'
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114737534939635002)
,p_theme_id=>42
,p_name=>'ACCENT_9'
,p_display_name=>'Accent 9'
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114737718131635002)
,p_theme_id=>42
,p_name=>'HIDDENHEADERNOAT'
,p_display_name=>'Hidden'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114737956558635002)
,p_theme_id=>42
,p_name=>'HIDEOVERFLOW'
,p_display_name=>'Hide'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114738098664635002)
,p_theme_id=>42
,p_name=>'HIDEREGIONHEADER'
,p_display_name=>'Hidden but accessible'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114738355348635002)
,p_theme_id=>42
,p_name=>'NOBODYPADDING'
,p_display_name=>'Remove Body Padding'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114738523604635002)
,p_theme_id=>42
,p_name=>'NOBORDER'
,p_display_name=>'Remove Borders'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114738769655635004)
,p_theme_id=>42
,p_name=>'REMOVE_UI_DECORATION'
,p_display_name=>'Remove UI Decoration'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114738941495635004)
,p_theme_id=>42
,p_name=>'SCROLLBODY'
,p_display_name=>'Scroll - Default'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114739119858635004)
,p_theme_id=>42
,p_name=>'SHOW_MAXIMIZE_BUTTON'
,p_display_name=>'Show Maximize Button'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114739353248635004)
,p_theme_id=>42
,p_name=>'SHOW_REGION_ICON'
,p_display_name=>'Show Region Icon'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114739501333635004)
,p_theme_id=>42
,p_name=>'STACKED'
,p_display_name=>'Stack Region'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114739694617635004)
,p_theme_id=>42
,p_name=>'TEXT_CONTENT'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114740908578635005)
,p_theme_id=>42
,p_name=>'FILL_TAB_LABELS'
,p_display_name=>'Fill Tab Labels'
,p_display_sequence=>10
,p_region_template_id=>wwv_flow_imp.id(114739845161635004)
,p_css_classes=>'t-TabsRegion-mod--fillLabels'
,p_group_id=>wwv_flow_imp.id(114740755270635005)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114741344276635005)
,p_theme_id=>42
,p_name=>'PILL'
,p_display_name=>'Pill'
,p_display_sequence=>20
...
,p_group_id=>wwv_flow_imp.id(114741129347635005)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114741538633635005)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114741707974635005)
,p_theme_id=>42
,p_name=>'SIMPLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114742137584635005)
,p_theme_id=>42
,p_name=>'TABSLARGE'
,p_display_name=>'Large'
,p_display_sequence=>20
...
,p_group_id=>wwv_flow_imp.id(114741910101635005)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114742330610635005)
,p_theme_id=>42
,p_name=>'TABS_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114746610005635007)
,p_theme_id=>42
,p_name=>'GET_TITLE_FROM_BREADCRUMB'
,p_display_name=>'Use Current Breadcrumb Entry'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_imp.id(114742391945635005)
,p_css_classes=>'t-BreadcrumbRegion--useBreadcrumbTitle'
,p_group_id=>wwv_flow_imp.id(114694439470634967)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114746810641635007)
,p_theme_id=>42
,p_name=>'HEADING_FONT_ALTERNATIVE'
,p_display_name=>'Alternative'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114747061160635007)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114747209912635007)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114747417127635009)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114749548235635014)
,p_theme_id=>42
,p_name=>'HIDESMALLSCREENS'
,p_display_name=>'Small Screens (Tablet)'
,p_display_sequence=>20
,p_region_template_id=>wwv_flow_imp.id(114747540960635009)
,p_css_classes=>'t-Wizard--hideStepsSmall'
,p_group_id=>wwv_flow_imp.id(114749323987635014)
,p_template_types=>'REGION'
,p_help_text=>'Hides the wizard progress steps for screens that are smaller than 768px wide.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114749766396635018)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114749915789635018)
,p_theme_id=>42
,p_name=>'SHOW_TITLE'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114750698091635020)
,p_theme_id=>42
,p_name=>'128PX'
,p_display_name=>'128px'
,p_display_sequence=>50
,p_report_template_id=>wwv_flow_imp.id(114750206713635020)
,p_css_classes=>'t-BadgeList--xxlarge'
,p_group_id=>wwv_flow_imp.id(114750571256635020)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114751134576635021)
,p_theme_id=>42
,p_name=>'2COLUMNGRID'
...
,p_group_id=>wwv_flow_imp.id(114750936121635021)
,p_template_types=>'REPORT'
,p_help_text=>'Arrange badges in a two column grid'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114751336026635021)
,p_theme_id=>42
,p_name=>'32PX'
,p_display_name=>'32px'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114751524022635021)
,p_theme_id=>42
,p_name=>'3COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114751757508635021)
,p_theme_id=>42
,p_name=>'48PX'
,p_display_name=>'48px'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114751917741635021)
,p_theme_id=>42
,p_name=>'4COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114752175714635021)
,p_theme_id=>42
,p_name=>'5COLUMNGRID'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114752343869635021)
,p_theme_id=>42
,p_name=>'64PX'
,p_display_name=>'64px'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114752560941635021)
,p_theme_id=>42
,p_name=>'96PX'
,p_display_name=>'96px'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114752729674635021)
,p_theme_id=>42
,p_name=>'APPLY_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114753139967635021)
,p_theme_id=>42
,p_name=>'CIRCULAR'
...
,p_group_id=>wwv_flow_imp.id(114752929754635021)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114753308302635021)
,p_theme_id=>42
,p_name=>'FIXED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114753514605635021)
,p_theme_id=>42
,p_name=>'FLEXIBLEBOX'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114753778231635021)
,p_theme_id=>42
,p_name=>'FLOATITEMS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114753917008635022)
,p_theme_id=>42
,p_name=>'GRID'
,p_display_name=>'Grid'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114754159508635022)
,p_theme_id=>42
,p_name=>'STACKED'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114754546124635022)
,p_theme_id=>42
,p_name=>'2_COLUMNS'
,p_display_name=>'2 Columns'
,p_display_sequence=>15
,p_report_template_id=>wwv_flow_imp.id(114754237044635022)
,p_css_classes=>'t-Cards--cols'
,p_group_id=>wwv_flow_imp.id(114750936121635021)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114754935555635022)
,p_theme_id=>42
,p_name=>'2_LINES'
...
,p_group_id=>wwv_flow_imp.id(114754713217635022)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114755155663635022)
,p_theme_id=>42
,p_name=>'3_COLUMNS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114755286967635022)
,p_theme_id=>42
,p_name=>'3_LINES'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114755520707635022)
,p_theme_id=>42
,p_name=>'4_COLUMNS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114755729003635022)
,p_theme_id=>42
,p_name=>'4_LINES'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114755909044635022)
,p_theme_id=>42
,p_name=>'5_COLUMNS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114756136571635022)
,p_theme_id=>42
,p_name=>'BASIC'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114756312499635022)
,p_theme_id=>42
,p_name=>'BLOCK'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114756725315635024)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114756547936635024)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114756949728635024)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114757148332635026)
,p_theme_id=>42
,p_name=>'COMPACT'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114757573367635026)
,p_theme_id=>42
,p_name=>'DISPLAY_ICONS'
,p_display_name=>'Display Icons'
,p_display_sequence=>10
...
,p_group_id=>wwv_flow_imp.id(114757362484635026)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114757714197635026)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114757913585635026)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114758139199635026)
,p_theme_id=>42
,p_name=>'FEATURED'
,p_display_name=>'Featured'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114758285446635026)
,p_theme_id=>42
,p_name=>'FLOAT'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114758511379635026)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114758957913635027)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114758771543635027)
,p_template_types=>'REPORT'
,p_help_text=>'The icons are displayed within a square with rounded corners.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114759098786635027)
,p_theme_id=>42
,p_name=>'ICONS_SQUARE'
,p_display_name=>'Square'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114759370548635027)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114759559409635027)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114760148914635028)
,p_theme_id=>42
,p_name=>'BASIC'
,p_display_name=>'Basic'
,p_display_sequence=>10
,p_report_template_id=>wwv_flow_imp.id(114759672325635028)
,p_css_classes=>'t-Comments--basic'
,p_group_id=>wwv_flow_imp.id(114759886645635028)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114760366819635029)
,p_theme_id=>42
,p_name=>'ICONS_ROUNDED'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114760559027635029)
,p_theme_id=>42
,p_name=>'ICONS_SQUARE'
,p_display_name=>'Square'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114760745330635029)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114761330956635031)
,p_theme_id=>42
,p_name=>'ACTIONS_HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>60
,p_report_template_id=>wwv_flow_imp.id(114760846196635029)
,p_css_classes=>'t-ContentRow--hideActions'
,p_group_id=>wwv_flow_imp.id(114761088212635031)
,p_template_types=>'REPORT'
,p_help_text=>'Hides the Actions column from being rendered on the screen.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114761708049635031)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114761485331635031)
,p_template_types=>'REPORT'
,p_help_text=>'Aligns the content to the top of the row. This is useful when you expect that yours rows will vary in height (e.g. some rows will have longer descriptions than others).'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114762139349635031)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114761929409635031)
,p_template_types=>'REPORT'
,p_help_text=>'Hides the Description from being rendered on the screen.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114762536369635031)
,p_theme_id=>42
,p_name=>'ICON_HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>20
...
,p_group_id=>wwv_flow_imp.id(114762340523635031)
,p_template_types=>'REPORT'
,p_help_text=>'Hides the Icon from being rendered on the screen.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114762971054635032)
,p_theme_id=>42
,p_name=>'MISC_HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>50
...
,p_group_id=>wwv_flow_imp.id(114762722243635032)
,p_template_types=>'REPORT'
,p_help_text=>'Hides the Misc column from being rendered on the screen.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114763319774635032)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114763175557635032)
,p_template_types=>'REPORT'
,p_help_text=>'Hides the Selection column from being rendered on the screen.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114763491876635032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114763924074635032)
,p_theme_id=>42
,p_name=>'TITLE_HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>30
...
,p_group_id=>wwv_flow_imp.id(114763680064635032)
,p_template_types=>'REPORT'
,p_help_text=>'Hides the Title from being rendered on the screen.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114764534795635032)
,p_theme_id=>42
,p_name=>'DISPLAY_ITEMS_STACKED'
,p_display_name=>'Stacked'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(114764063358635032)
,p_css_classes=>'t-ContextualInfo-item--stacked'
,p_group_id=>wwv_flow_imp.id(114764340844635032)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114764887672635032)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114764728249635032)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114765174468635032)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114765497693635033)
,p_theme_id=>42
,p_name=>'2_COLUMN_GRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>10
,p_report_template_id=>wwv_flow_imp.id(114765258352635032)
,p_css_classes=>'t-MediaList--cols t-MediaList--2cols'
,p_group_id=>wwv_flow_imp.id(114750936121635021)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114765755843635033)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114765908240635033)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114766124456635033)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114766354373635033)
,p_theme_id=>42
,p_name=>'APPLY_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114766511617635033)
,p_theme_id=>42
,p_name=>'ICONS_ROUNDED'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114766720094635034)
,p_theme_id=>42
,p_name=>'ICONS_SQUARE'
,p_display_name=>'Square'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114767163295635034)
,p_theme_id=>42
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>20
...
,p_group_id=>wwv_flow_imp.id(114766906866635034)
,p_template_types=>'REPORT'
,p_help_text=>'Increases the size of the text and icons in the list.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114767314656635034)
,p_theme_id=>42
,p_name=>'SHOW_BADGES'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114767570165635034)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114767711636635034)
,p_theme_id=>42
,p_name=>'SHOW_ICONS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114767884035635034)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114768102877635034)
,p_theme_id=>42
,p_name=>'STACK'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114768925932635037)
,p_theme_id=>42
,p_name=>'ALTROWCOLORSDISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>20
,p_report_template_id=>wwv_flow_imp.id(114768426678635034)
,p_css_classes=>'t-Report--staticRowColors'
,p_group_id=>wwv_flow_imp.id(114768696821635037)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114769124518635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114769504149635037)
,p_theme_id=>42
,p_name=>'ENABLE'
,p_display_name=>'Enable'
,p_display_sequence=>10
...
,p_group_id=>wwv_flow_imp.id(114769332536635037)
,p_template_types=>'REPORT'
,p_help_text=>'Enable row highlighting on mouse over'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114769883202635037)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114769761827635037)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114770088308635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114770355156635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114770538087635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114770765659635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114770926728635037)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114771371995635037)
,p_theme_id=>42
,p_name=>'COMPACT'
,p_display_name=>'Compact'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_imp.id(114771001644635037)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114771916739635039)
,p_theme_id=>42
,p_name=>'FIXED_LARGE'
,p_display_name=>'Fixed - Large'
,p_display_sequence=>30
,p_report_template_id=>wwv_flow_imp.id(114771460011635039)
,p_css_classes=>'t-AVPList--fixedLabelLarge'
,p_group_id=>wwv_flow_imp.id(114771744262635039)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114772156157635039)
,p_theme_id=>42
,p_name=>'FIXED_MEDIUM'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114772293809635039)
,p_theme_id=>42
,p_name=>'FIXED_SMALL'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114772512448635039)
,p_theme_id=>42
,p_name=>'HIDE_EMPTY_VALUES'
,p_display_name=>'Hide Empty Values'
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114772709553635039)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114772966911635039)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114773085663635039)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114773284589635039)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114773536824635039)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114773905191635039)
,p_theme_id=>42
,p_name=>'FIXED_LARGE'
,p_display_name=>'Fixed - Large'
,p_display_sequence=>30
,p_report_template_id=>wwv_flow_imp.id(114773654940635039)
,p_css_classes=>'t-AVPList--fixedLabelLarge'
,p_group_id=>wwv_flow_imp.id(114771744262635039)
,p_template_types=>'REPORT'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114774177121635040)
,p_theme_id=>42
,p_name=>'FIXED_MEDIUM'
,p_display_name=>'Fixed - Medium'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114774315564635040)
,p_theme_id=>42
,p_name=>'FIXED_SMALL'
,p_display_name=>'Fixed - Small'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114774485759635040)
,p_theme_id=>42
,p_name=>'LEFT_ALIGNED_DETAILS'
,p_display_name=>'Left Aligned Details'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114774778134635040)
,p_theme_id=>42
,p_name=>'RIGHT_ALIGNED_DETAILS'
,p_display_name=>'Right Aligned Details'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114774886735635040)
,p_theme_id=>42
,p_name=>'VARIABLE_LARGE'
,p_display_name=>'Variable - Large'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114775117797635040)
,p_theme_id=>42
,p_name=>'VARIABLE_MEDIUM'
,p_display_name=>'Variable - Medium'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114775313133635040)
,p_theme_id=>42
,p_name=>'VARIABLE_SMALL'
,p_display_name=>'Variable - Small'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114775922504635049)
,p_theme_id=>42
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>20
,p_list_template_id=>wwv_flow_imp.id(114775408585635044)
,p_css_classes=>'t-BadgeList--cols'
,p_group_id=>wwv_flow_imp.id(114775768927635049)
,p_template_types=>'LIST'
,p_help_text=>'Arrange badges in a two column grid'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114776179236635049)
,p_theme_id=>42
,p_name=>'3COLUMNGRID'
,p_display_name=>'3 Column Grid'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114776288704635049)
,p_theme_id=>42
,p_name=>'4COLUMNGRID'
,p_display_name=>'4 Column Grid'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114776492020635049)
,p_theme_id=>42
,p_name=>'5COLUMNGRID'
,p_display_name=>'5 Column Grid'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114776708750635049)
,p_theme_id=>42
,p_name=>'APPLY_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114777124314635049)
,p_theme_id=>42
,p_name=>'CIRCULAR'
,p_display_name=>'Circular'
,p_display_sequence=>20
,p_list_template_id=>wwv_flow_imp.id(114775408585635044)
,p_css_classes=>'t-BadgeList--circular'
,p_group_id=>wwv_flow_imp.id(114776938196635049)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114777294322635049)
,p_theme_id=>42
,p_name=>'FIXED'
,p_display_name=>'Span Horizontally'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114777502142635051)
,p_theme_id=>42
,p_name=>'FLEXIBLEBOX'
,p_display_name=>'Flexible Box'
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114777745130635051)
,p_theme_id=>42
,p_name=>'FLOATITEMS'
,p_display_name=>'Float Items'
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114777964188635051)
,p_theme_id=>42
,p_name=>'GRID'
,p_display_name=>'Grid'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114778342358635051)
,p_theme_id=>42
,p_name=>'LARGE'
,p_display_name=>'64px'
,p_display_sequence=>30
,p_list_template_id=>wwv_flow_imp.id(114775408585635044)
,p_css_classes=>'t-BadgeList--large'
,p_group_id=>wwv_flow_imp.id(114778142388635051)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114778512168635051)
,p_theme_id=>42
,p_name=>'MEDIUM'
,p_display_name=>'48px'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114778768279635051)
,p_theme_id=>42
,p_name=>'SMALL'
,p_display_name=>'32px'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114778927389635051)
,p_theme_id=>42
,p_name=>'STACKED'
,p_display_name=>'Stacked'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114779161593635051)
,p_theme_id=>42
,p_name=>'XLARGE'
,p_display_name=>'96px'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114779371613635051)
,p_theme_id=>42
,p_name=>'XXLARGE'
,p_display_name=>'128px'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114779742615635055)
,p_theme_id=>42
,p_name=>'2_COLUMNS'
,p_display_name=>'2 Columns'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114779458512635052)
,p_css_classes=>'t-Cards--cols'
,p_group_id=>wwv_flow_imp.id(114775768927635049)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114780130225635055)
,p_theme_id=>42
,p_name=>'2_LINES'
,p_display_name=>'2 Lines'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114779458512635052)
,p_css_classes=>'t-Cards--desc-2ln'
,p_group_id=>wwv_flow_imp.id(114779908465635055)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114780325758635055)
,p_theme_id=>42
,p_name=>'3_COLUMNS'
,p_display_name=>'3 Columns'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114780571470635055)
,p_theme_id=>42
,p_name=>'3_LINES'
,p_display_name=>'3 Lines'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114780687496635055)
,p_theme_id=>42
,p_name=>'4_COLUMNS'
,p_display_name=>'4 Columns'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114780958521635055)
,p_theme_id=>42
,p_name=>'4_LINES'
,p_display_name=>'4 Lines'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114781126984635055)
,p_theme_id=>42
,p_name=>'5_COLUMNS'
,p_display_name=>'5 Columns'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114781339437635055)
,p_theme_id=>42
,p_name=>'BASIC'
,p_display_name=>'Basic'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114781513053635066)
,p_theme_id=>42
,p_name=>'BLOCK'
,p_display_name=>'Block'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114781689338635067)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114782128941635067)
,p_theme_id=>42
,p_name=>'COLOR_FILL'
,p_display_name=>'Color Fill'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114779458512635052)
,p_css_classes=>'t-Cards--animColorFill'
,p_group_id=>wwv_flow_imp.id(114781923338635067)
,p_template_types=>'LIST'
,p_help_text=>'Fills the card background with the color of the icon or default link style.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114782312735635067)
,p_theme_id=>42
,p_name=>'COMPACT'
,p_display_name=>'Compact'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114782776892635067)
,p_theme_id=>42
,p_name=>'DISPLAY_ICONS'
,p_display_name=>'Display Icons'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114779458512635052)
,p_css_classes=>'t-Cards--displayIcons'
,p_group_id=>wwv_flow_imp.id(114782575912635067)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114782975840635068)
,p_theme_id=>42
,p_name=>'DISPLAY_INITIALS'
,p_display_name=>'Display Initials'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114783110982635068)
,p_theme_id=>42
,p_name=>'DISPLAY_SUBTITLE'
,p_display_name=>'Display Subtitle'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114783345133635068)
,p_theme_id=>42
,p_name=>'FEATURED'
,p_display_name=>'Featured'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114783538590635068)
,p_theme_id=>42
,p_name=>'FLOAT'
,p_display_name=>'Float'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114783762312635068)
,p_theme_id=>42
,p_name=>'HIDDEN_BODY_TEXT'
,p_display_name=>'Hidden'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114784124120635068)
,p_theme_id=>42
,p_name=>'ICONS_ROUNDED'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114779458512635052)
,p_css_classes=>'t-Cards--iconsRounded'
,p_group_id=>wwv_flow_imp.id(114783935252635068)
,p_template_types=>'LIST'
,p_help_text=>'The icons are displayed within a square with rounded corners.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114784290139635068)
,p_theme_id=>42
,p_name=>'ICONS_SQUARE'
,p_display_name=>'Square'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114784545298635068)
,p_theme_id=>42
,p_name=>'RAISE_CARD'
,p_display_name=>'Raise Card'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114784717427635068)
,p_theme_id=>42
,p_name=>'SPAN_HORIZONTALLY'
,p_display_name=>'Span Horizontally'
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114784957020635068)
,p_theme_id=>42
,p_name=>'USE_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114785344458635069)
,p_theme_id=>42
,p_name=>'ACTIONS'
,p_display_name=>'Actions'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114785027195635068)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114785491417635069)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114785689362635069)
,p_theme_id=>42
,p_name=>'SHOWBADGES'
,p_display_name=>'Show Badges'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114785947853635069)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114786377245635069)
,p_theme_id=>42
,p_name=>'SHOWICONS'
...
,p_group_id=>wwv_flow_imp.id(114786121888635069)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114786564839635069)
,p_theme_id=>42
,p_name=>'SHOWTOPICONS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114786960338635069)
,p_theme_id=>42
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_css_classes=>'t-MediaList--cols t-MediaList--2cols'
,p_group_id=>wwv_flow_imp.id(114775768927635049)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114787130741635069)
,p_theme_id=>42
,p_name=>'3COLUMNGRID'
,p_display_name=>'3 Column Grid'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114787294046635069)
,p_theme_id=>42
,p_name=>'4COLUMNGRID'
,p_display_name=>'4 Column Grid'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114787499370635069)
,p_theme_id=>42
,p_name=>'5COLUMNGRID'
,p_display_name=>'5 Column Grid'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114787767375635069)
,p_theme_id=>42
,p_name=>'APPLY_THEME_COLORS'
,p_display_name=>'Apply Theme Colors'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114787951581635069)
,p_theme_id=>42
,p_name=>'ICONS_ROUNDED'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114788135522635069)
,p_theme_id=>42
,p_name=>'ICONS_SQUARE'
,p_display_name=>'Square'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114788502892635069)
,p_theme_id=>42
...
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_css_classes=>'t-MediaList--large force-fa-lg'
,p_group_id=>wwv_flow_imp.id(114788363808635069)
,p_template_types=>'LIST'
,p_help_text=>'Increases the size of the text and icons in the list.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114788730462635070)
,p_theme_id=>42
,p_name=>'SHOW_BADGES'
,p_display_name=>'Show Badges'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114788911133635070)
,p_theme_id=>42
,p_name=>'SHOW_DESCRIPTION'
,p_display_name=>'Show Description'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114789134033635070)
,p_theme_id=>42
,p_name=>'SHOW_ICONS'
,p_display_name=>'Show Icons'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114789303826635070)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114789746778635072)
,p_theme_id=>42
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>40
,p_list_template_id=>wwv_flow_imp.id(114789461949635070)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
,p_help_text=>'Use this option to add shortcuts for menu items. Note that actions.js must be included on your page to support this functionality.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114789950356635072)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114790102290635072)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114790333988635072)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114790760731635074)
,p_theme_id=>42
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114790428178635074)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
,p_help_text=>'Enables you to define a keyboard shortcut to activate the menu item.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114790932290635074)
,p_theme_id=>42
,p_name=>'DISPLAY_MENU_CALLOUT'
,p_display_name=>'Display Menu Callout'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114791301753635075)
,p_theme_id=>42
,p_name=>'DISPLAY_MENU_CALLOUT'
,p_display_name=>'Display Menu Callout'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114790998415635074)
,p_css_classes=>'js-menu-callout'
,p_template_types=>'LIST'
,p_help_text=>'Use this option to add display a callout for the menu.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114791778662635075)
,p_theme_id=>42
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(114791400989635075)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
,p_help_text=>'Use this option to add shortcuts for menu items. Note that actions.js must be included on your page to support this functionality.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114791928372635075)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114792317878635076)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114792135200635075)
,p_template_types=>'LIST'
,p_help_text=>'Completely hide the navigation menu when it is collapsed.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114792515199635076)
,p_theme_id=>42
,p_name=>'ICON_DEFAULT'
,p_display_name=>'Icon'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114792774871635076)
,p_theme_id=>42
,p_name=>'STYLE_A'
,p_display_name=>'Style A'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114792967163635076)
,p_theme_id=>42
,p_name=>'STYLE_B'
,p_display_name=>'Style B'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114793127409635076)
,p_theme_id=>42
,p_name=>'STYLE_C'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114793573080635076)
,p_theme_id=>42
,p_name=>'ABOVE_LABEL'
,p_display_name=>'Above Label'
,p_display_sequence=>20
,p_list_template_id=>wwv_flow_imp.id(114793242640635076)
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114793714052635076)
,p_theme_id=>42
,p_name=>'FILL_LABELS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114793931505635076)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114794178091635076)
,p_theme_id=>42
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114794368587635076)
,p_theme_id=>42
,p_name=>'PILL'
,p_display_name=>'Pill'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114794556095635076)
,p_theme_id=>42
,p_name=>'SIMPLE'
,p_display_name=>'Simple'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114794701859635076)
,p_theme_id=>42
,p_name=>'SMALL'
,p_display_name=>'Small'
,p_display_sequence=>5
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114795116182635077)
,p_theme_id=>42
,p_name=>'2_COLUMNS'
,p_display_name=>'2 Columns'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114794873983635076)
,p_css_classes=>'t-MegaMenu--layout2Cols'
,p_group_id=>wwv_flow_imp.id(114775768927635049)
,p_template_types=>'LIST'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114795356146635077)
,p_theme_id=>42
,p_name=>'3_COLUMNS'
,p_display_name=>'3 Columns'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114795524513635078)
,p_theme_id=>42
,p_name=>'4_COLUMNS'
,p_display_name=>'4 Columns'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114795772133635078)
,p_theme_id=>42
,p_name=>'5_COLUMNS'
,p_display_name=>'5 Columns'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114795960766635078)
,p_theme_id=>42
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114796106946635078)
,p_theme_id=>42
,p_name=>'CUSTOM'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114796361876635078)
,p_theme_id=>42
,p_name=>'DISPLAY_MENU_CALLOUT'
,p_display_name=>'Display Menu Callout'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114796526223635078)
,p_theme_id=>42
,p_name=>'FULL_WIDTH'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114796700655635078)
,p_theme_id=>42
,p_name=>'STACKED'
,p_display_name=>'Stacked'
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114797080419635078)
,p_theme_id=>42
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_imp.id(114796784080635078)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
,p_help_text=>'Use this option to add shortcuts for menu items. Note that actions.js must be included on your page to support this functionality.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114797282731635078)
,p_theme_id=>42
,p_name=>'BEHAVE_LIKE_TABS'
,p_display_name=>'Behave Like Tabs'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114797541266635078)
,p_theme_id=>42
,p_name=>'DISPLAY_MENU_CALLOUT'
,p_display_name=>'Display Menu Callout'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114797682854635078)
,p_theme_id=>42
,p_name=>'SHOW_SUB_MENU_ICONS'
,p_display_name=>'Show Sub Menu Icons'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114798282807635079)
,p_theme_id=>42
,p_name=>'DISPLAY_LABELS_SM'
,p_display_name=>'Display labels'
,p_display_sequence=>40
,p_list_template_id=>wwv_flow_imp.id(114797814762635078)
,p_css_classes=>'t-NavTabs--displayLabels-sm'
,p_group_id=>wwv_flow_imp.id(114798116724635079)
,p_template_types=>'LIST'
,p_help_text=>'Displays the label for the list items below the icon'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114798540195635079)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114798883323635079)
,p_theme_id=>42
...
,p_group_id=>wwv_flow_imp.id(114798707294635079)
,p_template_types=>'LIST'
,p_help_text=>'Display the label stacked above the icon and badge'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114799141874635079)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114799286928635079)
,p_theme_id=>42
,p_name=>'NO_LABEL_LG'
,p_display_name=>'Do not display labels'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114799884348635079)
,p_theme_id=>42
,p_name=>'ALLSTEPS'
,p_display_name=>'All Steps'
,p_display_sequence=>10
,p_list_template_id=>wwv_flow_imp.id(114799439570635079)
,p_css_classes=>'t-WizardSteps--displayLabels'
,p_group_id=>wwv_flow_imp.id(114799738464635079)
,p_template_types=>'LIST'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114800113864635079)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114800290731635079)
,p_theme_id=>42
,p_name=>'HIDELABELS'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114800531196635079)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114800726675635080)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114801652952635084)
,p_theme_id=>42
,p_name=>'INDICATOR_ASTERISK'
,p_display_name=>'Asterisk'
,p_display_sequence=>10
,p_field_template_id=>wwv_flow_imp.id(114801249721635083)
,p_css_classes=>'t-Form-fieldContainer--indicatorAsterisk'
,p_group_id=>wwv_flow_imp.id(114801398993635083)
,p_template_types=>'FIELD'
,p_help_text=>'Displays an asterisk * on required items.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114801874438635084)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114802147234635084)
,p_theme_id=>42
,p_name=>'INDICATOR_ASTERISK'
,p_display_name=>'Asterisk'
,p_display_sequence=>10
,p_field_template_id=>wwv_flow_imp.id(114801964481635084)
,p_css_classes=>'t-Form-fieldContainer--indicatorAsterisk'
,p_group_id=>wwv_flow_imp.id(114801398993635083)
,p_template_types=>'FIELD'
,p_help_text=>'Displays an asterisk * on required items.'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114802301090635084)
,p_theme_id=>42
,p_name=>'INDICATOR_LABEL'
,p_display_name=>'Inline Label'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114802588223635085)
,p_theme_id=>42
,p_name=>'INDICATOR_ASTERISK'
,p_display_name=>'Asterisk'
,p_display_sequence=>10
,p_field_template_id=>wwv_flow_imp.id(114802399590635084)
,p_css_classes=>'t-Form-fieldContainer--indicatorAsterisk'
,p_group_id=>wwv_flow_imp.id(114801398993635083)
,p_template_types=>'FIELD'
,p_help_text=>'Displays an asterisk * on required items.'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114802791706635085)
,p_theme_id=>42
,p_name=>'INDICATOR_LABEL'
,p_display_name=>'Inline Label'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114803299925635089)
,p_theme_id=>42
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>20
,p_button_template_id=>wwv_flow_imp.id(114802929028635087)
,p_css_classes=>'t-Button--hoverIconPush'
,p_group_id=>wwv_flow_imp.id(114803172895635089)
,p_template_types=>'BUTTON'
,p_help_text=>'The icon will animate to the right or left on button hover or focus.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114803514514635089)
,p_theme_id=>42
,p_name=>'SPIN'
,p_display_name=>'Spin'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114804493920635089)
,p_theme_id=>42
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>10
...
,p_group_id=>wwv_flow_imp.id(114804375844635089)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114804690177635090)
,p_theme_id=>42
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114804925019635090)
,p_theme_id=>42
,p_name=>'RIGHTICON'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114805086459635090)
,p_theme_id=>42
,p_name=>'SPIN'
,p_display_name=>'Spin'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114894099269635674)
,p_theme_id=>42
,p_name=>'HEADING_LEVEL_H1'
,p_display_name=>'H1'
,p_display_sequence=>10
,p_css_classes=>'js-headingLevel-1'
,p_group_id=>wwv_flow_imp.id(114893899294635674)
,p_template_types=>'REGION'
,p_help_text=>'H1'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114894291006635674)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114894544957635674)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114894749984635674)
,p_theme_id=>42
,p_name=>'H4'
,p_display_name=>'H4'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114894888022635674)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114895110301635674)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114895508432635675)
,p_theme_id=>42
,p_name=>'FBM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-bottom-lg'
,p_group_id=>wwv_flow_imp.id(114895298820635674)
,p_template_types=>'FIELD'
,p_help_text=>'Adds a large bottom margin for this field.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114895929082635675)
,p_theme_id=>42
,p_name=>'RBM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-bottom-lg'
,p_group_id=>wwv_flow_imp.id(114895697273635675)
,p_template_types=>'REGION'
,p_help_text=>'Adds a large bottom margin to the region.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114896153465635675)
,p_theme_id=>42
,p_name=>'FBM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114896313073635675)
,p_theme_id=>42
,p_name=>'RBM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114896537798635675)
,p_theme_id=>42
,p_name=>'FBM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114896737737635675)
,p_theme_id=>42
,p_name=>'RBM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114896970705635675)
,p_theme_id=>42
,p_name=>'FBM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114897096363635675)
,p_theme_id=>42
,p_name=>'RBM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114897523406635675)
,p_theme_id=>42
,p_name=>'FLM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-left-lg'
,p_group_id=>wwv_flow_imp.id(114897291028635675)
,p_template_types=>'FIELD'
,p_help_text=>'Adds a large left margin for this field.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114897976979635675)
,p_theme_id=>42
,p_name=>'RLM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-left-lg'
,p_group_id=>wwv_flow_imp.id(114897698440635675)
,p_template_types=>'REGION'
,p_help_text=>'Adds a large right margin to the region.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114898139753635675)
,p_theme_id=>42
,p_name=>'FLM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114898336911635676)
,p_theme_id=>42
,p_name=>'RLM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114898555122635677)
,p_theme_id=>42
,p_name=>'FLM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114898778842635677)
,p_theme_id=>42
,p_name=>'RLM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114898889482635677)
,p_theme_id=>42
,p_name=>'FLM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114899122900635677)
,p_theme_id=>42
,p_name=>'RLM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114899509390635678)
,p_theme_id=>42
,p_name=>'FRM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-right-lg'
,p_group_id=>wwv_flow_imp.id(114899352268635678)
,p_template_types=>'FIELD'
,p_help_text=>'Adds a large right margin for this field.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114899969606635679)
,p_theme_id=>42
,p_name=>'RRM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-right-lg'
,p_group_id=>wwv_flow_imp.id(114899717646635679)
,p_template_types=>'REGION'
,p_help_text=>'Adds a large right margin to the region.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114900152547635679)
,p_theme_id=>42
,p_name=>'FRM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114900341084635679)
,p_theme_id=>42
,p_name=>'RRM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114900482149635679)
,p_theme_id=>42
,p_name=>'FRM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114900723607635679)
,p_theme_id=>42
,p_name=>'RRM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114900892984635679)
,p_theme_id=>42
,p_name=>'FRM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114901140102635679)
,p_theme_id=>42
,p_name=>'RRM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114901517728635679)
,p_theme_id=>42
,p_name=>'FTM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-top-lg'
,p_group_id=>wwv_flow_imp.id(114901339493635679)
,p_template_types=>'FIELD'
,p_help_text=>'Adds a large top margin for this field.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114901952986635679)
,p_theme_id=>42
,p_name=>'RTM_LARGE'
,p_display_name=>'Large'
,p_display_sequence=>40
,p_css_classes=>'margin-top-lg'
,p_group_id=>wwv_flow_imp.id(114901722420635679)
,p_template_types=>'REGION'
,p_help_text=>'Adds a large top margin to the region.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114902170116635679)
,p_theme_id=>42
,p_name=>'FTM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114902327495635679)
,p_theme_id=>42
,p_name=>'RTM_MEDIUM'
,p_display_name=>'Medium'
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114902482996635680)
,p_theme_id=>42
,p_name=>'FTM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114902708379635680)
,p_theme_id=>42
,p_name=>'RTM_NONE'
,p_display_name=>'None'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114902895340635680)
,p_theme_id=>42
,p_name=>'FTM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114903117606635680)
,p_theme_id=>42
,p_name=>'RTM_SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114903538544635680)
,p_theme_id=>42
,p_name=>'DANGER'
,p_display_name=>'Danger'
,p_display_sequence=>30
,p_css_classes=>'t-Button--danger'
,p_group_id=>wwv_flow_imp.id(114903337390635680)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114903972552635680)
,p_theme_id=>42
,p_name=>'LARGEBOTTOMMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapBottom'
,p_group_id=>wwv_flow_imp.id(114903706136635680)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114904323928635680)
,p_theme_id=>42
,p_name=>'LARGELEFTMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapLeft'
,p_group_id=>wwv_flow_imp.id(114904086777635680)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114904759304635680)
,p_theme_id=>42
,p_name=>'LARGERIGHTMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapRight'
,p_group_id=>wwv_flow_imp.id(114904578466635680)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114905107238635680)
,p_theme_id=>42
,p_name=>'LARGETOPMARGIN'
,p_display_name=>'Large'
,p_display_sequence=>20
,p_css_classes=>'t-Button--gapTop'
,p_group_id=>wwv_flow_imp.id(114904944631635680)
,p_template_types=>'BUTTON'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114905545092635680)
,p_theme_id=>42
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>30
,p_css_classes=>'t-Button--large'
,p_group_id=>wwv_flow_imp.id(114905301139635680)
,p_template_types=>'BUTTON'
,p_help_text=>'A large button.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114905951048635681)
,p_theme_id=>42
,p_name=>'DISPLAY_AS_LINK'
,p_display_name=>'Display as Link'
,p_display_sequence=>30
,p_css_classes=>'t-Button--link'
,p_group_id=>wwv_flow_imp.id(114905686824635681)
,p_template_types=>'BUTTON'
,p_help_text=>'This option makes the button appear as a text link.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114906103316635681)
,p_theme_id=>42
,p_name=>'NOUI'
,p_display_name=>'Remove UI Decoration'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114906303450635681)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114906513180635681)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114906681371635681)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114906903253635681)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114907290077635681)
,p_theme_id=>42
,p_name=>'PILL'
,p_display_name=>'Inner Button'
,p_display_sequence=>20
,p_css_classes=>'t-Button--pill'
,p_group_id=>wwv_flow_imp.id(114907088220635681)
,p_template_types=>'BUTTON'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114907571327635681)
,p_theme_id=>42
,p_name=>'PILLEND'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114907704213635681)
,p_theme_id=>42
,p_name=>'PILLSTART'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114907951854635681)
,p_theme_id=>42
,p_name=>'PRIMARY'
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114908143978635681)
,p_theme_id=>42
,p_name=>'SIMPLE'
,p_display_name=>'Simple'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114908295742635681)
,p_theme_id=>42
,p_name=>'SMALL'
,p_display_name=>'Small'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114908752819635681)
,p_theme_id=>42
,p_name=>'STRETCH'
,p_display_name=>'Stretch'
,p_display_sequence=>10
,p_css_classes=>'t-Button--stretch'
,p_group_id=>wwv_flow_imp.id(114908544115635681)
,p_template_types=>'BUTTON'
,p_help_text=>'Stretches button to fill container'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114908889344635681)
,p_theme_id=>42
,p_name=>'SUCCESS'
,p_display_name=>'Success'
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114909135340635682)
,p_theme_id=>42
,p_name=>'TINY'
,p_display_name=>'Tiny'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114909315407635682)
,p_theme_id=>42
,p_name=>'WARNING'
,p_display_name=>'Warning'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114909517843635682)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114909970306635682)
,p_theme_id=>42
,p_name=>'SHOWFORMLABELSABOVE'
,p_display_name=>'Show Form Labels Above'
,p_display_sequence=>10
,p_css_classes=>'t-Form--labelsAbove'
,p_group_id=>wwv_flow_imp.id(114909688814635682)
,p_template_types=>'REGION'
,p_help_text=>'Show form labels above input fields.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114910305169635682)
,p_theme_id=>42
,p_name=>'FORMSIZELARGE'
,p_display_name=>'Large'
,p_display_sequence=>10
,p_css_classes=>'t-Form--large'
,p_group_id=>wwv_flow_imp.id(114910111930635682)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114910733172635682)
,p_theme_id=>42
,p_name=>'FORMLEFTLABELS'
,p_display_name=>'Left'
,p_display_sequence=>20
,p_css_classes=>'t-Form--leftLabels'
,p_group_id=>wwv_flow_imp.id(114910530134635682)
,p_template_types=>'REGION'
,p_help_text=>'Align form labels to left.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114911087769635682)
,p_theme_id=>42
,p_name=>'FORMREMOVEPADDING'
,p_display_name=>'None'
,p_display_sequence=>20
,p_css_classes=>'t-Form--noPadding'
,p_group_id=>wwv_flow_imp.id(114910955441635682)
,p_template_types=>'REGION'
,p_help_text=>'Removes spacing between items.'
,p_is_advanced=>'N'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114911370159635682)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114911501911635683)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114911927373635684)
,p_theme_id=>42
,p_name=>'STRETCH_FORM_FIELDS'
,p_display_name=>'Stretch Form Fields'
,p_display_sequence=>10
,p_css_classes=>'t-Form--stretchInputs'
,p_group_id=>wwv_flow_imp.id(114911694985635683)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114912098374635684)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114912538368635684)
,p_theme_id=>42
,p_name=>'DISPLAY_TEXT_STYLE_BOLD'
,p_display_name=>'Bold'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--boldDisplay'
,p_group_id=>wwv_flow_imp.id(114912329060635684)
,p_template_types=>'FIELD'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114912907525635684)
,p_theme_id=>42
,p_name=>'LARGE_FIELD'
,p_display_name=>'Large'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--large'
,p_group_id=>wwv_flow_imp.id(114912749178635684)
,p_template_types=>'FIELD'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114913130093635684)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114913517037635684)
,p_theme_id=>42
,p_name=>'POST_TEXT_BLOCK'
,p_display_name=>'Display as Block'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--postTextBlock'
,p_group_id=>wwv_flow_imp.id(114913351008635684)
,p_template_types=>'FIELD'
,p_help_text=>'Displays the Item Post Text in a block style immediately after the item.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114913958091635684)
,p_theme_id=>42
,p_name=>'PRE_TEXT_BLOCK'
,p_display_name=>'Display as Block'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--preTextBlock'
,p_group_id=>wwv_flow_imp.id(114913776175635684)
,p_template_types=>'FIELD'
,p_help_text=>'Displays the Item Pre Text in a block style immediately before the item.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114914305626635684)
,p_theme_id=>42
,p_name=>'DISPLAY_AS_PILL_BUTTON'
,p_display_name=>'Display as Pill Button'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--radioButtonGroup'
,p_group_id=>wwv_flow_imp.id(114914118871635684)
,p_template_types=>'FIELD'
,p_help_text=>'Displays the radio buttons to look like a button set / pill button.  Note that the the radio buttons must all be in the same row for this option to work.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114914568655635685)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114914719742635686)
,p_theme_id=>42
,p_name=>'X_LARGE_SIZE'
,p_display_name=>'X Large'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114915129558635687)
,p_theme_id=>42
,p_name=>'REMOVE_PADDING'
,p_display_name=>'Remove Padding'
,p_display_sequence=>1
,p_css_classes=>'t-PageBody--noContentPadding'
,p_group_id=>wwv_flow_imp.id(114914952852635687)
,p_template_types=>'PAGE'
,p_help_text=>'Removes padding from the content region.'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114915486206635687)
,p_theme_id=>42
,p_name=>'SORT_CENTER'
,p_display_name=>'Center'
,p_display_sequence=>10
,p_css_classes=>'t-Region-orderBy--center'
,p_group_id=>wwv_flow_imp.id(114915294462635687)
,p_template_types=>'REGION'
);
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114915742726635687)
,p_theme_id=>42
,p_name=>'SORT_END'
,p_display_name=>'End'
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_template_option(
 p_id=>wwv_flow_imp.id(114916125907635687)
,p_theme_id=>42
,p_name=>'HIDE_WHEN_ALL_ROWS_DISPLAYED'
,p_display_name=>'Hide when all rows displayed'
,p_display_sequence=>10
,p_css_classes=>'t-Report--hideNoPagination'
,p_group_id=>wwv_flow_imp.id(114915923500635687)
,p_template_types=>'REPORT'
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114626177073634812)
,p_build_option_name=>'Commented Out'
,p_build_option_status=>'EXCLUDE'
,p_version_scn=>8999125
);
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114918976069635750)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114919046833635750)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114919096734635750)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114919351169635750)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114919625294635750)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(114919703900635750)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(115181296425636628)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(115181631389636628)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(114626392810634814)
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114805594505635149)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114805890185635164)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114806201134635173)
,p_plugin_attribute_id=>wwv_flow_imp.id(114805890185635164)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114806662367635179)
,p_plugin_attribute_id=>wwv_flow_imp.id(114805890185635164)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114807076568635179)
,p_plugin_attribute_id=>wwv_flow_imp.id(114805890185635164)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114807425627635183)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114805890185635164)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114807685243635184)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114808061054635188)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114808348883635188)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114808650206635188)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114808881530635189)
,p_plugin_attribute_id=>wwv_flow_imp.id(114808650206635188)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114809300514635189)
,p_plugin_attribute_id=>wwv_flow_imp.id(114808650206635188)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114809740172635191)
,p_plugin_attribute_id=>wwv_flow_imp.id(114808650206635188)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114810115707635192)
,p_plugin_attribute_id=>wwv_flow_imp.id(114808650206635188)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114810570318635192)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114810867255635192)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114811199923635193)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114811650633635193)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114812062072635193)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114812443725635193)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114812834786635194)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114813221602635194)
,p_plugin_attribute_id=>wwv_flow_imp.id(114810570318635192)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114813582191635197)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1914856505907748903)
,p_plugin_id=>wwv_flow_imp.id(114805594505635149)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114814693651635215)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '42')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114815068795635216)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'LABEL'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114815361443635216)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114815587941635216)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114815948572635216)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114816192495635216)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114816525410635217)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114816796832635217)
,p_plugin_attribute_id=>wwv_flow_imp.id(114816525410635217)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114817241375635225)
,p_plugin_attribute_id=>wwv_flow_imp.id(114816525410635217)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114817677362635225)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114817929020635227)
,p_plugin_attribute_id=>wwv_flow_imp.id(114817677362635225)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114818340995635232)
,p_plugin_attribute_id=>wwv_flow_imp.id(114817677362635225)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114818687524635232)
,p_plugin_attribute_id=>wwv_flow_imp.id(114817677362635225)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114819151373635232)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114819465523635232)
,p_plugin_attribute_id=>wwv_flow_imp.id(114819151373635232)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114819797219635233)
,p_plugin_attribute_id=>wwv_flow_imp.id(114819151373635232)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114820180656635233)
,p_plugin_attribute_id=>wwv_flow_imp.id(114819151373635232)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1626296972554737404)
,p_plugin_id=>wwv_flow_imp.id(114814693651635215)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114820867582635234)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '42')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114821133372635236)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'LABEL'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114821390417635236)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114821733714635236)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114821985569635238)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114822364278635239)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114822583983635239)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114822909398635239)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114823205494635241)
,p_plugin_id=>wwv_flow_imp.id(114820867582635234)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114823535653635242)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '42')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1914708956889666962)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114824072610635248)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114824349359635248)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114824610419635248)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114824919539635259)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114825216628635259)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114829864769635342)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1914708956889666962)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114825514816635260)
,p_plugin_attribute_id=>wwv_flow_imp.id(114825216628635259)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114825938326635263)
,p_plugin_attribute_id=>wwv_flow_imp.id(114825216628635259)
,p_display_sequence=>20
,p_display_value=>'Initials'
,p_return_value=>'initials'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114826326945635273)
,p_plugin_attribute_id=>wwv_flow_imp.id(114825216628635259)
,p_display_sequence=>30
,p_display_value=>'Icon'
,p_return_value=>'icon'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114826697446635283)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114825216628635259)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'image'
,p_attribute_group_id=>wwv_flow_imp.id(1914708956889666962)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114827072062635285)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114827347254635285)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114827637164635286)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114827894489635289)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114828275242635289)
,p_plugin_attribute_id=>wwv_flow_imp.id(114827894489635289)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Avatar--rounded'
,p_help_text=>'Displayed within a square with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114828668869635311)
,p_plugin_attribute_id=>wwv_flow_imp.id(114827894489635289)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Avatar--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114829055002635332)
,p_plugin_attribute_id=>wwv_flow_imp.id(114827894489635289)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Avatar--square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114829476070635333)
,p_plugin_attribute_id=>wwv_flow_imp.id(114827894489635289)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114829864769635342)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114830087847635343)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114830403740635343)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114830771832635347)
,p_plugin_attribute_id=>wwv_flow_imp.id(114830403740635343)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114831131798635354)
,p_plugin_attribute_id=>wwv_flow_imp.id(114830403740635343)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114831557805635356)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1914841624322768465)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1914841032817761008)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1914896656487742887)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1915048874200613658)
,p_plugin_id=>wwv_flow_imp.id(114823535653635242)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114833676979635388)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '42')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2042071485827707088)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2042070930815707087)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1785178867085433574)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114834488923635400)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114834809848635403)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114835151453635403)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114835456421635403)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114835764954635404)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114836069307635404)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114836340262635404)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114835764954635404)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2042071485827707088)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114836673665635407)
,p_plugin_attribute_id=>wwv_flow_imp.id(114836340262635404)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114837077825635412)
,p_plugin_attribute_id=>wwv_flow_imp.id(114836340262635404)
,p_display_sequence=>20
,p_display_value=>'Initials'
,p_return_value=>'initials'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114837439439635415)
,p_plugin_attribute_id=>wwv_flow_imp.id(114836340262635404)
,p_display_sequence=>30
,p_display_value=>'Icon'
,p_return_value=>'icon'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114837868134635416)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114836340262635404)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'image'
,p_attribute_group_id=>wwv_flow_imp.id(2042071485827707088)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114838116048635416)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114838437567635419)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114838748074635422)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114839068597635422)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114839288213635424)
,p_plugin_attribute_id=>wwv_flow_imp.id(114839068597635422)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Avatar--rounded'
,p_help_text=>'Displayed within a square with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114839685489635425)
,p_plugin_attribute_id=>wwv_flow_imp.id(114839068597635422)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Avatar--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114840139175635425)
,p_plugin_attribute_id=>wwv_flow_imp.id(114839068597635422)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Avatar--square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114840484399635432)
,p_plugin_attribute_id=>wwv_flow_imp.id(114839068597635422)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114840979339635435)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(114836069307635404)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2042070930815707087)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114841199261635435)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114841487761635443)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114841789436635447)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114842095223635450)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114842471835635452)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114842752176635453)
,p_plugin_attribute_id=>wwv_flow_imp.id(114842471835635452)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114843167491635454)
,p_plugin_attribute_id=>wwv_flow_imp.id(114842471835635452)
,p_display_sequence=>20
,p_display_value=>'Outline'
,p_return_value=>'t-Badge--outline'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114843533485635454)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114843871758635456)
,p_plugin_attribute_id=>wwv_flow_imp.id(114843533485635454)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Badge--rounded'
,p_help_text=>'Displayed with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114844227124635458)
,p_plugin_attribute_id=>wwv_flow_imp.id(114843533485635454)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Badge--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114844619308635458)
,p_plugin_attribute_id=>wwv_flow_imp.id(114843533485635454)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Badge--square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114844995311635465)
,p_plugin_attribute_id=>wwv_flow_imp.id(114843533485635454)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114845439735635465)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114845730904635466)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114846167497635469)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>20
,p_display_value=>'Extra Small'
,p_return_value=>'t-Avatar--xs'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114846531380635471)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>30
,p_display_value=>'Small'
,p_return_value=>'t-Avatar--sm'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114846959836635472)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>40
,p_display_value=>'Medium'
,p_return_value=>'t-Avatar--md'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114847367758635475)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>50
,p_display_value=>'Large'
,p_return_value=>'t-Avatar--lg'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114847731419635477)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>60
,p_display_value=>'Extra Large'
,p_return_value=>'t-Avatar--xl'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114848081484635479)
,p_plugin_attribute_id=>wwv_flow_imp.id(114845439735635465)
,p_display_sequence=>70
,p_display_value=>'Extra Extra Large'
,p_return_value=>'t-Avatar--xxl'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114848504992635483)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114848871565635483)
,p_plugin_attribute_id=>wwv_flow_imp.id(114848504992635483)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114849224708635485)
,p_plugin_attribute_id=>wwv_flow_imp.id(114848504992635483)
,p_display_sequence=>20
,p_display_value=>'Medium'
,p_return_value=>'t-Badge--md'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114849654212635486)
,p_plugin_attribute_id=>wwv_flow_imp.id(114848504992635483)
,p_display_sequence=>30
,p_display_value=>'Large'
,p_return_value=>'t-Badge--lg'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114849996362635486)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114850308681635487)
,p_plugin_attribute_id=>wwv_flow_imp.id(114849996362635486)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114850777794635491)
,p_plugin_attribute_id=>wwv_flow_imp.id(114849996362635486)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114851127424635491)
,p_plugin_attribute_id=>wwv_flow_imp.id(114849996362635486)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114851557656635497)
,p_plugin_attribute_id=>wwv_flow_imp.id(114849996362635486)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114851949571635498)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114852241721635499)
,p_plugin_attribute_id=>wwv_flow_imp.id(114851949571635498)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114852677927635501)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114852960655635502)
,p_plugin_attribute_id=>wwv_flow_imp.id(114852677927635501)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114853325596635502)
,p_plugin_attribute_id=>wwv_flow_imp.id(114852677927635501)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114853722501635505)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114854024602635509)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114854314753635511)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'REPORT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1785178867085433574)
,p_help_text=>'Specify whether to use the Universal Theme colors for avatar and badge row items. When set to Yes, the u-colors class will be applied to each row. When set to No, a default color will be used instead.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114854670262635513)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114854967614635523)
,p_plugin_attribute_id=>wwv_flow_imp.id(114854670262635513)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114855302453635534)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114855608368635534)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1923285376043528702)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_name=>'Button'
,p_type=>'BUTTON'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1923286635563532850)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1626333861147770272)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1909691747369121969)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1910371048099205073)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1923283440976483716)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
,p_name=>'Avatar Link'
,p_static_id=>'AVATAR_LINK'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1923284774366497573)
,p_plugin_id=>wwv_flow_imp.id(114833676979635388)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114861060585635574)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '42')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1914879399057519230)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1914878844045519229)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114861759882635583)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114861995640635584)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114862342962635585)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114862669106635585)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114862908684635586)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114862342962635585)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1914879399057519230)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114863244075635588)
,p_plugin_attribute_id=>wwv_flow_imp.id(114862908684635586)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114863617628635589)
,p_plugin_attribute_id=>wwv_flow_imp.id(114862908684635586)
,p_display_sequence=>20
,p_display_value=>'Initials'
,p_return_value=>'initials'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114863982610635589)
,p_plugin_attribute_id=>wwv_flow_imp.id(114862908684635586)
,p_display_sequence=>30
,p_display_value=>'Icon'
,p_return_value=>'icon'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114864382791635590)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114862908684635586)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'image'
,p_attribute_group_id=>wwv_flow_imp.id(1914879399057519230)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114864727421635591)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>95
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114865022402635592)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114865362377635592)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114865622569635593)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114865953000635593)
,p_plugin_attribute_id=>wwv_flow_imp.id(114865622569635593)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Avatar--rounded'
,p_help_text=>'Displayed within a square with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114866316905635594)
,p_plugin_attribute_id=>wwv_flow_imp.id(114865622569635593)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Avatar--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114866691167635596)
,p_plugin_attribute_id=>wwv_flow_imp.id(114865622569635593)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Avatar--square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114867137825635599)
,p_plugin_attribute_id=>wwv_flow_imp.id(114865622569635593)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114867524015635600)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(114862669106635585)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1914878844045519229)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114867801906635600)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114868117235635600)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114868463615635601)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114868763553635601)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
,p_display_sequence=>150
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114869011166635602)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
,p_display_sequence=>160
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114869373002635602)
,p_plugin_attribute_id=>wwv_flow_imp.id(114869011166635602)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114869693869635603)
,p_plugin_attribute_id=>wwv_flow_imp.id(114869011166635602)
,p_display_sequence=>20
,p_display_value=>'Outline'
,p_return_value=>'t-Badge--outline'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114870119799635604)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
,p_display_sequence=>170
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114870469063635604)
,p_plugin_attribute_id=>wwv_flow_imp.id(114870119799635604)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Badge--rounded'
,p_help_text=>'Displayed with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114870871263635605)
,p_plugin_attribute_id=>wwv_flow_imp.id(114870119799635604)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Badge--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114871245843635605)
,p_plugin_attribute_id=>wwv_flow_imp.id(114870119799635604)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Badge--square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114871635220635606)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'REPORT'
,p_attribute_sequence=>18
,p_display_sequence=>180
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114871956160635607)
,p_plugin_attribute_id=>wwv_flow_imp.id(114871635220635606)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114872334341635607)
,p_plugin_attribute_id=>wwv_flow_imp.id(114871635220635606)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114872753138635607)
,p_plugin_attribute_id=>wwv_flow_imp.id(114871635220635606)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114873110379635613)
,p_plugin_attribute_id=>wwv_flow_imp.id(114871635220635606)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114873542320635615)
,p_plugin_attribute_id=>wwv_flow_imp.id(114871635220635606)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114873931012635616)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'REPORT'
,p_attribute_sequence=>19
,p_display_sequence=>190
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114874185381635617)
,p_plugin_attribute_id=>wwv_flow_imp.id(114873931012635616)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114874601891635617)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_attribute_scope=>'REPORT'
,p_attribute_sequence=>20
,p_display_sequence=>200
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1915082451214665858)
,p_plugin_id=>wwv_flow_imp.id(114861060585635574)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(114877491644635623)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '42')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2261960993154742577)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2261960438142742576)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114878244807635627)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114878537614635627)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114878868636635627)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114879148283635629)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114879438140635629)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114879749791635629)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114880050262635629)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114879438140635629)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2261960993154742577)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114880326944635631)
,p_plugin_attribute_id=>wwv_flow_imp.id(114880050262635629)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114880721412635631)
,p_plugin_attribute_id=>wwv_flow_imp.id(114880050262635629)
,p_display_sequence=>20
,p_display_value=>'Initials'
,p_return_value=>'initials'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114881115992635632)
,p_plugin_attribute_id=>wwv_flow_imp.id(114880050262635629)
,p_display_sequence=>30
,p_display_value=>'Icon'
,p_return_value=>'icon'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114881509664635632)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(114880050262635629)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'image'
,p_attribute_group_id=>wwv_flow_imp.id(2261960993154742577)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114881815698635633)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>115
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114882094119635633)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114882401714635634)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114882704793635634)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>12
,p_display_sequence=>120
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114883004311635634)
,p_plugin_attribute_id=>wwv_flow_imp.id(114882704793635634)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Avatar--rounded'
,p_help_text=>'Displayed within a square with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114883389420635636)
,p_plugin_attribute_id=>wwv_flow_imp.id(114882704793635634)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Avatar--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114883826991635636)
,p_plugin_attribute_id=>wwv_flow_imp.id(114882704793635634)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Avatar--square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114884267279635636)
,p_plugin_attribute_id=>wwv_flow_imp.id(114882704793635634)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114884644909635637)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>13
,p_display_sequence=>130
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(114879749791635629)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2261960438142742576)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114884931689635637)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>14
,p_display_sequence=>140
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114885250839635638)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>15
,p_display_sequence=>150
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114885574582635639)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>16
,p_display_sequence=>160
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114885866373635639)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>17
,p_display_sequence=>170
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114886151742635639)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>18
,p_display_sequence=>180
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114886477839635639)
,p_plugin_attribute_id=>wwv_flow_imp.id(114886151742635639)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114886842875635640)
,p_plugin_attribute_id=>wwv_flow_imp.id(114886151742635639)
,p_display_sequence=>20
,p_display_value=>'Outline'
,p_return_value=>'t-Badge--outline'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114887219157635640)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>19
,p_display_sequence=>190
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114887489790635640)
,p_plugin_attribute_id=>wwv_flow_imp.id(114887219157635640)
,p_display_sequence=>10
,p_display_value=>'Rounded'
,p_return_value=>'t-Badge--rounded'
,p_help_text=>'Displayed with rounded corners.'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114887890560635642)
,p_plugin_attribute_id=>wwv_flow_imp.id(114887219157635640)
,p_display_sequence=>20
,p_display_value=>'Circular'
,p_return_value=>'t-Badge--circle'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114888332499635642)
,p_plugin_attribute_id=>wwv_flow_imp.id(114887219157635640)
,p_display_sequence=>30
,p_display_value=>'Square'
,p_return_value=>'t-Badge--square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114888685179635642)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'REPORT'
,p_attribute_sequence=>20
,p_display_sequence=>200
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(114889044658635642)
,p_plugin_attribute_id=>wwv_flow_imp.id(114888685179635642)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(114889467553635643)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_attribute_scope=>'REPORT'
,p_attribute_sequence=>21
,p_display_sequence=>210
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1909730338340951163)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_name=>'Title Link'
,p_static_id=>'TITLE_LINK'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2024141701329214764)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_name=>'User Name Link'
,p_static_id=>'USER_NAME_LINK'
,p_display_sequence=>15
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2143172948303519205)
,p_plugin_id=>wwv_flow_imp.id(114877491644635623)
,p_name=>'Avatar Link'
,p_static_id=>'AVATAR_LINK'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'Employe Data'
,p_format=>'JSON'
,p_encoding=>'utf-8'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(92319486908292288)
,p_data_profile_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'JOB'
,p_sequence=>1
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(92319805067292288)
,p_data_profile_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'SAL'
,p_sequence=>2
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(92320110615292288)
,p_data_profile_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'COMM'
,p_sequence=>3
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(92320371706292288)
,p_data_profile_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'EMPNO'
,p_sequence=>4
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(92320672470292289)
,p_data_profile_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'DEPTNO'
,p_sequence=>5
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(92321052659292289)
,p_data_profile_id=>wwv_flow_imp.id(92319262828292266)
,p_name=>'HIREDATE'
,p_sequence=>6
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(92321257044292289)
,p_name=>'Employe Data'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114932225514635865)
,p_plug_name=>'(Tema10)Creating and Using Dynamic Actions'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114696679933634968)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114985744231636073)
,p_plug_name=>'Page Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:u-colors:t-Cards--featured t-Cards--block force-fa-lg:t-Cards--displayIcons:t-Cards--4cols:t-Cards--hideBody:t-Cards--animColorFill'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(114984581764636071)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114944561718635924)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(114944612309635924)
,p_name=>'Project_form'
...
,p_detail_link_auth_scheme=>wwv_flow_imp.id(114921806060635768)
,p_owner=>'GONZALEZFJU'
,p_internal_uid=>11193232840258132
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114945306904635929)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114945711583635936)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114946175494635937)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114946566578635939)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114946879980635941)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114947368733635941)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114947775141635942)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114948139419635942)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114948547183635943)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(114966249145636020)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114950200441635949)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114742391945635005)
,p_plug_display_sequence=>20
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(114626778068634816)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_imp.id(114805227208635090)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114949022408635944)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(114944561718635924)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
,p_button_is_hot=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(114949347278635945)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(114944561718635924)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(114949831303635946)
,p_event_id=>wwv_flow_imp.id(114949347278635945)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(114944561718635924)
,p_attribute_01=>'N'
);
end;
/
...
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_imp.id(114627480759634843)
,p_page_template_options=>'#DEFAULT#:js-dialog-class-t-Drawer--pullOutEnd'
,p_required_role=>wwv_flow_imp.id(114921806060635768)
,p_dialog_chained=>'N'
,p_protection_level=>'C'
,p_page_component_map=>'02'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114940244693635908)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114940598963635909)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(114940244693635908)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114941987817635918)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114942347665635918)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114942691061635918)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114933937593635899)
,p_name=>'P3_ID'
...
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(114933575890635898)
,p_item_source_plug_id=>wwv_flow_imp.id(114933575890635898)
...
,p_field_template=>wwv_flow_imp.id(114802399590635084)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114934291161635902)
,p_name=>'P3_PROJECT'
...
,p_cMaxlength=>50
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_imp.id(114801084727635083)
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'disabled', 'N',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114934771104635903)
,p_name=>'P3_TASK_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114935081043635903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114935573623635904)
,p_name=>'P3_END_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114935912734635904)
,p_name=>'P3_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114936337282635904)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114936723527635904)
,p_name=>'P3_COST'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114937117870635905)
,p_name=>'P3_BUDGET'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(114940715137635909)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(114940598963635909)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(114941533000635913)
,p_event_id=>wwv_flow_imp.id(114940715137635909)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114943547795635923)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(114933575890635898)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114943954738635924)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114943154165635919)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114952584318635969)
,p_plug_name=>'Project Demoes'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114720261633634994)
,p_plug_display_sequence=>20
,p_query_type=>'TABLE'
,p_query_table=>'PROJECT_DEMO'
,p_include_rowid_column=>false
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114953883232635976)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114954436907635985)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114955407502635994)
,p_name=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114956431702635996)
,p_name=>'PROJECT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114957427473635997)
,p_name=>'TASK_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114958465911636004)
,p_name=>'START_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114959411118636006)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114960423587636007)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114961393156636007)
,p_name=>'ASSIGNED_TO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114962461753636008)
,p_name=>'COST'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(114963412833636008)
,p_name=>'BUDGET'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_interactive_grid(
 p_id=>wwv_flow_imp.id(114953122194635970)
,p_internal_uid=>11201742725258178
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_add_authorization_scheme=>wwv_flow_imp.id(114921806060635768)
,p_update_authorization_scheme=>wwv_flow_imp.id(114921806060635768)
,p_delete_authorization_scheme=>wwv_flow_imp.id(114921806060635768)
,p_lost_update_check_type=>'VALUES'
...
wwv_flow_imp_page.create_ig_report(
 p_id=>wwv_flow_imp.id(114953576700635972)
,p_interactive_grid_id=>wwv_flow_imp.id(114953122194635970)
,p_static_id=>'112022'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_imp_page.create_ig_report_view(
 p_id=>wwv_flow_imp.id(114953722564635974)
,p_report_id=>wwv_flow_imp.id(114953576700635972)
,p_view_type=>'GRID'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114954822323635986)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>0
,p_column_id=>wwv_flow_imp.id(114954436907635985)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114955788269635994)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>1
,p_column_id=>wwv_flow_imp.id(114955407502635994)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114956802678635996)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>2
,p_column_id=>wwv_flow_imp.id(114956431702635996)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114957832553635997)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>3
,p_column_id=>wwv_flow_imp.id(114957427473635997)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114958809942636004)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>4
,p_column_id=>wwv_flow_imp.id(114958465911636004)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114959782495636007)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>5
,p_column_id=>wwv_flow_imp.id(114959411118636006)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114960862222636007)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>6
,p_column_id=>wwv_flow_imp.id(114960423587636007)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114961784585636008)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>7
,p_column_id=>wwv_flow_imp.id(114961393156636007)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114962790535636008)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>8
,p_column_id=>wwv_flow_imp.id(114962461753636008)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(114963821595636009)
,p_view_id=>wwv_flow_imp.id(114953722564635974)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(114963412833636008)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114965126090636010)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114742391945635005)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114964401111636009)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(114952584318635969)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92321624004296761)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92323541836296765)
,p_plug_name=>'Data Source'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(114730045758634998)
,p_plug_display_sequence=>20
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'TEXT',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92323882864296766)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(92323541836296765)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92326052606296770)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(92327610089296772)
,p_name=>'Preview'
,p_template=>wwv_flow_imp.id(114730045758634998)
,p_display_sequence=>50
...
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(114768426678635034)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92328040426296779)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92328448189296779)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92328809068296779)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92329218982296780)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92329601612296780)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92330040721296780)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92330418890296780)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92330857747296780)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92331264232296780)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92331643636296781)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92332011142296781)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(92322024282296764)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(92321624004296761)
,p_button_name=>'CLEAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(92322310697296764)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(92321624004296761)
,p_button_name=>'LOAD'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(92324276376296766)
,p_name=>'P5_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(92323882864296766)
,p_prompt=>'Upload a File'
,p_display_as=>'NATIVE_FILE'
,p_grid_label_column_span=>0
,p_field_template=>wwv_flow_imp.id(114800804265635081)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(92324674566296769)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(92326429630296770)
,p_name=>'P5_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(92326052606296770)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(92326953393296771)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(92327291016296772)
...
,p_associated_item=>wwv_flow_imp.id(92324276376296766)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(92325111483296769)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(92325582151296769)
,p_event_id=>wwv_flow_imp.id(92325111483296769)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(92322802543296764)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load Data'
,p_attribute_01=>wwv_flow_imp.id(92321257044292289)
,p_attribute_02=>'FILE'
,p_attribute_03=>'P5_FILE'
,p_attribute_08=>'P5_ERROR_ROW_COUNT'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(92322310697296764)
,p_internal_uid=>12833035409504124
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(92323263953296765)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92336830998309763)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114742391945635005)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92337524259309765)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92339531276309766)
,p_plug_name=>'Data Source'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(114730045758634998)
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92339965344309766)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(92339531276309766)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
,p_plug_display_sequence=>30
,p_plug_display_condition_type=>'ITEM_IS_NULL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(92342026426309768)
,p_plug_name=>'Loaded File'
,p_parent_plug_id=>wwv_flow_imp.id(92339531276309766)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(92343653632309768)
,p_name=>'Preview'
,p_template=>wwv_flow_imp.id(114730045758634998)
,p_display_sequence=>50
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92344050905309771)
,p_query_column_id=>1
,p_column_alias=>'LINE_NUMBER'
,p_column_display_sequence=>1
,p_column_heading=>'Line Number'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92344385052309771)
,p_query_column_id=>2
,p_column_alias=>'COL001'
,p_column_display_sequence=>2
,p_column_heading=>'Col001'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92344842990309772)
,p_query_column_id=>3
,p_column_alias=>'COL002'
,p_column_display_sequence=>3
,p_column_heading=>'Col002'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92345210506309772)
,p_query_column_id=>4
,p_column_alias=>'COL003'
,p_column_display_sequence=>4
,p_column_heading=>'Col003'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92345585816309772)
,p_query_column_id=>5
,p_column_alias=>'COL004'
,p_column_display_sequence=>5
,p_column_heading=>'Col004'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92345969791309772)
,p_query_column_id=>6
,p_column_alias=>'COL005'
,p_column_display_sequence=>6
,p_column_heading=>'Col005'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92346386021309772)
,p_query_column_id=>7
,p_column_alias=>'COL006'
,p_column_display_sequence=>7
,p_column_heading=>'Col006'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92346860414309772)
,p_query_column_id=>8
,p_column_alias=>'COL007'
,p_column_display_sequence=>8
,p_column_heading=>'Col007'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92347174524309773)
,p_query_column_id=>9
,p_column_alias=>'COL008'
,p_column_display_sequence=>9
,p_column_heading=>'Col008'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92347648264309773)
,p_query_column_id=>10
,p_column_alias=>'COL009'
,p_column_display_sequence=>10
,p_column_heading=>'Col009'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(92348012470309773)
,p_query_column_id=>11
,p_column_alias=>'COL010'
,p_column_display_sequence=>11
,p_column_heading=>'Col010'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(92337984434309765)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(92337524259309765)
,p_button_name=>'CLEAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(92338280707309766)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(92337524259309765)
,p_button_name=>'LOAD'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(92340267739309767)
,p_name=>'P6_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(92339965344309766)
,p_prompt=>'Upload a File'
,p_display_as=>'NATIVE_FILE'
,p_grid_label_column_span=>0
,p_field_template=>wwv_flow_imp.id(114800804265635081)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(92340682928309767)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(92342373667309768)
,p_name=>'P6_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(92342026426309768)
,p_item_default=>'Pasted Data'
,p_prompt=>'Loaded File'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_imp.id(114801084727635083)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(92342887141309768)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(92343343873309768)
,p_validation_name=>'Is valid file type'
,p_validation_sequence=>10
,p_validation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if apex_data_parser.assert_file_type(',
...
,p_validation_type=>'FUNC_BODY_RETURNING_BOOLEAN'
,p_error_message=>'Invalid file type. Supported file types JSON.'
,p_associated_item=>wwv_flow_imp.id(92340267739309767)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(92341135294309767)
,p_name=>'Upload a File'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(92341648036309767)
,p_event_id=>wwv_flow_imp.id(92341135294309767)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(92338793152309766)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load Data'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(92338280707309766)
,p_internal_uid=>12849026018517126
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(92339242779309766)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Cache'
...
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_imp.id(114635956504634887)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114924856846635824)
,p_plug_name=>'(Tema10)Creating and Using Dynamic Actions'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114724810584634995)
,p_plug_display_sequence=>10
,p_region_image=>'#APP_FILES#icons/app-icon-512.png'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114926912004635846)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(114924856846635824)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114925361643635832)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(114924856846635824)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114925775419635834)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114926173065635838)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114926481022635843)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114929143788635853)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(114929624432635853)
,p_page_process_id=>wwv_flow_imp.id(114929143788635853)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(114930090081635853)
,p_page_process_id=>wwv_flow_imp.id(114929143788635853)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114927260350635846)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(114927729126635850)
,p_page_process_id=>wwv_flow_imp.id(114927260350635846)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(114928214326635852)
,p_page_process_id=>wwv_flow_imp.id(114927260350635846)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(114928748000635852)
,p_page_process_id=>wwv_flow_imp.id(114927260350635846)
,p_page_id=>9999
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114931054868635854)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114930612202635854)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(114923242246635801)
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_imp.id(114921580695635768)
,p_protection_level=>'C'
,p_deep_linking=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115162668255636578)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114742391945635005)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115169222301636585)
,p_plug_name=>'Column 1'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114664865481634933)
,p_plug_display_sequence=>10
,p_plug_query_num_rows=>15
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115169644730636587)
,p_plug_name=>'Configuration'
,p_parent_plug_id=>wwv_flow_imp.id(115169222301636585)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114730045758634998)
,p_plug_display_sequence=>40
,p_list_id=>wwv_flow_imp.id(115163294125636579)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_plug_query_num_rows=>15
,p_required_patch=>wwv_flow_imp.id(114919351169635750)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115169988902636589)
...
,p_list_id=>wwv_flow_imp.id(115164029619636582)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_plug_query_num_rows=>15
,p_required_patch=>wwv_flow_imp.id(114919703900635750)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115170442971636589)
...
,p_list_id=>wwv_flow_imp.id(115164747355636583)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_plug_query_num_rows=>15
,p_required_patch=>wwv_flow_imp.id(114919046833635750)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115170784911636589)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115171239698636591)
,p_plug_name=>'Access Control'
,p_parent_plug_id=>wwv_flow_imp.id(115170784911636589)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114730045758634998)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115172077481636592)
,p_plug_name=>'ACL Information'
,p_parent_plug_id=>wwv_flow_imp.id(115171239698636591)
,p_region_css_classes=>'margin-sm'
,p_region_template_options=>'#DEFAULT#:t-Alert--colorBG:t-Alert--horizontal:t-Alert--noIcon:t-Alert--warning:t-Alert--accessibleHeading'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114658241706634917)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(115172414966636592)
...
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(114773654940635039)
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_no_data_found=>'no data found'
,p_query_row_count_max=>500
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115173133406636596)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115173545191636596)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115173885565636596)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115177067541636608)
...
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(115167470930636584)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_plug_query_num_rows=>15
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115177389342636608)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(115177787112636609)
,p_name=>'Report'
,p_parent_plug_id=>wwv_flow_imp.id(115177389342636608)
,p_template=>wwv_flow_imp.id(114730045758634998)
,p_display_sequence=>10
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--stacked:t-Region--scrollBody:t-Region--noPadding'
,p_component_template_options=>'#DEFAULT#:t-AVPList--rightAligned'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115178400760636616)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115178862215636616)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115180728122636624)
,p_plug_name=>'Feedback'
,p_parent_plug_id=>wwv_flow_imp.id(115177389342636608)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:u-colors'
...
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(115168505853636584)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
,p_plug_query_num_rows=>15
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115171595971636591)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115171239698636591)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115176161097636607)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115171595971636591)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115176592804636608)
,p_event_id=>wwv_flow_imp.id(115176161097636607)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115172414966636592)
,p_attribute_01=>'N'
);
end;
/
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(114923242246635801)
,p_step_template=>wwv_flow_imp.id(114634440583634881)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114986115737636075)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114986286084636078)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(114986880666636079)
,p_name=>'Configuration Options'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114987656993636101)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114988074117636102)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114988464140636102)
,p_db_column_name=>'STATUS'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114988797320636107)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114989185411636108)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114989676529636108)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(114989995140636109)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(114992792635636114)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114994367521636118)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(114986115737636075)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114993723719636116)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(114986286084636078)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(114995143805636120)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(114994684457636119)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114995474576636121)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(114995529728636121)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114997940865636124)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(114995474576636121)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(114996521886636122)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(114995474576636121)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(114998310482636124)
,p_branch_name=>'Branch to Admin Page'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114998646406636125)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(114995529728636121)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(114999281594636142)
...
,p_lov=>'.'||wwv_flow_imp.id(114999413470636142)||'.'
,p_grid_label_column_span=>0
,p_field_template=>wwv_flow_imp.id(114800804265635081)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(114996657345636122)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(114996521886636122)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(114997326854636123)
,p_event_id=>wwv_flow_imp.id(114996657345636122)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115000509305636151)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115000964799636152)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115001197081636152)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(115001352299636152)
,p_region_id=>wwv_flow_imp.id(115001197081636152)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(115003397961636161)
,p_chart_id=>wwv_flow_imp.id(115001352299636152)
,p_seq=>10
,p_name=>'Series 1'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(115004061855636166)
,p_chart_id=>wwv_flow_imp.id(115001352299636152)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(115004637780636169)
,p_chart_id=>wwv_flow_imp.id(115001352299636152)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115001437770636152)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(115001563016636152)
,p_region_id=>wwv_flow_imp.id(115001437770636152)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(115008431784636179)
,p_chart_id=>wwv_flow_imp.id(115001563016636152)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(115009652421636180)
,p_chart_id=>wwv_flow_imp.id(115001563016636152)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(115009028428636179)
,p_chart_id=>wwv_flow_imp.id(115001563016636152)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115001628882636152)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(115001762501636152)
,p_region_id=>wwv_flow_imp.id(115001628882636152)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(115005923752636175)
,p_chart_id=>wwv_flow_imp.id(115001762501636152)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(115007178207636178)
,p_chart_id=>wwv_flow_imp.id(115001762501636152)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(115006512860636177)
,p_chart_id=>wwv_flow_imp.id(115001762501636152)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(115001847553636152)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115010753248636187)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115011097986636189)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(115001954638636152)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115013819827636232)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115014270887636232)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115002070832636152)
,p_plug_name=>'Filters'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115016524445636242)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115001197081636152)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115016945047636242)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115001437770636152)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115017322917636243)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115001628882636152)
,p_button_name=>'VIEW_ACTIVITY_BY_USER'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--noUI'
,p_button_template_id=>wwv_flow_imp.id(114802929028635087)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115017771577636243)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115001847553636152)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115002134289636152)
,p_name=>'P10030_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115002070832636152)
,p_prompt=>'Timeframe'
,p_source=>'900'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115002228024636152)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115019323123636245)
,p_event_id=>wwv_flow_imp.id(115002228024636152)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115001197081636152)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115019795568636246)
,p_event_id=>wwv_flow_imp.id(115002228024636152)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115001628882636152)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115020319112636246)
,p_event_id=>wwv_flow_imp.id(115002228024636152)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115001437770636152)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115020851769636246)
,p_event_id=>wwv_flow_imp.id(115002228024636152)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115001847553636152)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115021353667636246)
,p_event_id=>wwv_flow_imp.id(115002228024636152)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115001954638636152)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115055073786636305)
,p_plug_name=>'Top Users'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--noBorders'
,p_plug_template=>wwv_flow_imp.id(114720261633634994)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115056171371636307)
,p_name=>'Top Users'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115056822366636319)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115057174590636319)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115057577848636327)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115057926500636329)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115058303025636332)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115058741258636335)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115059112242636338)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115059540325636342)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115062630484636374)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115055100959636305)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--slimPadding:t-ButtonRegion--noUI:t-Form--large'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115055316802636305)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(115055464737636305)
,p_region_id=>wwv_flow_imp.id(115055316802636305)
,p_chart_type=>'donut'
,p_height=>'600'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(115066225853636383)
,p_chart_id=>wwv_flow_imp.id(115055464737636305)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115063480290636378)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115055073786636305)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115055530518636305)
,p_name=>'P10031_VIEW_AS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(115055100959636305)
,p_prompt=>'View As'
,p_source=>'REPORT'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'VIEW_AS_REPORT_CHART'
,p_lov=>'.'||wwv_flow_imp.id(115066761787636386)||'.'
,p_field_template=>wwv_flow_imp.id(114800804265635081)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115055745144636307)
...
' order by insert_order'))
,p_cHeight=>1
,p_field_template=>wwv_flow_imp.id(114800922177635083)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'execute_validations', 'Y',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115055197538636305)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115064878700636381)
,p_event_id=>wwv_flow_imp.id(115055197538636305)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115055073786636305)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115068263108636387)
,p_event_id=>wwv_flow_imp.id(115055197538636305)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115048024582636298)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115048592535636298)
,p_name=>'Application Error Log'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115049313965636300)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115049736578636300)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115050123950636300)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115050480957636301)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115050918438636301)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115051352425636301)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115053796867636304)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115054715517636305)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115048024582636298)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115033415830636280)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115034052548636280)
,p_name=>'Page Performance'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115034964908636289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115035308945636289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115035774214636289)
,p_db_column_name=>'MEDIAN_ELAPSED'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Median Elapsed'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115036149882636289)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115036547474636289)
,p_db_column_name=>'ERRORS'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Errors'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115036917746636290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115037325861636290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115037710519636290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115038131769636290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115038513635636290)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115038907046636291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115039302591636291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115039744431636291)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115040115470636291)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115045296218636294)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115033494414636280)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--slimPadding:t-ButtonRegion--noUI:t-Form--large'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115046183945636295)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115033415830636280)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115033334206636280)
,p_name=>'P10033_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115033494414636280)
,p_prompt=>'Timeframe'
,p_source=>'900'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115033626765636280)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115047519777636296)
,p_event_id=>wwv_flow_imp.id(115033626765636280)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115033415830636280)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115021865651636252)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115022389251636252)
,p_name=>'Page Views'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115023085826636262)
,p_db_column_name=>'PAGE_NAME'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Page Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115023560139636262)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115023891786636262)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115024302791636262)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115024764582636264)
,p_db_column_name=>'PAGE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Page'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115025149026636264)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115025564179636264)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115025941749636264)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115026581989636265)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115027039595636265)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115030742152636268)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115021961513636252)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--slimPadding:t-ButtonRegion--noUI:t-Form--large'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115031638832636268)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115021865651636252)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115021744445636252)
,p_name=>'P10034_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115021961513636252)
,p_prompt=>'Timeframe'
,p_source=>'900'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115022054529636252)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115032941859636273)
,p_event_id=>wwv_flow_imp.id(115022054529636252)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115021865651636252)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115068767970636391)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115069325125636391)
,p_name=>'Automations Log'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115070076498636408)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115070422060636408)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115070843979636408)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115071179555636408)
,p_db_column_name=>'STATUS'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115071630886636409)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115072048718636409)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115072455501636409)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115072841946636409)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115073255391636410)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115076584360636412)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115077552992636412)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115068767970636391)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115078094526636413)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(115080422320636421)
,p_name=>'Messages'
,p_template=>wwv_flow_imp.id(114720261633634994)
,p_display_sequence=>10
,p_region_template_options=>'#DEFAULT#:t-IRR-region--noBorders'
,p_component_template_options=>'#DEFAULT#:t-Report--stretch:t-Report--altRowsDefault:t-Report--rowHighlight:t-Report--inline'
,p_source_type=>'NATIVE_SQL_REPORT'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115080878350636426)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115081254420636426)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115081652411636426)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115082075439636427)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115078540701636414)
,p_name=>'P10036_LOG_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115078094526636413)
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115078956191636419)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115079199130636420)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115079634739636421)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115080065278636421)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115084215840636429)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115084346794636429)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115085524789636431)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115084346794636429)
,p_button_name=>'APPLY_CHANGES'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115085877634636431)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115084346794636429)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(115087236314636435)
,p_branch_name=>'Branch to Admin Page'
,p_branch_action=>'f?p=&APP_ID.:10000:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115087486690636435)
,p_name=>'P10040_ALLOW_OTHER_USERS'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(115084215840636429)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115085905057636431)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115085877634636431)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115086673335636435)
,p_event_id=>wwv_flow_imp.id(115085905057636431)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115087927915636437)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115088375230636438)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115089123306636440)
,p_name=>'Manage User Access'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_base_pk1=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115089861113636443)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115090190820636443)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115090661046636443)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115092241723636444)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115093106971636445)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115088375230636438)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115093565332636445)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(115088375230636438)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115093886170636445)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(115088375230636438)
,p_button_name=>'ADD_USER'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115088381100636438)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(115088375230636438)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115094480948636445)
,p_event_id=>wwv_flow_imp.id(115088381100636438)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115088375230636438)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115095059907636447)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115095177875636447)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115097907238636451)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(115095177875636447)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
,p_button_is_hot=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115098313703636451)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(115095177875636447)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115096166594636449)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115095177875636447)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115097558589636451)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115095177875636447)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115098613197636452)
,p_name=>'P10042_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115095059907636447)
,p_item_source_plug_id=>wwv_flow_imp.id(115095059907636447)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115098988357636453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115099464341636453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115099849096636453)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(115101085704636462)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115096224537636449)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115096166594636449)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115096938996636449)
,p_event_id=>wwv_flow_imp.id(115096224537636449)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115101419314636463)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(115095059907636447)
,p_process_type=>'NATIVE_FORM_INIT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115101785759636463)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(115095059907636447)
,p_process_type=>'NATIVE_FORM_DML'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115102179803636463)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115102652186636463)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115102718411636463)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115102856336636463)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115102652186636463)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115104800249636466)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115102652186636463)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(115106084396636467)
,p_branch_action=>'f?p=&APP_ID.:10044:&APP_SESSION.::&DEBUG.:RP,10044::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(115102856336636463)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115106547390636467)
,p_name=>'P10043_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(115102718411636463)
,p_prompt=>'Roles'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'ACCESS_ROLES'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115106895037636468)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115107366287636471)
...
,p_lov=>'.'||wwv_flow_imp.id(115107419051636471)||'.'
,p_field_template=>wwv_flow_imp.id(114802399590635084)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115104924345636466)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115104800249636466)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115105584513636467)
,p_event_id=>wwv_flow_imp.id(115104924345636466)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115108432267636479)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115102856336636463)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115102911172636463)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115102986750636463)
,p_plug_name=>'Wizard Container'
,p_region_template_options=>'#DEFAULT#:t-Form--stretchInputs'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(115103252773636463)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(115102986750636463)
,p_template=>wwv_flow_imp.id(114682336616634960)
,p_display_sequence=>60
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115110356085636484)
,p_query_column_id=>1
,p_column_alias=>'USERNAME'
,p_column_display_sequence=>1
,p_column_heading=>'Username'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(115110760539636484)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115103352189636463)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115103452288636463)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115113780305636495)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115114495977636498)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115103549959636463)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115102911172636463)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115115185403636499)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115102911172636463)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115115591559636500)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115102911172636463)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115116910880636500)
,p_name=>'P10044_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115103452288636463)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115117301067636501)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115117688289636501)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115115683918636500)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115115591559636500)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115116474762636500)
,p_event_id=>wwv_flow_imp.id(115115683918636500)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115118084319636501)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115103549959636463)
,p_process_success_message=>'User(s) added.'
,p_internal_uid=>11366704850258709
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115118497338636502)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115118972578636502)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115119055796636502)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115119175204636502)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115119055796636502)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115122140311636507)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115119055796636502)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(115129835399636515)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115123425028636508)
,p_name=>'P10050_APPLICATION_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115118972578636502)
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115123826439636508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115124180084636508)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115124608619636510)
...
,p_lov=>'.'||wwv_flow_imp.id(115124740628636510)||'.'
,p_field_template=>wwv_flow_imp.id(114801084727635083)
,p_item_template_options=>'#DEFAULT#:t-Form-fieldContainer--radioButtonGroup'
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115126505254636512)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(115129471731636515)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115122251918636507)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115122140311636507)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115122942002636507)
,p_event_id=>wwv_flow_imp.id(115122251918636507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115126953290636513)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115119175204636502)
,p_process_success_message=>'Feedback Submitted'
,p_internal_uid=>11375573821258721
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115127475328636513)
,p_page_process_id=>wwv_flow_imp.id(115126953290636513)
,p_page_id=>10050
,p_name=>'p_comment'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115127932106636513)
,p_page_process_id=>wwv_flow_imp.id(115126953290636513)
,p_page_id=>10050
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115128440621636513)
,p_page_process_id=>wwv_flow_imp.id(115126953290636513)
,p_page_id=>10050
,p_name=>'p_page_id'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115128927770636513)
,p_page_process_id=>wwv_flow_imp.id(115126953290636513)
,p_page_id=>10050
,p_name=>'p_rating'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115119536069636503)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115119451966636503)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115119536069636503)
,p_button_name=>'CLOSE'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115119651634636503)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115119451966636503)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115131369645636517)
,p_event_id=>wwv_flow_imp.id(115119651634636503)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115120851996636503)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115144251149636536)
,p_name=>'Manage Feedback'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_base_pk1=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115144948282636549)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115145300253636550)
,p_db_column_name=>'PAGE_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Page'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115145759778636550)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115146151565636550)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115146484971636550)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115146915972636551)
...
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(115124740628636510)
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115147305106636551)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115147725561636551)
,p_db_column_name=>'STATUS'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Status'
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(115137060467636527)
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115148125849636554)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115148566486636555)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115148970345636555)
,p_db_column_name=>'UPDATED'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Updated'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115149372034636555)
,p_db_column_name=>'UPDATED_BY'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Updated By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115149741716636556)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115154336977636558)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115155244624636559)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115120851996636503)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>wwv_flow_imp.id(114803773322635089)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115120720122636503)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(115120851996636503)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115155974267636559)
,p_event_id=>wwv_flow_imp.id(115120720122636503)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(115120851996636503)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115120150643636503)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115120243827636503)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114666231652634933)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115120312694636503)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115120243827636503)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--gapLeft'
,p_button_template_id=>wwv_flow_imp.id(114803604149635089)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115132928982636519)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(115120243827636503)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115120551886636503)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(115120243827636503)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115134545285636520)
,p_name=>'P10054_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115120150643636503)
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115134959825636521)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115135356621636523)
,p_name=>'P10054_FILED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(115120150643636503)
,p_prompt=>'Filed'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115135682947636523)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115136081183636524)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115136484156636524)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115136952121636527)
...
,p_lov=>'.'||wwv_flow_imp.id(115137060467636527)||'.'
,p_field_template=>wwv_flow_imp.id(114801084727635083)
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'execute_validations', 'Y',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115139205712636528)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115133007936636520)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(115132928982636519)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115133745975636520)
,p_event_id=>wwv_flow_imp.id(115133007936636520)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115139722633636529)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Load Data'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115140033830636530)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115120312694636503)
,p_process_success_message=>'Action Processed.'
,p_internal_uid=>11388654361258738
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115140480801636530)
,p_page_process_id=>wwv_flow_imp.id(115140033830636530)
,p_page_id=>10054
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115141045022636530)
,p_page_process_id=>wwv_flow_imp.id(115140033830636530)
,p_page_id=>10054
,p_name=>'p_status'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115141547435636530)
,p_page_process_id=>wwv_flow_imp.id(115140033830636530)
,p_page_id=>10054
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115141942125636531)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(115120551886636503)
,p_process_success_message=>'Feedback Deleted'
,p_internal_uid=>11390562656258739
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(115142392251636532)
,p_page_process_id=>wwv_flow_imp.id(115141942125636531)
,p_page_id=>10054
,p_name=>'p_feedback_id'
,p_direction=>'IN'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115142892862636532)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Page(s) Cache'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(115143291090636533)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115156801755636565)
,p_plug_name=>'About Page'
,p_region_template_options=>'#DEFAULT#:t-ContentBlock--padded:t-ContentBlock--h1:t-ContentBlock--lightBG'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(114692122764634966)
,p_plug_display_sequence=>20
,p_query_type=>'SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115157516201636566)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115157949233636566)
,p_name=>'P10061_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115157516201636566)
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(115181177642636628)
,p_step_template=>wwv_flow_imp.id(114627480759634843)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115186262856636635)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115186639524636635)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(114670563894634934)
,p_plug_display_sequence=>20
,p_query_type=>'TABLE'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(115187111754636637)
,p_region_id=>wwv_flow_imp.id(115186639524636635)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115187660664636639)
,p_plug_name=>'Settings'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges:u-colors'
,p_plug_template=>wwv_flow_imp.id(114663420892634928)
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(115185201448636634)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(114786583827635069)
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115182656847636629)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115182988849636631)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(115182377929636629)
,p_button_sequence=>10
,p_button_name=>'BACK'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115183549567636632)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115182988849636631)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(115183874705636632)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115184321891636633)
,p_event_id=>wwv_flow_imp.id(115183874705636632)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(115184830142636633)
,p_event_id=>wwv_flow_imp.id(115183874705636632)
