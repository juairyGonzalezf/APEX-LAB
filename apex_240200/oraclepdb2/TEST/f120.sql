...
,p_authentication_id=>wwv_flow_imp.id(102379625979981171)
...
,p_security_scheme=>wwv_flow_imp.id(102675050246981353)
...
,p_print_remote_server_id=>wwv_flow_imp.id(24045738037189462)
,p_file_storage=>'DB'
,p_is_pwa=>'Y'
...
,p_pwa_push_credential_id=>wwv_flow_imp.id(25998241912373547)
);
end;
/
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(102380458816981174)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(102669708773981340)
...
wwv_imp_workspace.create_credential(
 p_id=>wwv_flow_imp.id(25998241912373547)
...
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(24045738037189462)
,p_name=>'Print server'
,p_static_id=>'Print_server'
,p_base_url=>nvl(wwv_flow_application_install.get_remote_server_base_url('Print_server'),'http://localhost:8080/ords/')
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102380458816981174)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>5391915
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102684790199981376)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102686255504981378)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(100963663901421546)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102898197663981589)
,p_list_item_display_sequence=>10000
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=&APP_ID.:10000:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-user-wrench'
,p_security_scheme=>wwv_flow_imp.id(102674988214981353)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102669708773981340)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
,p_version_scn=>5036503
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102894441858981588)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102894887959981588)
,p_list_item_display_sequence=>20
...
,p_required_patch=>wwv_flow_imp.id(102672457890981350)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102895173457981588)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'About'
,p_list_item_icon=>'fa-question-circle-o'
,p_list_text_02=>'icon-only'
,p_required_patch=>wwv_flow_imp.id(102672973165981350)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102895606539981588)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Page Help'
,p_list_item_link_target=>'f?p=&APP_ID.:10061:&APP_SESSION.::&DEBUG.::P10061_PAGE_ID:&APP_PAGE_ID.'
,p_list_item_icon=>'fa-question-circle-o'
,p_parent_list_item_id=>wwv_flow_imp.id(102895173457981588)
,p_list_text_02=>'icon-only'
,p_required_patch=>wwv_flow_imp.id(102672973165981350)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102895999365981588)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102896394276981589)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102896724982981589)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102924168168981616)
,p_list_item_display_sequence=>1
,p_list_item_link_text=>'Settings'
,p_list_item_link_target=>'f?p=&APP_ID.:20000:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-gear'
,p_parent_list_item_id=>wwv_flow_imp.id(102896724982981589)
,p_required_patch=>wwv_flow_imp.id(102917702322981610)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102897292032981589)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102897613457981589)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102721527726981431)
,p_name=>'Page Navigation'
,p_list_status=>'PUBLIC'
,p_version_scn=>5036098
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102721917047981431)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'test'
,p_list_item_link_target=>'f?p=&APP_ID.:2:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-table'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102899360795981590)
,p_name=>'Application Configuration'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(102672609415981350)
,p_version_scn=>5036472
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102899733642981590)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102899999107981590)
,p_name=>'User Interface'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(102673083255981350)
,p_version_scn=>5036472
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102900440689981591)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102900743583981591)
,p_name=>'Activity Reports'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(102672358951981350)
,p_version_scn=>5036475
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102901132496981591)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102901511779981591)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102901921874981591)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102902389329981591)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102902735797981591)
,p_list_item_display_sequence=>50
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102903145393981592)
,p_list_item_display_sequence=>60
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102903470953981592)
,p_name=>'Access Control'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(102672264345981350)
,p_version_scn=>5036475
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102903858950981592)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102904270170981592)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102904562041981592)
,p_name=>'Feedback'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(102672457890981350)
,p_version_scn=>5036475
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102904909166981592)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(102921335823981613)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102921778036981613)
,p_list_item_display_sequence=>10
...
,p_required_patch=>wwv_flow_imp.id(102917421817981610)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(102670855677981348)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(102671186884981349)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(102671462968981349)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(102671763627981349)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(102672075706981349)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98470297709659356)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>5275759
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102375467369981168)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102375759793981169)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102376010725981169)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>5034710
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102376302381981169)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102376595381981170)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102376925784981170)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102377224590981170)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>5034710
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102377560443981170)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102377821371981170)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102378151422981170)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102378410985981170)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102378728186981170)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(102379024586981170)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(102674988214981353)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(102675050246981353)
...
begin
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(102675149223981353)
...
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(102674536209981352)
...
begin
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(102674730095981352)
...
begin
wwv_flow_imp_shared.create_acl_role(
 p_id=>wwv_flow_imp.id(102674853552981352)
,p_static_id=>'READER'
,p_name=>'Reader'
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(102675991616981355)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(102676287088981356)
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102835923288981549)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102735358700981446)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102843415489981555)
,p_lov_name=>'EMAIL_USERNAME_FORMAT'
,p_lov_query=>'.'||wwv_flow_imp.id(102843415489981555)||'.'
,p_location=>'STATIC'
,p_version_scn=>5036434
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102843756292981555)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102860753258981568)
,p_lov_name=>'FEEDBACK_RATING'
,p_lov_query=>'.'||wwv_flow_imp.id(102860753258981568)||'.'
,p_location=>'STATIC'
,p_version_scn=>5036442
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102861086646981568)
,p_lov_disp_sequence=>1
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102861460665981568)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102861848461981568)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102873167046981574)
,p_lov_name=>'FEEDBACK_STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(102873167046981574)||'.'
,p_location=>'STATIC'
,p_version_scn=>5036445
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102873451017981574)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'No Action'
,p_lov_return_value=>'0'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102873810248981574)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Acknowledged'
,p_lov_return_value=>'1'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102874253977981574)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'Open'
,p_lov_return_value=>'3'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102874664894981574)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102755088773981475)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102736019712981452)
,p_lov_name=>'USER_THEME_PREFERENCE'
,p_lov_query=>'.'||wwv_flow_imp.id(102736019712981452)||'.'
,p_location=>'STATIC'
,p_version_scn=>5036130
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102736328373981452)
,p_lov_disp_sequence=>1
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(102802669225981520)
,p_lov_name=>'VIEW_AS_REPORT_CHART'
,p_lov_query=>'.'||wwv_flow_imp.id(102802669225981520)||'.'
,p_location=>'STATIC'
,p_version_scn=>5036376
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102802916539981520)
,p_lov_disp_sequence=>1
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(102803344218981520)
,p_lov_disp_sequence=>2
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(102676589574981357)
,p_group_name=>'Administration'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(102917280147981609)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(102379991788981172)
,p_name=>'Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(100964508496421554)
,p_short_name=>'Employess'
,p_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>6
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102380150654981172)
,p_short_name=>'Home'
,p_link=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102705232958981407)
,p_short_name=>'test'
,p_link=>'f?p=&APP_ID.:2:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>2
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102899166579981590)
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(102646979660981331)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102379370073981171)
,p_build_option_name=>'Commented Out'
,p_build_option_status=>'EXCLUDE'
,p_version_scn=>5034710
);
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102672264345981350)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102672358951981350)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102672457890981350)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102672609415981350)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102672973165981350)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102673083255981350)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102917421817981610)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(102917702322981610)
...
wwv_flow_imp_shared.create_shared_query(
 p_id=>wwv_flow_imp.id(103368245245337849)
,p_name=>'test'
,p_static_id=>'TEST'
,p_include_session_state=>'N'
,p_report_layout_id=>wwv_flow_imp.id(103367684869329873)
,p_format=>'PDF'
,p_output_file_name=>'test'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_imp_shared.create_shared_query_stmnt(
 p_id=>wwv_flow_imp.id(103368585328337865)
,p_shared_query_id=>wwv_flow_imp.id(103368245245337849)
,p_name=>'test'
...
wwv_flow_imp_shared.create_report_layout(
 p_id=>wwv_flow_imp.id(100973380089830747)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(102379625979981171)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102685631396981377)
,p_plug_name=>'test'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102722276589981431)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(102721527726981431)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102698648125981397)
...
,p_prn_template_id=>wwv_flow_imp.id(103367684869329873)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102698760230981397)
,p_name=>'test'
...
,p_detail_link_auth_scheme=>wwv_flow_imp.id(102675149223981353)
,p_owner=>'GONZALEZFJU'
,p_internal_uid=>5932568187812623
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100949439047416075)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100949512037416076)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100949607358416077)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100949709575416078)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100949844046416079)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100949982622416080)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102706696483981415)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102704729762981406)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(102379991788981172)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102703502622981404)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102698648125981397)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102703835660981404)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(102698648125981397)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102704382690981405)
,p_event_id=>wwv_flow_imp.id(102703835660981404)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102698648125981397)
,p_attribute_01=>'N'
);
end;
/
...
,p_required_role=>wwv_flow_imp.id(102675149223981353)
,p_dialog_chained=>'N'
,p_protection_level=>'C'
,p_page_component_map=>'02'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102686808373981387)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102694242344981394)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102694654246981394)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102694242344981394)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102696077070981395)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102696471654981396)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102696816416981396)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102687214096981387)
,p_name=>'P3_ID'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102686808373981387)
,p_item_source_plug_id=>wwv_flow_imp.id(102686808373981387)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102687622584981389)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102688080930981390)
,p_name=>'P3_PROJECT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102688459695981390)
,p_name=>'P3_TASK_NAME'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>40
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102688870049981390)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102689246885981391)
,p_name=>'P3_END_DATE'
,p_source_data_type=>'DATE'
,p_is_required=>true
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102689614982981391)
,p_name=>'P3_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>70
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102690047961981391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102690478817981391)
,p_name=>'P3_COST'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(102686808373981387)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102690816345981392)
,p_name=>'P3_BUDGET'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(102686808373981387)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102694727607981394)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102694654246981394)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102695500810981395)
,p_event_id=>wwv_flow_imp.id(102694727607981394)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102697640096981396)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(102686808373981387)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102698003059981396)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102697267127981396)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(100964020336421550)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(100964764354421554)
...
,p_include_rowid_column=>false
,p_plug_source_type=>'NATIVE_IR'
,p_prn_template_id=>wwv_flow_imp.id(100973380089830747)
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
,p_prn_width=>11
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(100964841919421554)
,p_name=>'Employess'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100965557213421560)
,p_db_column_name=>'EMPID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100965916815421561)
,p_db_column_name=>'FIRSTNAME'
,p_display_order=>2
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100966314668421561)
,p_db_column_name=>'LASTNAME'
,p_display_order=>3
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100966736085421561)
,p_db_column_name=>'EMAIL'
,p_display_order=>4
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100967094201421561)
,p_db_column_name=>'PHONENO'
,p_display_order=>5
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(100967553651421562)
,p_db_column_name=>'SALARY'
,p_display_order=>6
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(100967897184422017)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102678210562981366)
,p_plug_name=>'test'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102680345747981372)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(102678210562981366)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102678722891981369)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102678210562981366)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102679102950981369)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102679499385981371)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102679988255981371)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102682563383981374)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102683085105981374)
,p_page_process_id=>wwv_flow_imp.id(102682563383981374)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102683519538981374)
,p_page_process_id=>wwv_flow_imp.id(102682563383981374)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102680670846981372)
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102681121915981373)
,p_page_process_id=>wwv_flow_imp.id(102680670846981372)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102681622327981374)
,p_page_process_id=>wwv_flow_imp.id(102680670846981372)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102682133067981374)
,p_page_process_id=>wwv_flow_imp.id(102680670846981372)
,p_page_id=>9999
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102684415724981375)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102684055640981375)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(102676589574981357)
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_imp.id(102674988214981353)
,p_protection_level=>'C'
,p_deep_linking=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102898646814981590)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102905232947981592)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102905629463981593)
,p_plug_name=>'Configuration'
,p_parent_plug_id=>wwv_flow_imp.id(102905232947981592)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>40
,p_list_id=>wwv_flow_imp.id(102899360795981590)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102905993704981593)
...
,p_list_id=>wwv_flow_imp.id(102899999107981590)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_plug_query_num_rows=>15
,p_required_patch=>wwv_flow_imp.id(102673083255981350)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102906458804981593)
...
,p_list_id=>wwv_flow_imp.id(102900743583981591)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_plug_query_num_rows=>15
,p_required_patch=>wwv_flow_imp.id(102672358951981350)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102906872435981594)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102907286729981594)
,p_plug_name=>'Access Control'
,p_parent_plug_id=>wwv_flow_imp.id(102906872435981594)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102908036438981594)
,p_plug_name=>'ACL Information'
,p_parent_plug_id=>wwv_flow_imp.id(102907286729981594)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(102908427382981595)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102909157040981597)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102909517832981598)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102909919159981598)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102913003473981602)
...
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(102903470953981592)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_plug_query_num_rows=>15
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102913447842981602)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(102913821005981603)
,p_name=>'Report'
,p_parent_plug_id=>wwv_flow_imp.id(102913447842981602)
,p_template=>4072358936313175081
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102914534644981605)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102914974260981605)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102916814048981609)
,p_plug_name=>'Feedback'
,p_parent_plug_id=>wwv_flow_imp.id(102913447842981602)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:u-colors'
...
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(102904562041981592)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_plug_query_num_rows=>15
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102907657403981594)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102907286729981594)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102912167445981602)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102907657403981594)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102912623886981602)
,p_event_id=>wwv_flow_imp.id(102912167445981602)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102908427382981595)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102722643041981432)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102722796201981432)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102723416773981433)
,p_name=>'Configuration Options'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102724104667981438)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102724557645981439)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102724982085981439)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102725373371981439)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102725693769981439)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102726098066981439)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102726580393981440)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102729390256981442)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102730897875981444)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102722643041981432)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102730195546981443)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102722796201981432)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(102731694181981444)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102731362619981444)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102732076418981445)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102732190485981445)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102734527335981446)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102732076418981445)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102733156352981445)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102732076418981445)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(102734957067981446)
,p_branch_name=>'Branch to Admin Page'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102735202645981446)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102732190485981445)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102735908969981452)
...
,p_lov=>'.'||wwv_flow_imp.id(102736019712981452)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102733248457981445)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102733156352981445)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102733974387981446)
,p_event_id=>wwv_flow_imp.id(102733248457981445)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102737157329981454)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102737515658981454)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102737843676981455)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(102737929850981455)
,p_region_id=>wwv_flow_imp.id(102737843676981455)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(102740076994981456)
,p_chart_id=>wwv_flow_imp.id(102737929850981455)
,p_seq=>10
,p_name=>'Series 1'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(102740690578981457)
,p_chart_id=>wwv_flow_imp.id(102737929850981455)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(102741242557981458)
,p_chart_id=>wwv_flow_imp.id(102737929850981455)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102738034995981455)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(102738163145981455)
,p_region_id=>wwv_flow_imp.id(102738034995981455)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(102745020847981460)
,p_chart_id=>wwv_flow_imp.id(102738163145981455)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(102745664887981460)
,p_chart_id=>wwv_flow_imp.id(102738163145981455)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(102746276743981460)
,p_chart_id=>wwv_flow_imp.id(102738163145981455)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102738197551981455)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(102738384306981455)
,p_region_id=>wwv_flow_imp.id(102738197551981455)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'horizontal'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(102742546683981459)
,p_chart_id=>wwv_flow_imp.id(102738384306981455)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(102743112248981459)
,p_chart_id=>wwv_flow_imp.id(102738384306981455)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_baseline_scaling=>'zero'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(102743735001981459)
,p_chart_id=>wwv_flow_imp.id(102738384306981455)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(102738442269981455)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102747352871981464)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102747710485981464)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(102738536599981455)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102750587694981471)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102750957557981471)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102738623640981455)
,p_plug_name=>'Filters'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102753245186981475)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102737843676981455)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102753634379981475)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102738034995981455)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102754088522981475)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102738197551981455)
,p_button_name=>'VIEW_ACTIVITY_BY_USER'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--noUI'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102754444529981475)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102738442269981455)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102738701535981455)
,p_name=>'P10030_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102738623640981455)
,p_prompt=>'Timeframe'
,p_source=>'900'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102738832589981455)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102756057147981477)
,p_event_id=>wwv_flow_imp.id(102738832589981455)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102737843676981455)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102756582744981477)
,p_event_id=>wwv_flow_imp.id(102738832589981455)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102738197551981455)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102757047417981477)
,p_event_id=>wwv_flow_imp.id(102738832589981455)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102738034995981455)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102757561782981477)
,p_event_id=>wwv_flow_imp.id(102738832589981455)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102738442269981455)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102758075710981477)
,p_event_id=>wwv_flow_imp.id(102738832589981455)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102738536599981455)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102790795766981504)
,p_plug_name=>'Top Users'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--noBorders'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102791975654981504)
,p_name=>'Top Users'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102792637416981511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102793066145981511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102793449094981511)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102793836099981512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102794218372981512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102794632094981513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102795009152981513)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102795416487981514)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102798581617981516)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102790942961981504)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--slimPadding:t-ButtonRegion--noUI:t-Form--large'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102791150017981504)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(102791198785981504)
,p_region_id=>wwv_flow_imp.id(102791150017981504)
,p_chart_type=>'donut'
,p_height=>'600'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(102802127162981519)
,p_chart_id=>wwv_flow_imp.id(102791198785981504)
,p_seq=>10
,p_name=>'Series 1'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102799471264981517)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102790795766981504)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102791391417981504)
,p_name=>'P10031_VIEW_AS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(102790942961981504)
,p_prompt=>'View As'
,p_source=>'REPORT'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'VIEW_AS_REPORT_CHART'
,p_lov=>'.'||wwv_flow_imp.id(102802669225981520)||'.'
,p_field_template=>2040785906935475274
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102791554967981504)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102791011835981504)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102800776882981518)
,p_event_id=>wwv_flow_imp.id(102791011835981504)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102790795766981504)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102804150722981521)
,p_event_id=>wwv_flow_imp.id(102791011835981504)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102783885417981500)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102784491343981500)
,p_name=>'Application Error Log'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102785181204981501)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102785564523981502)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102785925120981502)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102786311190981502)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102786789843981502)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102787108031981502)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102789630725981504)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102790531961981504)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102783885417981500)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102769705991981489)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102770388433981489)
,p_name=>'Page Performance'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102771017029981493)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102771416328981493)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102771841397981493)
,p_db_column_name=>'MEDIAN_ELAPSED'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Median Elapsed'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102772192065981494)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102772630579981494)
,p_db_column_name=>'ERRORS'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Errors'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102773059457981494)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102773406116981494)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102773835182981494)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102774202494981494)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102774631420981495)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102775025214981495)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102775400056981495)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102775805678981495)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102776227901981495)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102781122943981498)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102769794977981489)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--slimPadding:t-ButtonRegion--noUI:t-Form--large'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102782077771981499)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102769705991981489)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102769654958981489)
,p_name=>'P10033_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102769794977981489)
,p_prompt=>'Timeframe'
,p_source=>'900'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102769897445981489)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102783369744981500)
,p_event_id=>wwv_flow_imp.id(102769897445981489)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102769705991981489)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102758549106981478)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102759117274981478)
,p_name=>'Page Views'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102759726242981483)
,p_db_column_name=>'PAGE_NAME'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Page Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102760131940981483)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102760548183981483)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102760990575981484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102761313097981484)
,p_db_column_name=>'PAGE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Page'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102761713300981484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102762134990981484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102762587244981484)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102762896857981485)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102763325021981485)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102767047886981487)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102758659104981478)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--slimPadding:t-ButtonRegion--noUI:t-Form--large'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102767903659981487)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102758549106981478)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102758485470981478)
,p_name=>'P10034_TIMEFRAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102758659104981478)
,p_prompt=>'Timeframe'
,p_source=>'900'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102758768025981478)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102769287753981488)
,p_event_id=>wwv_flow_imp.id(102758768025981478)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102758549106981478)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102804673014981521)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102805285748981521)
,p_name=>'Automations Log'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102805976618981528)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102806312306981528)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102806745188981528)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102807106810981529)
,p_db_column_name=>'STATUS'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102807566663981529)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102807916518981529)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102808359152981529)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102808713191981529)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102809146941981530)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102812550524981532)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102813487814981532)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102804673014981521)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102814044978981532)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(102816431491981533)
,p_name=>'Messages'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102816877253981536)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102817275082981536)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102817655613981537)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102818075170981537)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102814441451981533)
,p_name=>'P10036_LOG_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102814044978981532)
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102814808427981533)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102815284462981533)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102815672369981533)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102815996972981533)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102820265480981538)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102820362692981538)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102821497753981539)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102820362692981538)
,p_button_name=>'APPLY_CHANGES'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102821842353981539)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102820362692981538)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(102823268568981540)
,p_branch_name=>'Branch to Admin Page'
,p_branch_action=>'f?p=&APP_ID.:10000:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102823543402981540)
,p_name=>'P10040_ALLOW_OTHER_USERS'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(102820265480981538)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102821908187981539)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102821842353981539)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102822673590981540)
,p_event_id=>wwv_flow_imp.id(102821908187981539)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102823896540981541)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102824377867981541)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102825123815981541)
,p_name=>'Manage User Access'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_base_pk1=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102825859050981543)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102826264877981544)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102826651698981544)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102828254608981545)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102829105438981545)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102824377867981541)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102829549538981545)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(102824377867981541)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102829979346981546)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(102824377867981541)
,p_button_name=>'ADD_USER'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102824424828981541)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(102824377867981541)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102830560318981546)
,p_event_id=>wwv_flow_imp.id(102824424828981541)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102824377867981541)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102831009506981546)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102831111419981546)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102833906265981548)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(102831111419981546)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102834298078981548)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(102831111419981546)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102832130849981547)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102831111419981546)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102833493548981548)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102831111419981546)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102834645503981548)
,p_name=>'P10042_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102831009506981546)
,p_item_source_plug_id=>wwv_flow_imp.id(102831009506981546)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102835025178981548)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102835443768981548)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102835816921981549)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(102837172114981552)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102832203675981547)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102832130849981547)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102832985197981547)
,p_event_id=>wwv_flow_imp.id(102832203675981547)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102837483597981552)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(102831009506981546)
,p_process_type=>'NATIVE_FORM_INIT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102837886182981552)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(102831009506981546)
,p_process_type=>'NATIVE_FORM_DML'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102838228086981552)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102838595331981552)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102838697963981552)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102838861888981552)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102838595331981552)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102840874459981553)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102838595331981552)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(102842154887981554)
,p_branch_action=>'f?p=&APP_ID.:10044:&APP_SESSION.::&DEBUG.:RP,10044::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(102838861888981552)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102842555904981554)
,p_name=>'P10043_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(102838697963981552)
,p_prompt=>'Roles'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'ACCESS_ROLES'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102842928329981554)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102843322473981555)
...
,p_lov=>'.'||wwv_flow_imp.id(102843415489981555)||'.'
,p_field_template=>1609122147107268652
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102840967528981553)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102840874459981553)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102841652672981554)
,p_event_id=>wwv_flow_imp.id(102840967528981553)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102844487387981555)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(102838861888981552)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102838895036981552)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102839007981981552)
,p_plug_name=>'Wizard Container'
,p_region_template_options=>'#DEFAULT#:t-Form--stretchInputs'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(102839253722981552)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(102839007981981552)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102846292591981558)
,p_query_column_id=>1
,p_column_alias=>'USERNAME'
,p_column_display_sequence=>1
,p_column_heading=>'Username'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(102846791204981558)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102839361961981552)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102839411445981552)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102849814220981563)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102850551493981563)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102839578819981552)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102838895036981552)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102851214448981564)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102838895036981552)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102851595005981564)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102838895036981552)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102852944269981565)
,p_name=>'P10044_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102839411445981552)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102853323193981565)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102853776108981565)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102851777753981564)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102851595005981564)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102852460323981564)
,p_event_id=>wwv_flow_imp.id(102851777753981564)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102854163914981565)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(102839578819981552)
,p_process_success_message=>'User(s) added.'
,p_internal_uid=>6087971871812791
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102854572099981565)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102854909179981565)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102854998884981565)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102855111168981565)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102854998884981565)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102858131605981567)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102854998884981565)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(102865887197981570)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102859468274981567)
,p_name=>'P10050_APPLICATION_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102854909179981565)
,p_use_cache_before_default=>'NO'
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102859889840981567)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102860290492981567)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102860599376981568)
...
,p_lov=>'.'||wwv_flow_imp.id(102860753258981568)||'.'
,p_field_template=>1609121967514267634
,p_item_template_options=>'#DEFAULT#:t-Form-fieldContainer--radioButtonGroup'
,p_lov_display_extra=>'NO'
,p_escape_on_http_output=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102862528395981569)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(102865423247981570)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102858201595981567)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102858131605981567)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102858908605981567)
,p_event_id=>wwv_flow_imp.id(102858201595981567)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102862961437981569)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(102855111168981565)
,p_process_success_message=>'Feedback Submitted'
,p_internal_uid=>6096769394812795
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102863420535981569)
,p_page_process_id=>wwv_flow_imp.id(102862961437981569)
,p_page_id=>10050
,p_name=>'p_comment'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102863980332981570)
,p_page_process_id=>wwv_flow_imp.id(102862961437981569)
,p_page_id=>10050
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102864424818981570)
,p_page_process_id=>wwv_flow_imp.id(102862961437981569)
,p_page_id=>10050
,p_name=>'p_page_id'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102864930670981570)
,p_page_process_id=>wwv_flow_imp.id(102862961437981569)
,p_page_id=>10050
,p_name=>'p_rating'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102855543656981565)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102855402336981565)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102855543656981565)
,p_button_name=>'CLOSE'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102855684060981565)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102855402336981565)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102867414052981571)
,p_event_id=>wwv_flow_imp.id(102855684060981565)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102856832092981566)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(102880331366981577)
,p_name=>'Manage Feedback'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_base_pk1=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102881070445981579)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102881435311981579)
,p_db_column_name=>'PAGE_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Page'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102881884887981579)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102882168561981580)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102882563887981580)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102882950269981580)
...
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(102860753258981568)
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102883387436981580)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102883778575981580)
,p_db_column_name=>'STATUS'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Status'
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_imp.id(102873167046981574)
,p_use_as_row_header=>'N'
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102884148215981581)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102884511030981581)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102884951835981581)
,p_db_column_name=>'UPDATED'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Updated'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102885300410981581)
,p_db_column_name=>'UPDATED_BY'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Updated By'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(102885742574981581)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(102890310713981584)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102891229133981584)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102856832092981566)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102856765620981566)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(102856832092981566)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102891979170981585)
,p_event_id=>wwv_flow_imp.id(102856765620981566)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(102856832092981566)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102856138279981566)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102856257555981566)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102856381386981566)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102856257555981566)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--gapLeft'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102869026296981572)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102856257555981566)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102856510127981566)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102856257555981566)
,p_button_name=>'DELETE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102870598588981573)
,p_name=>'P10054_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102856138279981566)
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102871058950981573)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102871401640981573)
,p_name=>'P10054_FILED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(102856138279981566)
,p_prompt=>'Filed'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102871807166981573)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102872194182981573)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102872690395981574)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102873077929981574)
...
,p_lov=>'.'||wwv_flow_imp.id(102873167046981574)||'.'
,p_field_template=>1609121967514267634
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102875367479981575)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102869152216981572)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(102869026296981572)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102869864177981572)
,p_event_id=>wwv_flow_imp.id(102869152216981572)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102875880049981575)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102876157720981575)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(102856381386981566)
,p_process_success_message=>'Action Processed.'
,p_internal_uid=>6109965677812801
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102876642015981575)
,p_page_process_id=>wwv_flow_imp.id(102876157720981575)
,p_page_id=>10054
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102877134956981575)
,p_page_process_id=>wwv_flow_imp.id(102876157720981575)
,p_page_id=>10054
,p_name=>'p_status'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102877679053981575)
,p_page_process_id=>wwv_flow_imp.id(102876157720981575)
,p_page_id=>10054
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102878031154981576)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(102856510127981566)
,p_process_success_message=>'Feedback Deleted'
,p_internal_uid=>6111839111812802
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(102878564809981576)
,p_page_process_id=>wwv_flow_imp.id(102878031154981576)
,p_page_id=>10054
,p_name=>'p_feedback_id'
,p_direction=>'IN'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102878996487981576)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear Page(s) Cache'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102879439780981576)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102892801785981586)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102893549356981586)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102893915887981587)
,p_name=>'P10061_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102893549356981586)
,p_display_as=>'NATIVE_HIDDEN'
,p_lov_display_extra=>'NO'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(102917280147981609)
,p_step_template=>1661186590416509825
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102922306416981614)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102922715168981615)
,p_plug_name=>'&APP_USER.'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(102923219971981615)
,p_region_id=>wwv_flow_imp.id(102922715168981615)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102923708790981616)
,p_plug_name=>'Settings'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges:u-colors'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(102921335823981613)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102918775364981611)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102919142629981612)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102918487639981611)
,p_button_sequence=>10
,p_button_name=>'BACK'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102919618675981612)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102919142629981612)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102919973915981612)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102920445005981613)
,p_event_id=>wwv_flow_imp.id(102919973915981612)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102920955217981613)
,p_event_id=>wwv_flow_imp.id(102919973915981612)
