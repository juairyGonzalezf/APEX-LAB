...
begin
  wwv_imp_workspace.create_script (
    ...
    p_created_on => to_date('202605080642','YYYYMMDDHH24MI'),
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 213,
    p_owner => 'APEXPDB',
    p_access_date => to_date('202604230753','YYYYMMDDHH24MI'),
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 213,
    p_owner => 'APEXPDB',
    p_access_date => to_date('202604230757','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.107',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 213,
    p_owner => 'APEXPDB',
    p_access_date => to_date('202604230820','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.107',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 213,
    p_owner => 'APEXPDB',
    p_access_date => to_date('202604230755','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.107',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_240200',
    p_access_date => to_date('202604230750','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.107',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
'_**NOTE:** To associate an issue with an application and/or page, first log the issue, then use the **ACTIONS** drop down to associate the App and Page._'
 ...
 ,p_created_by => 'GONZALEZFJU'
 ,p_updated_on => to_date('20260508064255','YYYYMMDDHH24MISS')
