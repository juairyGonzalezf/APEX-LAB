...
,p_default_id_offset=>19833646592540698
...
,p_authentication_id=>wwv_flow_imp.id(38454550398531045)
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(56820805744524371)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(56821641525524401)
...
wwv_imp_workspace.create_credential(
 p_id=>wwv_flow_imp.id(18617636203721277)
...
begin
wwv_imp_workspace.create_credential(
 p_id=>wwv_flow_imp.id(25028851417046795)
...
begin
wwv_imp_workspace.create_credential(
 p_id=>wwv_flow_imp.id(25029429241071717)
...
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(25029089660046800)
...
,p_credential_id=>wwv_flow_imp.id(25028851417046795)
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(25029668275071717)
...
,p_credential_id=>wwv_flow_imp.id(25029429241071717)
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(26057725633048067)
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(26431435947121993)
...
wwv_flow_imp_shared.create_ai_config(
 p_id=>wwv_flow_imp.id(62539526714058135)
,p_name=>'OCI'
,p_static_id=>'oci'
,p_remote_server_id=>wwv_flow_imp.id(25029089660046800)
...
begin
wwv_flow_imp_shared.create_ai_config(
 p_id=>wwv_flow_imp.id(62539274163057021)
,p_name=>'OPENAI'
,p_static_id=>'openai'
,p_remote_server_id=>wwv_flow_imp.id(25029668275071717)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(44442687934628779)
,p_name=>'AI Generated Data Progress'
,p_list_status=>'PUBLIC'
,p_version_scn=>124383924
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44442841821628783)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44443245912628784)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44443668074628784)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45102490459210720)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(44445363586676724)
,p_name=>'Upload Data Progress'
,p_list_status=>'PUBLIC'
,p_version_scn=>124384366
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44445600862676724)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44445963226676724)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44446361232676724)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Generate Vector Embeddings'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45102823384222488)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Confirmation'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(44814961579044879)
,p_name=>'Movie Vector Search'
,p_list_status=>'PUBLIC'
,p_version_scn=>124378845
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44815187727044879)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45099565033138361)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45099895698143981)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45100140945147993)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45100487498161710)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45100830258166200)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(44912396720386507)
,p_name=>'Vector Search (Custom Data)'
,p_list_status=>'PUBLIC'
,p_version_scn=>115120918
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44912587296386508)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Basic Vector Search'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44913022198386509)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Vector vs. Oracle Text'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44913383303386509)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Vector and Oracle Text'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(44918266513504176)
,p_name=>'Custom Vector Search'
,p_list_status=>'PUBLIC'
,p_version_scn=>124364933
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44918516894504178)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Prepare Data'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44918928004504178)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Basic Vector Search'
,p_list_item_link_target=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-search'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45098491014107281)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Vector vs. Oracle Text'
,p_list_item_link_target=>'f?p=&APP_ID.:32:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-search'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(45098772084115101)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Vector and Oracle Text'
,p_list_item_link_target=>'f?p=&APP_ID.:33:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-search'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(56820805744524371)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>124400979
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(56832261105524445)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44812897976968526)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44882634230387833)
,p_list_item_display_sequence=>13
,p_list_item_link_text=>'Prepare Data'
,p_list_item_link_target=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:11:::'
,p_list_item_icon=>'fa-number-1-o'
,p_parent_list_item_id=>wwv_flow_imp.id(44812897976968526)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'11'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44885996548476273)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44886240665481351)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44886629304485024)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44916979429476011)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44917266807478885)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44813418017980948)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44907484790250346)
,p_list_item_display_sequence=>250
,p_list_item_link_text=>'Prepare Data'
,p_list_item_link_target=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:25,26,27:::'
,p_list_item_icon=>'fa-number-1-o'
,p_parent_list_item_id=>wwv_flow_imp.id(44813418017980948)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'25'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44908228411294615)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44908498227301413)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44908807317316580)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57108991131832298)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(61724023000624725)
,p_list_item_display_sequence=>150
,p_list_item_link_text=>'Set AI Provider'
,p_list_item_link_target=>'f?p=&APP_ID.:54:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-key'
,p_parent_list_item_id=>wwv_flow_imp.id(57108991131832298)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57713511581169078)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57733386370293310)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(56821641525524401)
,p_name=>'Navigation Bar'
,p_list_status=>'PUBLIC'
,p_version_scn=>50291004
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(56833764192524464)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(56834242386524465)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(56833764192524464)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(56834718998524465)
,p_list_item_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(57137707913722231)
,p_name=>'Administration'
,p_list_status=>'PUBLIC'
,p_version_scn=>124380376
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(61913548493147513)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57137928378722232)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Reset Sample Data Tables'
,p_list_item_link_target=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-database'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57138308122722233)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(57142949509757518)
,p_name=>'Vector Search (Movie Data)'
,p_list_status=>'PUBLIC'
,p_version_scn=>115119551
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57143162146757518)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Basic Vector Search'
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-search'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57143626813757519)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Vector vs. Oracle Text'
,p_list_item_link_target=>'f?p=&APP_ID.:16:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-search'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(57144004332757519)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Vector and Oracle Text'
,p_list_item_link_target=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-search'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(62402010724401089)
,p_name=>'Home Page List'
,p_list_status=>'PUBLIC'
,p_version_scn=>126221802
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(62402562491401091)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Movie Data'
,p_list_item_link_target=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-film'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(62402988553401091)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Custom Data'
,p_list_item_link_target=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-database-user'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(62403342949401091)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Administration'
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(51989031099530011)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(56822806838524411)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(56823116463524413)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(56823375400524413)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(56823731645524414)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(56823996998524414)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56815525014524363)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56815792556524365)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56816062189524365)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56816408314524365)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56816675002524365)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56817028302524365)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56817286116524365)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>50290795
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56817618092524366)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56817853506524366)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56818191519524366)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56818503408524366)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>50290795
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56818809376524366)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>50290795
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56819098031524366)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(56819412525524366)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(56825327896524415)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(58299686471796531)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(52214279654654948)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(62413135408652662)
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(52214603326670589)
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(58300259504806286)
,p_computation_sequence=>10
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(62414073000685701)
,p_computation_sequence=>10
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(52214957334683279)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(57892487416331053)
,p_name=>'AI_PROVIDER'
,p_value=>'OPENAI'
,p_is_required=>'N'
,p_valid_values=>'OPENAI,OCI,NONE'
,p_on_upgrade_keep_value=>true
,p_version_scn=>160026159
);
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(62413475036668437)
,p_name=>'WC_STATUS'
,p_value=>'VOID'
,p_is_required=>'N'
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(56825619907524417)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(56820309911524369)
,p_name=>'Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(57345729297264278)
,p_parent_id=>wwv_flow_imp.id(57109895295832299)
,p_option_sequence=>5
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44814308151010637)
,p_short_name=>'Movie Vector Search'
,p_link=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.:::'
,p_page_id=>10
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44922504397594941)
,p_parent_id=>wwv_flow_imp.id(44929043284788783)
,p_short_name=>'Basic Vector Search'
,p_link=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:::'
,p_page_id=>15
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44923883706615127)
,p_parent_id=>wwv_flow_imp.id(44923638409611042)
,p_short_name=>'Vector Search'
,p_link=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::'
,p_page_id=>30
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44924136079619305)
,p_parent_id=>wwv_flow_imp.id(44923883706615127)
,p_short_name=>'Basic Vector Search'
,p_link=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.:::'
,p_page_id=>31
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44929043284788783)
,p_parent_id=>wwv_flow_imp.id(44814308151010637)
,p_short_name=>'Vector Search'
,p_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::'
,p_page_id=>14
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(45441612089287545)
,p_parent_id=>wwv_flow_imp.id(57109895295832299)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(56820532399524369)
,p_short_name=>'Home'
,p_link=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>1
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(57107290985821676)
,p_short_name=>'Movie Recommendation'
,p_link=>'f?p=&APP_ID.:41:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>41
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(57726334091195989)
,p_parent_id=>wwv_flow_imp.id(57109895295832299)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44924333654628977)
,p_parent_id=>wwv_flow_imp.id(44923883706615127)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44923638409611042)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44923017838597099)
,p_parent_id=>wwv_flow_imp.id(44929043284788783)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(57108550139825367)
,p_option_sequence=>30
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44924504144631175)
,p_parent_id=>wwv_flow_imp.id(44923883706615127)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(57109895295832299)
,p_option_sequence=>40
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(44923161327598745)
,p_parent_id=>wwv_flow_imp.id(44929043284788783)
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(56821201946524373)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(56819691605524367)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(55277533403985269)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(38454550398531045)
,p_name=>'Keycloak SSO'
,p_scheme_type=>'NATIVE_SOCIAL'
,p_attribute_01=>wwv_flow_imp.id(18617636203721277)
,p_attribute_02=>'OPENID_CONNECT'
,p_attribute_03=>'http://10.0.2.218:8080/realms/master/.well-known/openid-configuration'
,p_attribute_07=>'openid profile email'
...
begin
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(56820013908524367)
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(57114817253482629)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57114844652482635)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
,p_name=>'TITLE'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57115186716482636)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57115498650482636)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
,p_name=>'ACTORS'
,p_sequence=>4
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57115814569482636)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
,p_name=>'GENRE'
,p_sequence=>5
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57116136570482637)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
,p_name=>'VOTES'
,p_sequence=>6
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57116426011482637)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
,p_name=>'RELEASE_DATE'
,p_sequence=>7
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57116719881482637)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
,p_name=>'RATING'
,p_sequence=>8
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57117032752482637)
,p_data_profile_id=>wwv_flow_imp.id(57114817253482629)
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(57117389106482638)
,p_name=>'GenAI CSV Load'
...
begin
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(57120535852482640)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57120631890482640)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL1'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57120893752482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL2'
,p_sequence=>3
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57121235845482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL3'
,p_sequence=>4
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57121455754482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL4'
,p_sequence=>5
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57121816188482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL5'
,p_sequence=>6
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57122073483482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL6'
,p_sequence=>7
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57122392245482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL7'
,p_sequence=>8
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57122685913482641)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL8'
,p_sequence=>9
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57122979877482642)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL9'
,p_sequence=>10
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57123315875482642)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'COL10'
,p_sequence=>11
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(57123638357482642)
,p_data_profile_id=>wwv_flow_imp.id(57120535852482640)
,p_name=>'EMBEDDING_VECTOR'
,p_sequence=>21
,p_column_type=>'SQL_EXPRESSION'
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(57123954800482642)
,p_name=>'Manual CSV Load'
...
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(44957136469189192)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(44959296988278194)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(57129588790532796)
...
,p_vector_provider_id =>wwv_flow_imp.id(26431435947121993)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(57130314935569345)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(57130764491593968)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(57131297206611193)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(57133189464627037)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(62455845347497068)
...
,p_query_where=>'SUBSTR(moviedescription, 1, 40) <> SUBSTR(:P41_SEARCH, 1, 40)'
,p_oratext_index_column_name=>'EMBEDDING_VECTOR'
,p_vector_provider_id =>wwv_flow_imp.id(26057725633048067)
,p_vector_search_type=>'EXACT'
,p_vector_distance_metric=>'DOT'
,p_return_max_results=>5
,p_pk_column_name=>'ID'
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(62456516839505365)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(62456878568508591)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(56833215765524451)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62092056434173537)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62092655139173543)
...
,p_location=>null
,p_list_id=>wwv_flow_imp.id(62402010724401089)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(52023094758670911)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(44813827107010633)
...
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(56820309911524369)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68346969949222132)
...
,p_plug_display_sequence=>20
,p_location=>null
,p_list_id=>wwv_flow_imp.id(44814961579044879)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52534206005854455)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(44442687934628779)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2010149141494510257
,p_ai_enabled=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68348950230286371)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68349631356286378)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(44820133770119438)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(68349631356286378)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(44821898434119452)
,p_branch_name=>'Go To Data Preview'
,p_branch_action=>'f?p=&APP_ID.:12:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(44820133770119438)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(64917077082439249)
,p_name=>'P11_EXE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(68348950230286371)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(68350119241286391)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44446333448280421)
...
,p_when_button_pressed=>wwv_flow_imp.id(44820133770119438)
,p_associated_item=>wwv_flow_imp.id(68350119241286391)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44821049898119450)
...
,p_process_when_button_id=>wwv_flow_imp.id(44820133770119438)
,p_internal_uid=>11260412829604374
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44820713532119447)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(44821049898119450)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62890846399889245)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63424762751026460)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(64920660311443970)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(71065944594464479)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(71066008628464480)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(44825650929124162)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(71066008628464480)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(44826106519124162)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(71066008628464480)
,p_button_name=>'PREV'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(44835775985124173)
,p_branch_name=>'Go To Vector Generation'
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:11,12::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(44825650929124162)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(64922998891443979)
,p_name=>'P12_SOFAR'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(71065944594464479)
,p_item_default=>'-1'
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(64923064332443980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71069921262464492)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(44828443628124165)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44828966216124167)
,p_event_id=>wwv_flow_imp.id(44828443628124165)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44829520671124168)
,p_event_id=>wwv_flow_imp.id(44828443628124165)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44830016722124169)
,p_event_id=>wwv_flow_imp.id(44828443628124165)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(44830423271124169)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44830855311124170)
,p_event_id=>wwv_flow_imp.id(44830423271124169)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(71065944594464479)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44831418374124170)
,p_event_id=>wwv_flow_imp.id(44830423271124169)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(71066008628464480)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44831915385124171)
,p_event_id=>wwv_flow_imp.id(44830423271124169)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(62890846399889245)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(44832303582124171)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44832759929124171)
,p_event_id=>wwv_flow_imp.id(44832303582124171)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44833323221124171)
,p_event_id=>wwv_flow_imp.id(44832303582124171)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44833796704124172)
,p_event_id=>wwv_flow_imp.id(44832303582124171)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44834290465124172)
,p_event_id=>wwv_flow_imp.id(44832303582124171)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44834757866124172)
,p_event_id=>wwv_flow_imp.id(44832303582124171)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44835285055124173)
,p_event_id=>wwv_flow_imp.id(44832303582124171)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(64920660311443970)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44827070657124164)
...
,p_attribute_01=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(44825650929124162)
,p_internal_uid=>11266433588609088
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44826722842124163)
,p_process_sequence=>60
,p_parent_process_id=>wwv_flow_imp.id(44827070657124164)
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Data Load'
,p_attribute_01=>wwv_flow_imp.id(57117389106482638)
,p_attribute_02=>'TEXT'
,p_attribute_04=>'P12_AI_OUTPUT'
,p_internal_uid=>11266085773609087
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44827440348124164)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44762770797158516)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(44762873985158517)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63438866584036618)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(71070353327404351)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(72902402980960111)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(44838548612133257)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(44838949361133258)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(44837407497133254)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(71070353327404351)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(44837763276133254)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(71070353327404351)
,p_button_name=>'PREV'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(44762181904158510)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44840409864133259)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(44837407497133254)
,p_internal_uid=>11279772795618183
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44840026421133258)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68414098722577378)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68414165830575873)
,p_plug_name=>'Movie Vector Search Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>20
,p_location=>null
,p_list_id=>wwv_flow_imp.id(57142949509757518)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(78290222220491099)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63306972648370169)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63307085816370170)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63307213835370171)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(63307085816370170)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68378472071381320)
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44845932646214333)
,p_region_id=>wwv_flow_imp.id(68378472071381320)
,p_search_config_id=>wwv_flow_imp.id(57131297206611193)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OCI'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73377161617872807)
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44846792035214333)
,p_region_id=>wwv_flow_imp.id(73377161617872807)
,p_search_config_id=>wwv_flow_imp.id(62456878568508591)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90930560312946290)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(68379548628381320)
,p_name=>'P15_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(63307213835370171)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63310547315374345)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72162421057896338)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72168357380938414)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72173782162986794)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(72168357380938414)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76218469385722336)
,p_plug_name=>'Vector'
,p_parent_plug_id=>wwv_flow_imp.id(72168357380938414)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73381922470876995)
,p_plug_name=>'Search Results OPENAI'
,p_parent_plug_id=>wwv_flow_imp.id(76218469385722336)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44851328996218518)
,p_region_id=>wwv_flow_imp.id(73381922470876995)
,p_search_config_id=>wwv_flow_imp.id(62456878568508591)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76218101761722333)
,p_plug_name=>'Search Results OCI'
,p_parent_plug_id=>wwv_flow_imp.id(76218469385722336)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44852162144218519)
,p_region_id=>wwv_flow_imp.id(76218101761722333)
,p_search_config_id=>wwv_flow_imp.id(57131297206611193)
,p_use_as_initial_result=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76218554589722337)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76616195991188984)
,p_plug_name=>'Search Results'
,p_parent_plug_id=>wwv_flow_imp.id(76218554589722337)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44853457280218520)
,p_region_id=>wwv_flow_imp.id(76616195991188984)
,p_search_config_id=>wwv_flow_imp.id(44959296988278194)
,p_use_as_initial_result=>false
,p_display_sequence=>22
,p_name=>'Oracle Text Search'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90930844654948360)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76623244990189001)
,p_name=>'P16_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(72173782162986794)
,p_prompt=>'Search'
,p_placeholder=>'Enter your search term, e.g. Subconscious Mind or Darth Vader'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_grid_label_column_span=>0
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(71245055180708470)
,p_plug_name=>'Oracle Text not available'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--danger'
,p_plug_template=>2040683448887306517
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72169420895900243)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72175468358942822)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72182138953005711)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(72175468358942822)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73388938214879707)
,p_plug_name=>'Search Results'
,p_parent_plug_id=>wwv_flow_imp.id(72175468358942822)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44857594105221226)
,p_region_id=>wwv_flow_imp.id(73388938214879707)
,p_search_config_id=>wwv_flow_imp.id(57130314935569345)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Oracle Text And Vector'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90931116992949717)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76834074735957973)
,p_name=>'P17_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72182138953005711)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79706578251245706)
...
,p_plug_display_sequence=>10
,p_location=>null
,p_list_id=>wwv_flow_imp.id(44918266513504176)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_landmark_type=>'navigation'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90931793358954738)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52163433160424198)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(44445363586676724)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2010149141494510257
,p_ai_enabled=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65311726819527839)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65311904587527840)
,p_plug_name=>'RDS'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>40
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65311943210527841)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65312518188527846)
,p_plug_name=>'Upload a File'
,p_parent_plug_id=>wwv_flow_imp.id(65311943210527841)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(71119545292828409)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(67321466842217100)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57318679242090725)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(67321466842217100)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(58115373106320073)
,p_branch_name=>'Go To Data Preview'
,p_branch_action=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(57318679242090725)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65316401038527885)
,p_name=>'P25_FILE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(65312518188527846)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65316462027527886)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71129155254828461)
,p_name=>'P25_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(71119545292828409)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(58328192473707021)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52163712423425358)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68049712877771808)
,p_plug_name=>'RDS'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68049751500771809)
,p_plug_name=>'Upload File'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>50
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68050721092771818)
,p_plug_name=>'Loaded File'
,p_parent_plug_id=>wwv_flow_imp.id(68049751500771809)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(68908326009343555)
,p_name=>'Preview'
,p_parent_plug_id=>wwv_flow_imp.id(68049751500771809)
,p_template=>4072358936313175081
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(44762359084158512)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(44762648190158515)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(44762620427158514)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58002548358889496)
,p_query_column_id=>4
,p_column_alias=>'COL4'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58002977989889497)
,p_query_column_id=>5
,p_column_alias=>'COL5'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58003396873889497)
,p_query_column_id=>6
,p_column_alias=>'COL6'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58003764225889497)
,p_query_column_id=>7
,p_column_alias=>'COL7'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58004206033889497)
,p_query_column_id=>8
,p_column_alias=>'COL8'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58004596103889498)
,p_query_column_id=>9
,p_column_alias=>'COL9'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58005007079889498)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70059275132461068)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(58005831926889499)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(70059275132461068)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57939824739620627)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(70059275132461068)
,p_button_name=>'PREV'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(58020532328271247)
,p_branch_name=>'Go Back To File Upload'
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(57939824739620627)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(58914401134203143)
,p_branch_name=>'Go To File Vector Embeddings'
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(58005831926889499)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(68060024747771866)
,p_name=>'P26_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(68050721092771818)
,p_item_default=>'''EBA_VECTOR_DATATABLE'''
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(58006457731889499)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(58951079197472649)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
...
,p_attribute_01=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(58005831926889499)
,p_internal_uid=>3692637774827129
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(58952360844480132)
,p_process_sequence=>80
,p_parent_process_id=>wwv_flow_imp.id(58951079197472649)
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Load File Data'
,p_attribute_01=>wwv_flow_imp.id(57123954800482642)
,p_attribute_02=>'FILE'
,p_attribute_03=>'P25_FILE'
,p_internal_uid=>3693919421834612
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(58007219703889500)
,p_process_sequence=>90
,p_parent_process_id=>wwv_flow_imp.id(58951079197472649)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44762995817158518)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52163969151426915)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(56195539445716262)
,p_plug_name=>'Data Uploaded Successfully'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(57942845940620658)
,p_name=>'Summary'
,p_template=>4072358936313175081
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58914140402203140)
,p_query_column_id=>1
,p_column_alias=>'ROW_COUNT'
,p_column_display_sequence=>10
,p_column_heading=>'Loaded Row Count'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(58914210470203141)
,p_query_column_id=>2
,p_column_alias=>'VECTOR_COUNT'
,p_column_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70030107395330866)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57956089068741615)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(70030107395330866)
,p_button_name=>'GENERATE_VECTOR_EMBEDDINGS'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(58912443031203124)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(70030107395330866)
,p_button_name=>'PREV'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(44762292508158511)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(57956716843741621)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Generate Vectors Embeddings'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(57956089068741615)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(67017897929901833)
,p_plug_name=>'Progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79764762632431875)
,p_plug_name=>'Custom Vector Search Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges'
,p_plug_template=>3371237801798025892
,p_plug_display_sequence=>20
,p_location=>null
,p_list_id=>wwv_flow_imp.id(44912396720386507)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79765490009435547)
,p_plug_name=>'Ready for Vector Search'
,p_region_template_options=>'#DEFAULT#:t-Alert--wizard:t-Alert--defaultIcons:t-Alert--success'
,p_plug_template=>2040683448887306517
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52023774224670918)
,p_plug_name=>'About Basic Vector Search'
,p_region_template_options=>'#DEFAULT#:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57085986762664576)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72264841949753927)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72270252595804060)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(72264841949753927)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73478159235689693)
,p_plug_name=>'Search Results OPENAI'
,p_parent_plug_id=>wwv_flow_imp.id(72264841949753927)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44945614111031227)
,p_region_id=>wwv_flow_imp.id(73478159235689693)
,p_search_config_id=>wwv_flow_imp.id(62456516839505365)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI Datatable'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(78284955308845818)
,p_plug_name=>'Search Results OCI'
,p_parent_plug_id=>wwv_flow_imp.id(72264841949753927)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(44946469590031229)
,p_region_id=>wwv_flow_imp.id(78284955308845818)
,p_search_config_id=>wwv_flow_imp.id(57133189464627037)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OCI Datatable'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(78287170775845841)
,p_name=>'P31_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72270252595804060)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022795100670908)
,p_plug_name=>'Oracle Text not available'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--danger'
,p_plug_template=>2040683448887306517
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60874668843192901)
,p_plug_name=>'About Vector vs. Oracle Text Search'
,p_region_template_options=>'#DEFAULT#:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60880605166234977)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60886029948283357)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(60880605166234977)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(64930717171018899)
,p_plug_name=>'Vector'
,p_parent_plug_id=>wwv_flow_imp.id(60880605166234977)
,p_region_template_options=>'#DEFAULT#:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62094170256173558)
,p_plug_name=>'Search Results OPENAI'
,p_parent_plug_id=>wwv_flow_imp.id(64930717171018899)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(62094325252173559)
,p_region_id=>wwv_flow_imp.id(62094170256173558)
,p_search_config_id=>wwv_flow_imp.id(62456516839505365)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI Datatable'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(64930349547018896)
,p_plug_name=>'Search Results OCI'
,p_parent_plug_id=>wwv_flow_imp.id(64930717171018899)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(57354443305405857)
,p_region_id=>wwv_flow_imp.id(64930349547018896)
,p_search_config_id=>wwv_flow_imp.id(57133189464627037)
,p_use_as_initial_result=>false
,p_display_sequence=>20
,p_name=>'Basic Vector Search OCI Datatable'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(64930802375018900)
,p_plug_name=>'Oracle Text'
,p_parent_plug_id=>wwv_flow_imp.id(60880605166234977)
,p_region_template_options=>'#DEFAULT#:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65328443776485547)
,p_plug_name=>'Search Results'
,p_parent_plug_id=>wwv_flow_imp.id(64930802375018900)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(57356115505405862)
,p_region_id=>wwv_flow_imp.id(65328443776485547)
,p_search_config_id=>wwv_flow_imp.id(57130764491593968)
,p_use_as_initial_result=>false
,p_display_sequence=>22
,p_name=>'Oracle Text Search'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65327739470485542)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65333744184485561)
,p_name=>'P32_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(60886029948283357)
,p_prompt=>'Search'
,p_placeholder=>'Enter your search term, e.g. Testing'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_grid_label_column_span=>0
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(59950557045002323)
,p_plug_name=>'Oracle Text not available'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--danger'
,p_plug_template=>2040683448887306517
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60874922760194096)
,p_plug_name=>'About Vector and Oracle Text Search'
,p_region_template_options=>'#DEFAULT#:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60880970223236675)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60887640817299564)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(60880970223236675)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62094440079173560)
,p_plug_name=>'Search Results'
,p_parent_plug_id=>wwv_flow_imp.id(60880970223236675)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(62094458718173561)
,p_region_id=>wwv_flow_imp.id(62094440079173560)
,p_search_config_id=>wwv_flow_imp.id(44957136469189192)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Oracle Text And Vector Datatable'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65535500029251812)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65537857405251824)
,p_name=>'P33_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(60887640817299564)
,p_prompt=>'Search'
,p_placeholder=>'Enter your search term, e.g. Testing'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_grid_label_column_span=>0
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57106746754821676)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60894981381566111)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57373643600594823)
,p_plug_name=>'Search Results OCI'
,p_parent_plug_id=>wwv_flow_imp.id(60894981381566111)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(57373805096594824)
,p_region_id=>wwv_flow_imp.id(57373643600594823)
,p_search_config_id=>wwv_flow_imp.id(57129588790532796)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Movie Recommendation'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60895342973567860)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(60894981381566111)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62094764679173564)
,p_plug_name=>'Search Results OPENAI'
,p_parent_plug_id=>wwv_flow_imp.id(60894981381566111)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(62094926546173565)
,p_region_id=>wwv_flow_imp.id(62094764679173564)
,p_search_config_id=>wwv_flow_imp.id(62455845347497068)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Movie Recommendation'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60898758722599390)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(57373472065594821)
,p_name=>'P41_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(60895342973567860)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(57374145714594828)
,p_name=>'Submit Page'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(57374264102594829)
,p_event_id=>wwv_flow_imp.id(57374145714594828)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(57373643600594823)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44447952532433633)
,p_event_id=>wwv_flow_imp.id(57374145714594828)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(62094764679173564)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57108138891825366)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60896977504589283)
,p_plug_name=>'Content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57373957037594826)
,p_plug_name=>'Search Results OCI'
,p_parent_plug_id=>wwv_flow_imp.id(60896977504589283)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(57374056195594827)
,p_region_id=>wwv_flow_imp.id(57373957037594826)
,p_search_config_id=>wwv_flow_imp.id(57131297206611193)
,p_use_as_initial_result=>false
,p_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60896310905579211)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_imp.id(60896977504589283)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(62094965803173566)
,p_plug_name=>'Search Results OPENAI'
,p_parent_plug_id=>wwv_flow_imp.id(60896977504589283)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(62095123135173567)
,p_region_id=>wwv_flow_imp.id(62094965803173566)
,p_search_config_id=>wwv_flow_imp.id(62456878568508591)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Vector Comparison'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60899072019600337)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(57373928025594825)
,p_name=>'P42_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(60896310905579211)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(30259121190935819)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(30259849703935826)
,p_region_id=>wwv_flow_imp.id(30259121190935819)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1623627059132031120)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45073923626176159)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1623627059132031120)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(45087740194208193)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(45086690984208182)
,p_name=>'P49_SEARCH_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(30259121190935819)
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(45087679652208192)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(45073923626176159)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57091278922682029)
...
,p_plug_display_sequence=>10
,p_location=>null
,p_list_id=>wwv_flow_imp.id(57137707913722231)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_landmark_type=>'navigation'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(57109417034832299)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(61273469218489046)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(66848872257075315)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(66848979261075316)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_imp.id(66848872257075315)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57342790284264275)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(66848979261075316)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57343217849264275)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(66848979261075316)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(57346843330264279)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(57346036435264278)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(57342790284264275)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3936502931872354890)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5917388707509443360)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(57723983566195973)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(5917388707509443360)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(57727104730195995)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(57723983566195973)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2514617231324914618)
,p_name=>'P52_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(5917388707509443360)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(57726616521195993)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(57723983566195973)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(45441192150287536)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(56956888618980594)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63890613425443296)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63890729167443297)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(81727344843264048)
,p_plug_name=>'Web Credentials'
,p_parent_plug_id=>wwv_flow_imp.id(63890729167443297)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63890824077443298)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63890885620443299)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45429672474287505)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(56956888618980594)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45440671291287534)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(63890885620443299)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(45452947381287564)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(70798191146556024)
,p_name=>'P54_OPENAI_WEB_CRED_HEADER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(63890824077443298)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(81730697175264101)
,p_name=>'P54_SHOW_WEB_CREDENTIALS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(63890729167443297)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(81734996575264108)
,p_name=>'P54_OCI_WEB_CREDENTIALS_HEADER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(81727344843264048)
,p_prompt=>'Web Credential'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(88654550725087164)
,p_name=>'P54_AI_PROVIDER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(63890613425443296)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(88691412751188102)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(88691488956188103)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(88691592004188104)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(88691717079188105)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(88697288555189609)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(89659907456770593)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(89659982327770594)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45444702046287553)
,p_validation_name=>'P54_OCI_COMPARTMENT_ID not null'
,p_validation_sequence=>20
,p_validation=>'P54_OCI_COMPARTMENT_ID'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(45440671291287534)
,p_associated_item=>wwv_flow_imp.id(89659982327770594)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45443512923287553)
...
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(45440671291287534)
,p_associated_item=>wwv_flow_imp.id(89659907456770593)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45442695102287552)
...
,p_when_button_pressed=>wwv_flow_imp.id(45440671291287534)
,p_associated_item=>wwv_flow_imp.id(88691412751188102)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45445071785287554)
,p_validation_name=>'P54_OPENAI_API_KEY not null'
,p_validation_sequence=>50
,p_validation=>'P54_OPENAI_API_KEY'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(45429672474287505)
,p_associated_item=>wwv_flow_imp.id(88697288555189609)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45443092730287552)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(45440671291287534)
,p_associated_item=>wwv_flow_imp.id(88691488956188103)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45443916253287553)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(45440671291287534)
,p_associated_item=>wwv_flow_imp.id(88691592004188104)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(45444250652287553)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(45440671291287534)
,p_associated_item=>wwv_flow_imp.id(88691717079188105)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(45446611335287557)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45447130989287559)
,p_event_id=>wwv_flow_imp.id(45446611335287557)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(81727344843264048)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45447595088287559)
,p_event_id=>wwv_flow_imp.id(45446611335287557)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(45448035371287560)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45449958247287561)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45451466690287562)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(63890729167443297)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45450980650287562)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(63890824077443298)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45451955576287562)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(63890885620443299)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45448437137287560)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(56956888618980594)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45450483610287562)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45449517860287561)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45452490036287563)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45449014519287560)
,p_event_id=>wwv_flow_imp.id(45448035371287560)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(45445780368287555)
,p_process_sequence=>90
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(45445434767287554)
...
,p_process_error_message=>'Invalid web credentials: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(45429672474287505)
,p_process_success_message=>'Success: Web credentials verified successfully.'
,p_internal_uid=>11884797698772478
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44859838555463475)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(44859607382463473)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(32210818572115154)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(45088458286208200)
,p_plug_name=>'Button OPENAI'
,p_parent_plug_id=>wwv_flow_imp.id(32210818572115154)
,p_region_css_classes=>'step-container'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>70
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022041949670900)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022053464670901)
,p_plug_name=>'Welcome to Sample Vector Search'
,p_parent_plug_id=>wwv_flow_imp.id(52022041949670900)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022183092670902)
,p_plug_name=>'Select Provider'
,p_title=>'Select AI Provider'
,p_parent_plug_id=>wwv_flow_imp.id(32210818572115154)
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022298834670903)
,p_plug_name=>'Enter OCI Web Credentials'
,p_title=>'Enter Web Credentials'
,p_parent_plug_id=>wwv_flow_imp.id(32210818572115154)
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69858914510491654)
,p_plug_name=>'Web Credentials'
,p_parent_plug_id=>wwv_flow_imp.id(52022298834670903)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader js-removeLandmark:t-Region--noBorder:t-Region--hiddenOverflow'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022393744670904)
,p_plug_name=>'Enter OpenAI Web Credentials'
,p_title=>'Enter Web Credentials'
,p_parent_plug_id=>wwv_flow_imp.id(32210818572115154)
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(52022455287670905)
,p_plug_name=>'Button OCI'
,p_parent_plug_id=>wwv_flow_imp.id(32210818572115154)
,p_region_css_classes=>'step-container'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(32210924212115155)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45088598236208201)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(45088458286208200)
,p_button_name=>'COMPLETE_OPENAI'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(52022611431670906)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(52022455287670905)
,p_button_name=>'COMPLETE_OCI'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(52022746156670907)
,p_branch_name=>'Go to Home Page'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(58920122029783570)
,p_name=>'P100_OPENAI_WEB_CRED_HEADER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(52022393744670904)
,p_prompt=>'Web Credential'
,p_source=>'OpenAI Credentials'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(69859343951491657)
,p_name=>'P100_SHOW_WEB_CREDENTIALS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(52022298834670903)
,p_item_default=>'Y'
,p_prompt=>'Edit Web Credentials'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>2318601014859922299
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(69861348151491659)
,p_name=>'P100_OCI_WEB_CRED_HEADER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(69858914510491654)
,p_prompt=>'Web Credential'
,p_source=>'OCI Credentials'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76783855433314723)
,p_name=>'P100_AI_PROVIDER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(52022183092670902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76817764327415653)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76817840532415654)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76817943580415655)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76818068655415656)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76819219438417155)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(77788554232998149)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(77788629103998150)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44759721620158485)
...
,p_validation_condition2=>'Y'
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(52022611431670906)
,p_associated_item=>wwv_flow_imp.id(76817764327415653)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44760360727158492)
...
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(52022611431670906)
,p_associated_item=>wwv_flow_imp.id(77788629103998150)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44760521792158493)
...
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(52022611431670906)
,p_associated_item=>wwv_flow_imp.id(77788554232998149)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44760604137158494)
,p_validation_name=>'P100_OPENAI_API_KEY not null'
,p_validation_sequence=>40
,p_validation=>'P100_OPENAI_API_KEY'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(45088598236208201)
,p_associated_item=>wwv_flow_imp.id(76819219438417155)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44759790025158486)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(52022611431670906)
,p_associated_item=>wwv_flow_imp.id(76817840532415654)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44760194402158490)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(52022611431670906)
,p_associated_item=>wwv_flow_imp.id(76817943580415655)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(44760284814158491)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(52022611431670906)
,p_associated_item=>wwv_flow_imp.id(76818068655415656)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(52091591435341915)
,p_name=>'Toggle Switch Visibility'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(52092029869341917)
,p_event_id=>wwv_flow_imp.id(52091591435341915)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(69858914510491654)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(52092458850341918)
,p_event_id=>wwv_flow_imp.id(52091591435341915)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(47341262910621671)
,p_name=>'Change AI Provider'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(47341197327621670)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44761027509158498)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(52022298834670903)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44761260142158501)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(52022393744670904)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44761408333158502)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(52022455287670905)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45088681133208202)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(45088458286208200)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44761210202158500)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44761099921158499)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(44761494775158503)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45088778622208203)
,p_event_id=>wwv_flow_imp.id(47341262910621671)
,p_event_result=>'TRUE'
,p_action_sequence=>90
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(52022882456670909)
,p_process_sequence=>90
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Complete OCI'
...
,p_process_error_message=>'Invalid web credentials: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(52022611431670906)
,p_process_success_message=>'Success: Web credentials verified successfully.'
,p_internal_uid=>7713632804735014
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(45088871489208204)
,p_process_sequence=>100
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Complete Open AI'
...
,p_process_error_message=>'Invalid web credentials: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(45088598236208201)
,p_process_success_message=>'Success: Web credentials verified successfully.'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(56826190583524430)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(56827860882524440)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(56826190583524430)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(56826720417524438)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(56826190583524430)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(56827088961524439)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(56827486456524439)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(56830088578524442)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(56830623262524443)
,p_page_process_id=>wwv_flow_imp.id(56830088578524442)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(56831136845524443)
,p_page_process_id=>wwv_flow_imp.id(56830088578524442)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(56828220085524441)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(56828644072524441)
,p_page_process_id=>wwv_flow_imp.id(56828220085524441)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(56829200599524442)
,p_page_process_id=>wwv_flow_imp.id(56828220085524441)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(56829659412524442)
,p_page_process_id=>wwv_flow_imp.id(56828220085524441)
,p_page_id=>9999
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(56831979606524443)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(56831563791524443)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(62307645634774421)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(62312755226766272)
,p_install_id=>wwv_flow_imp.id(62307645634774421)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(45607232271808207)
,p_install_id=>wwv_flow_imp.id(62307645634774421)
...
wwv_flow_imp_shared.create_install_check(
 p_id=>wwv_flow_imp.id(62314258990021945)
,p_install_id=>wwv_flow_imp.id(62307645634774421)
...
wwv_flow_imp_shared.create_install_check(
 p_id=>wwv_flow_imp.id(51969921972300711)
,p_install_id=>wwv_flow_imp.id(62307645634774421)
