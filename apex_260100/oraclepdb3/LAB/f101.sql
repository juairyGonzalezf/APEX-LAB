...
,p_default_id_offset=>3764204167088500
,p_default_owner=>'APEXPDB'
);
end;
/
 
prompt APPLICATION 101 - Sample REST Services
--
-- Application Export:
--   Application:     101
--   Name:            Sample REST Services
...
,p_authentication_id=>wwv_flow_imp.id(98038332417571975)
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(98039146166571977)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2469215554099805162
,p_nav_list_template_options=>'#DEFAULT#:js-defaultCollapsed:js-navCollapsed--hidden:t-TreeNav--styleA'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(98040375423571992)
...
,p_files_version=>2461161212652
);
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1153641917960728633)
,p_plugin_id=>wwv_flow_imp.id(1156627073823035222)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98034206033571973)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>'3433272'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98037136040571974)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98034432976571973)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98034785827571973)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98036891049571974)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98036259413571973)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98037520970571974)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98037742290571974)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98035962408571973)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98033932439571972)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98036600910571973)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98035086049571973)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98035715770571973)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>'3433272'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(98035424663571973)
,p_plugin_type=>'WEB SOURCE TYPE'
...
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(98286775731051893)
,p_name=>'EBA_REST_DATA_EMPLOYEE'
,p_static_id=>'Employee_ords_rest_source'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'NEW'
,p_format=>'JSON'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98286214575051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'COMM'
,p_static_id=>'comm'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98286454621051893)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98284347179051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'EMPNO'
,p_static_id=>'empno'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98284710618051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'ENAME'
,p_static_id=>'ename'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98285544388051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'HIREDATE'
,p_static_id=>'hiredate'
,p_sequence=>5
,p_column_type=>'DATA'
,p_data_type=>'DATE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98284937874051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'JOB'
,p_static_id=>'job'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98285281304051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'MGR'
,p_static_id=>'mgr'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(98285844363051892)
,p_data_profile_id=>wwv_flow_imp.id(98284134221051892)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>6
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(98287732719051893)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_static_id=>'delete'
,p_operation=>'DELETE'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(99750486622365323)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_name=>'fetchOne'
,p_static_id=>'fetchone'
,p_operation=>'GET'
,p_url_pattern=>':empname'
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100455655139892841)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_web_src_operation_id=>wwv_flow_imp.id(99750486622365323)
,p_name=>'query'
,p_static_id=>'query-2'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(98286970836051893)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_static_id=>'get'
,p_operation=>'GET'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100456078462896034)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_web_src_operation_id=>wwv_flow_imp.id(98286970836051893)
,p_name=>'query'
,p_static_id=>'query'
,p_param_type=>'QUERY_STRING'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(98288129481051893)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_static_id=>'get-2'
,p_operation=>'GET'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(99750756916369415)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_web_src_operation_id=>wwv_flow_imp.id(98288129481051893)
,p_name=>'empno'
,p_static_id=>'empno'
,p_param_type=>'QUERY_STRING'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(98287345999051893)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_static_id=>'post'
,p_operation=>'POST'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(98288610967051893)
,p_web_src_module_id=>wwv_flow_imp.id(98286775731051893)
,p_static_id=>'put'
,p_operation=>'PUT'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100373749645537530)
,p_name=>'EBA_MOVIE_PLUG'
,p_static_id=>'eba_movie_plug'
,p_web_source_type=>'PLUGIN_COM.ORACLE.APEX.RESTSOURCE.FIXEDPAGESIZE'
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_remote_server_id=>19597746759082809
,p_url_path_prefix=>'/movie'
,p_credential_id=>15655119485874726
,p_version_scn=>'21055822'
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100374336415537532)
,p_web_src_module_id=>wwv_flow_imp.id(100373749645537530)
,p_name=>'query'
,p_static_id=>'query'
,p_param_type=>'QUERY_STRING'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'EBA_MOVIE_PLUG'
,p_format=>'JSON'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100369386471537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'ADULT'
,p_static_id=>'adult'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100372400899537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'BACKDROP_PATH'
,p_static_id=>'backdrop-path'
,p_sequence=>12
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100370591920537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'GENRE_IDS'
,p_static_id=>'genre-ids'
,p_sequence=>6
,p_column_type=>'DATA'
,p_data_type=>'ARRAY'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100373252180537529)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'GENRE_IDS2'
,p_static_id=>'genre-ids-2'
,p_sequence=>15
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100370591920537528)
,p_data_type=>'NUMBER'
,p_selector=>'.'
,p_remote_data_type=>'number'
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100369039138537527)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'ID'
,p_static_id=>'id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100372990112537529)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'ORIGINAL_LANGUAGE'
,p_static_id=>'original-language'
,p_sequence=>14
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100372658945537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'ORIGINAL_TITLE'
,p_static_id=>'original-title'
,p_sequence=>13
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100370320862537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'OVERVIEW'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100370859903537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'POPULARITY'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100371485022537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'POSTER_PATH'
,p_static_id=>'poster-path'
,p_sequence=>9
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100371747176537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'RELEASE_DATE'
,p_static_id=>'release-date'
,p_sequence=>10
,p_column_type=>'DATA'
,p_data_type=>'DATE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100369700964537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'TITLE'
,p_static_id=>'title'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100369935307537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'VIDEO'
,p_static_id=>'video'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100372100194537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'VOTE_AVERAGE'
,p_static_id=>'vote-average'
,p_sequence=>11
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100371213165537528)
,p_data_profile_id=>wwv_flow_imp.id(100368921609537525)
,p_name=>'VOTE_COUNT'
,p_static_id=>'vote-count'
,p_sequence=>8
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100374017130537531)
,p_web_src_module_id=>wwv_flow_imp.id(100373749645537530)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100094766398062175)
,p_name=>'EBA_REST_DEPARTMENT'
,p_static_id=>'eba_rest_department'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(100093702694062168)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100093702694062168)
,p_name=>'EBA_REST_DEPARTMENT'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100093856061062174)
,p_data_profile_id=>wwv_flow_imp.id(100093702694062168)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100094203824062174)
,p_data_profile_id=>wwv_flow_imp.id(100093702694062168)
,p_name=>'DNAME'
,p_static_id=>'dname'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100094519069062174)
,p_data_profile_id=>wwv_flow_imp.id(100093702694062168)
,p_name=>'LOC'
,p_static_id=>'loc'
,p_sequence=>3
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100095790952062179)
,p_web_src_module_id=>wwv_flow_imp.id(100094766398062175)
,p_static_id=>'delete'
,p_operation=>'DELETE'
,p_database_operation=>'DELETE'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100094933189062178)
,p_web_src_module_id=>wwv_flow_imp.id(100094766398062175)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100096217111062179)
,p_web_src_module_id=>wwv_flow_imp.id(100094766398062175)
,p_static_id=>'get-2'
,p_operation=>'GET'
,p_database_operation=>'FETCH_SINGLE_ROW'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100095422471062179)
,p_web_src_module_id=>wwv_flow_imp.id(100094766398062175)
,p_static_id=>'post'
,p_operation=>'POST'
,p_database_operation=>'INSERT'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100096562927062179)
,p_web_src_module_id=>wwv_flow_imp.id(100094766398062175)
,p_static_id=>'put'
,p_operation=>'PUT'
,p_database_operation=>'UPDATE'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(101379648226200363)
,p_name=>'EBA_REST_EMPLOYEE_DATA'
,p_static_id=>'eba_rest_employee_data'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'EBA_REST_EMPLOYEE_DATA'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101378175681200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'COMM'
,p_static_id=>'comm'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101379090960200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101378488339200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'EMPNO'
,p_static_id=>'empno'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101378799044200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'ENAME'
,p_static_id=>'ename'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101379382413200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'HIREDATE'
,p_static_id=>'hiredate'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101377227604200360)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'JOB'
,p_static_id=>'job'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101377604116200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'MGR'
,p_static_id=>'mgr'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101377867792200361)
,p_data_profile_id=>wwv_flow_imp.id(101377099158200357)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>3
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101379863497200364)
,p_web_src_module_id=>wwv_flow_imp.id(101379648226200363)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(103782061999092897)
,p_name=>'EBA_REST_EMPLOYEE_DERIVED'
,p_static_id=>'eba_rest_employee_derived'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_remote_server_id=>18529060167393527
,p_url_path_prefix=>'/data/emp'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'returns_legacy_ords_json', 'N',
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'EBA_REST_EMPLOYEE_DERIVED'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103781481550092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'APEX_ROW_SYNC_TIMESTAMP'
,p_static_id=>'apex-row-sync-timestamp'
,p_sequence=>90
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103781815565092896)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'APEX_SYNC_STEP_STATIC_ID'
,p_static_id=>'apex-sync-step-static-id'
,p_sequence=>100
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103779930074092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'COMM'
,p_static_id=>'comm'
,p_sequence=>40
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103780875231092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>70
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103780239325092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'EMPNO'
,p_static_id=>'empno'
,p_sequence=>50
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103780621351092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'ENAME'
,p_static_id=>'ename'
,p_sequence=>60
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103783826680101730)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'Full Salary'
,p_static_id=>'full-salary'
,p_sequence=>85
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103781194390092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'HIREDATE'
,p_static_id=>'hiredate'
,p_sequence=>80
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103779036395092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'JOB'
,p_static_id=>'job'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103779328674092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'MGR'
,p_static_id=>'mgr'
,p_sequence=>20
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103779717262092895)
,p_data_profile_id=>wwv_flow_imp.id(103778868199092894)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>30
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103782313129092898)
,p_web_src_module_id=>wwv_flow_imp.id(103782061999092897)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100384623875340940)
,p_name=>'EBA_REST_EMPLOYEE_INVOKE'
,p_static_id=>'eba_rest_employee_invoke'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_remote_server_id=>18529060167393527
,p_url_path_prefix=>'/data/emp'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'returns_legacy_ords_json', 'N',
  'sorting_nulls', 'FLEXIBLE')).to_clob
,p_version_scn=>'16940737'
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100398970301860263)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_name=>'Content-Type'
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'EBA_REST_EMPLOYEE_INVOKE'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100383113694340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'COMM'
,p_static_id=>'comm'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100384003890340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100383374918340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'EMPNO'
,p_static_id=>'empno'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100383667549340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'ENAME'
,p_static_id=>'ename'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100384268530340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'HIREDATE'
,p_static_id=>'hiredate'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100382177807340937)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'JOB'
,p_static_id=>'job'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100382467064340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'MGR'
,p_static_id=>'mgr'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100382777966340938)
,p_data_profile_id=>wwv_flow_imp.id(100381979230340933)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>3
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100384762958340948)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100398139373651221)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_static_id=>'get-2'
,p_operation=>'GET'
,p_database_operation=>'FETCH_SINGLE_ROW'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100398447242652949)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_web_src_operation_id=>wwv_flow_imp.id(100398139373651221)
,p_name=>'id'
,p_static_id=>'id-2'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100385239970349129)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_static_id=>'put'
,p_operation=>'PUT'
,p_database_operation=>'UPDATE'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100385965659353594)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_web_src_operation_id=>wwv_flow_imp.id(100385239970349129)
,p_name=>'id'
,p_static_id=>'id'
,p_param_type=>'URL_PATTERN'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100937065015388805)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_web_src_operation_id=>wwv_flow_imp.id(100385239970349129)
,p_name=>'response'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(100385582031351942)
,p_web_src_module_id=>wwv_flow_imp.id(100384623875340940)
,p_web_src_operation_id=>wwv_flow_imp.id(100385239970349129)
,p_name=>'SAL'
,p_static_id=>'sal'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(101383282890286991)
,p_name=>'EBA_REST_EMPLOYEE_INVOKEAPI'
,p_static_id=>'eba_rest_employee_invokeapi'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_remote_server_id=>18529060167393527
,p_url_path_prefix=>'/data/emp'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'returns_legacy_ords_json', 'N',
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'EBA_REST_EMPLOYEE_INVOKEAPI'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101381799555286990)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'COMM'
,p_static_id=>'comm'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101382657258286991)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101382087364286991)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'EMPNO'
,p_static_id=>'empno'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101382351142286991)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'ENAME'
,p_static_id=>'ename'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101383007495286991)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'HIREDATE'
,p_static_id=>'hiredate'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101380874536286990)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'JOB'
,p_static_id=>'job'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101385772606332426)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'message'
,p_static_id=>'message'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101381126975286990)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'MGR'
,p_static_id=>'mgr'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101381514293286990)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101385057934329150)
,p_data_profile_id=>wwv_flow_imp.id(101380706566286990)
,p_name=>'status'
,p_static_id=>'status'
,p_sequence=>9
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101383496314286991)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101383970689302229)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_static_id=>'put'
,p_operation=>'PUT'
,p_database_operation=>'UPDATE'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(101407392091605876)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_web_src_operation_id=>wwv_flow_imp.id(101383970689302229)
,p_name=>'Content-Type'
,p_static_id=>'content-type'
,p_param_type=>'HEADER'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(101384271670308340)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_web_src_operation_id=>wwv_flow_imp.id(101383970689302229)
,p_name=>'id'
,p_static_id=>'id'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(101386536952335658)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_web_src_operation_id=>wwv_flow_imp.id(101383970689302229)
,p_name=>'message'
,p_static_id=>'message'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(101384632989314596)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_web_src_operation_id=>wwv_flow_imp.id(101383970689302229)
,p_name=>'SAL'
,p_static_id=>'sal'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(101386191437334659)
,p_web_src_module_id=>wwv_flow_imp.id(101383282890286991)
,p_web_src_operation_id=>wwv_flow_imp.id(101383970689302229)
,p_name=>'status'
,p_static_id=>'status'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100480729560577968)
,p_name=>'EBA_REST_EMPLOYEES_QUERY'
,p_static_id=>'eba_rest_employees'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_remote_server_id=>18529060167393527
,p_url_path_prefix=>'data/emp'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'returns_legacy_ords_json', 'N',
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100476596692577961)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100477993456577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'COMM'
,p_static_id=>'comm'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100479175271577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'DEPTNO'
,p_static_id=>'deptno'
,p_sequence=>9
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100478280630577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'EMPNO'
,p_static_id=>'empno'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100478558570577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'ENAME'
,p_static_id=>'ename'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100479483866577966)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'HIREDATE'
,p_static_id=>'hiredate'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100480033137577966)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'HREF'
,p_static_id=>'href'
,p_sequence=>12
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100478848592577965)
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
,p_selector=>'href'
,p_remote_data_type=>'string'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100477120812577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'JOB'
,p_static_id=>'job'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100478848592577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'LINKS'
,p_static_id=>'links'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100477418404577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'MGR'
,p_static_id=>'mgr'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100479802209577966)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'REL'
,p_static_id=>'rel'
,p_sequence=>11
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100476794672577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'RN'
,p_static_id=>'rn'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100477677411577965)
,p_data_profile_id=>wwv_flow_imp.id(100476596692577961)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>4
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100480986529577968)
,p_web_src_module_id=>wwv_flow_imp.id(100480729560577968)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(103523047316037782)
,p_name=>'EBA_REST_MOVIE_SYNCHRONIZATION'
,p_static_id=>'eba_rest_movie_synchronization'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_remote_server_id=>19597746759082809
,p_url_path_prefix=>'movie'
,p_credential_id=>15655119485874726
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(103523646878037785)
,p_web_src_module_id=>wwv_flow_imp.id(103523047316037782)
,p_name=>'query'
,p_static_id=>'query'
,p_param_type=>'QUERY_STRING'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'EBA_REST_MOVIE_SYNCHRONIZATION'
,p_format=>'JSON'
,p_row_selector=>'results'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103518626540037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'ADULT'
,p_static_id=>'adult'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103521684789037781)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'BACKDROP_PATH'
,p_static_id=>'backdrop-path'
,p_sequence=>12
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103519854674037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'GENRE_IDS'
,p_static_id=>'genre-ids'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103522536323037781)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'GENRE_IDS2'
,p_static_id=>'genre-ids-2'
,p_sequence=>15
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(103519854674037780)
,p_data_type=>'NUMBER'
,p_selector=>'.'
,p_remote_data_type=>'number'
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103518372114037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'ID'
,p_static_id=>'id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103522256512037781)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'ORIGINAL_LANGUAGE'
,p_static_id=>'original-language'
,p_sequence=>14
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103521972810037781)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'ORIGINAL_TITLE'
,p_static_id=>'original-title'
,p_sequence=>13
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103519617531037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'OVERVIEW'
,p_static_id=>'overview'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103520216990037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'POPULARITY'
,p_static_id=>'popularity'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103520821212037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'POSTER_PATH'
,p_static_id=>'poster-path'
,p_sequence=>9
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103521101384037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'RELEASE_DATE'
,p_static_id=>'release-date'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103518999832037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'TITLE'
,p_static_id=>'title'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103519254153037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'VIDEO'
,p_static_id=>'video'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103521422155037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'VOTE_AVERAGE'
,p_static_id=>'vote-average'
,p_sequence=>11
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103520437721037780)
,p_data_profile_id=>wwv_flow_imp.id(103518136432037777)
,p_name=>'VOTE_COUNT'
,p_static_id=>'vote-count'
,p_sequence=>8
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103523229325037783)
,p_web_src_module_id=>wwv_flow_imp.id(103523047316037782)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100061818544964008)
,p_name=>'EBA_REST_MOVIES'
,p_static_id=>'eba_rest_movies'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_remote_server_id=>20780987798122564
,p_url_path_prefix=>'/movie/popular'
,p_credential_id=>15655119485874726
,p_version_scn=>'23648570'
);
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'EBA_REST_MOVIES'
,p_format=>'JSON'
,p_row_selector=>'results'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100057396249964005)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'ADULT'
,p_static_id=>'adult'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100060377391964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'BACKDROP_PATH'
,p_static_id=>'backdrop-path'
,p_sequence=>12
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100058606201964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'GENRE_IDS'
,p_static_id=>'genre-ids'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100061271974964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'GENRE_IDS2'
,p_static_id=>'genre-ids-2'
,p_sequence=>15
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100058606201964006)
,p_data_type=>'NUMBER'
,p_selector=>'.'
,p_remote_data_type=>'number'
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100057051974964005)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'ID'
,p_static_id=>'id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100061016487964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'ORIGINAL_LANGUAGE'
,p_static_id=>'original-language'
,p_sequence=>14
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100060722105964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'ORIGINAL_TITLE'
,p_static_id=>'original-title'
,p_sequence=>13
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100058284820964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'OVERVIEW'
,p_static_id=>'overview'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100058846250964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'POPULARITY'
,p_static_id=>'popularity'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100059481533964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'POSTER_PATH'
,p_static_id=>'poster-path'
,p_sequence=>9
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100059739303964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'RELEASE_DATE'
,p_static_id=>'release-date'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100057655689964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'TITLE'
,p_static_id=>'title'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100057953274964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'VIDEO'
,p_static_id=>'video'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100060038666964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'VOTE_AVERAGE'
,p_static_id=>'vote-average'
,p_sequence=>11
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(22149285345098275)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'VOTE_AVG_ROUNDED'
,p_static_id=>'vote-avg-rounded'
,p_sequence=>25
,p_column_type=>'SQL_EXPRESSION'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100059216654964006)
,p_data_profile_id=>wwv_flow_imp.id(100056851406964002)
,p_name=>'VOTE_COUNT'
,p_static_id=>'vote-count'
,p_sequence=>8
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100061976680964010)
,p_web_src_module_id=>wwv_flow_imp.id(100061818544964008)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(101174937107568592)
,p_name=>'EBA_REST_ORDERS'
,p_static_id=>'eba_rest_orders'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(101173299460568585)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(101173299460568585)
,p_name=>'EBA_REST_ORDERS'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101174109753568590)
,p_data_profile_id=>wwv_flow_imp.id(101173299460568585)
,p_name=>'CUSTOMER_ID'
,p_static_id=>'customer-id'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101173792828568590)
,p_data_profile_id=>wwv_flow_imp.id(101173299460568585)
,p_name=>'ORDER_DATETIME'
,p_static_id=>'order-datetime'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101173434816568590)
,p_data_profile_id=>wwv_flow_imp.id(101173299460568585)
,p_name=>'ORDER_ID'
,p_static_id=>'order-id'
,p_sequence=>1
,p_is_primary_key=>true
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101174409339568590)
,p_data_profile_id=>wwv_flow_imp.id(101173299460568585)
,p_name=>'ORDER_STATUS'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101174661287568590)
,p_data_profile_id=>wwv_flow_imp.id(101173299460568585)
,p_name=>'STORE_ID'
,p_static_id=>'store-id'
,p_sequence=>5
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'store_id'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101175928816568594)
,p_web_src_module_id=>wwv_flow_imp.id(101174937107568592)
,p_static_id=>'delete'
,p_operation=>'DELETE'
,p_database_operation=>'DELETE'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101175140687568593)
,p_web_src_module_id=>wwv_flow_imp.id(101174937107568592)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101176423009568594)
,p_web_src_module_id=>wwv_flow_imp.id(101174937107568592)
,p_static_id=>'get-2'
,p_operation=>'GET'
,p_database_operation=>'FETCH_SINGLE_ROW'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101175567502568594)
,p_web_src_module_id=>wwv_flow_imp.id(101174937107568592)
,p_static_id=>'post'
,p_operation=>'POST'
,p_database_operation=>'INSERT'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101176780610568594)
,p_web_src_module_id=>wwv_flow_imp.id(101174937107568592)
,p_static_id=>'put'
,p_operation=>'PUT'
,p_database_operation=>'UPDATE'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100898397835684095)
,p_name=>'EBA_REST_EMPLOYEE_PAGINATION'
,p_static_id=>'eba_rest_pagination'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_remote_server_id=>18529060167393527
,p_url_path_prefix=>'/data/Pagination'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'has_more_rows_attribute_value', 'true',
  'has_more_rows_selector', 'hasMore',
  'has_more_rows_when_value', 'EQUALS',
  'page_size_url_parameter', 'limit',
  'pagination_type', 'FLEXIBLE',
  'row_offset_type', 'OFFSET',
  'row_offset_url_parameter', 'offset')).to_clob
,p_version_scn=>'16940986'
);
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100896384835684091)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100897796436684093)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'BONUS'
,p_static_id=>'bonus'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100896835754684093)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'DEPT'
,p_static_id=>'dept'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103808906123253822)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'ID'
,p_static_id=>'id'
,p_sequence=>0
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100897131760684093)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'NAME'
,p_static_id=>'name'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100897468600684093)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'RNUM'
,p_static_id=>'rnum'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100896588817684093)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'SAL'
,p_static_id=>'sal'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100898121456684093)
,p_data_profile_id=>wwv_flow_imp.id(100896384835684091)
,p_name=>'STATUS'
,p_static_id=>'status'
,p_sequence=>6
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100898548295684096)
,p_web_src_module_id=>wwv_flow_imp.id(100898397835684095)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(104588373329466022)
,p_name=>'EBA_REST_PRODUCT_WORKFLOWS'
,p_static_id=>'eba_rest_product_workflows'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104588925997466022)
,p_web_src_module_id=>wwv_flow_imp.id(104588373329466022)
,p_name=>'id'
,p_static_id=>'id'
,p_param_type=>'URL_PATTERN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'EBA_REST_PRODUCT_WORKFLOWS'
,p_format=>'JSON'
,p_row_selector=>'.'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104586574200466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'IMAGE_CHARSET'
,p_static_id=>'image-charset'
,p_sequence=>4
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104587223872466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'IMAGE_FILENAME'
,p_static_id=>'image-filename'
,p_sequence=>6
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104588103592466022)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'IMAGE_LAST_UPDATED'
,p_static_id=>'image-last-updated'
,p_sequence=>9
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104587483429466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'IMAGE_MIME_TYPE'
,p_static_id=>'image-mime-type'
,p_sequence=>7
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104587762850466022)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104585655878466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'PRODUCT_ID'
,p_static_id=>'product-id'
,p_sequence=>1
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104586909033466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'PRODUCT_IMAGE'
,p_static_id=>'product-image'
,p_sequence=>5
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104586302515466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'PRODUCT_NAME'
,p_static_id=>'product-name'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104585964896466021)
,p_data_profile_id=>wwv_flow_imp.id(104585522112466021)
,p_name=>'UNIT_PRICE'
,p_static_id=>'unit-price'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(104588543075466022)
,p_web_src_module_id=>wwv_flow_imp.id(104588373329466022)
,p_name=>'fetch single product'
,p_static_id=>'fetch-single-product'
,p_operation=>'GET'
,p_database_operation=>'FETCH_SINGLE_ROW'
,p_url_pattern=>'.'
);
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104591725753472139)
,p_web_src_module_id=>wwv_flow_imp.id(104588373329466022)
,p_web_src_operation_id=>wwv_flow_imp.id(104588543075466022)
,p_name=>'PRODUCT_DETAILS'
,p_static_id=>'product-details'
,p_param_type=>'DATA_PROFILE'
,p_direction=>'OUT'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104590761692471266)
,p_web_src_module_id=>wwv_flow_imp.id(104588373329466022)
,p_web_src_operation_id=>wwv_flow_imp.id(104588543075466022)
,p_name=>'PRODUCT_NAME'
,p_static_id=>'product-name'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(100992928651159995)
,p_name=>'EBA_REST_PURCHASE_ORDER'
,p_static_id=>'eba_rest_purchase_order'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'EBA_REST_PURCHASE_ORDER'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100990700637159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'ITEMNUMBER'
,p_static_id=>'itemnumber'
,p_sequence=>21
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100985276675159991)
,p_data_type=>'NUMBER'
,p_selector=>'ItemNumber'
,p_remote_data_type=>'number'
);
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100991299708159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'NUMBER_'
,p_static_id=>'number'
,p_sequence=>23
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100986740236159991)
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
,p_selector=>'number'
,p_remote_data_type=>'string'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100990076853159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PART_DESCRIPTION'
,p_static_id=>'part-description'
,p_sequence=>19
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100985276675159991)
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100989765035159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PART_UNITPRICE'
,p_static_id=>'part-unitprice'
,p_sequence=>18
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100985276675159991)
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100989507800159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PART_UPCCODE'
,p_static_id=>'part-upccode'
,p_sequence=>17
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(100985276675159991)
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100986179043159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_COSTCENTER'
,p_static_id=>'po-costcenter'
,p_sequence=>6
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100985276675159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_LINEITEMS'
,p_static_id=>'po-lineitems'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'ARRAY'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100984986912159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_PONUMBER'
,p_static_id=>'po-ponumber'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100985598740159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_REFERENCE'
,p_static_id=>'po-reference'
,p_sequence=>4
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100985896470159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_REQUESTOR'
,p_static_id=>'po-requestor'
,p_sequence=>5
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100987047796159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_CITY'
,p_static_id=>'po-shippinginstructions-address-city'
,p_sequence=>9
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100988243440159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_COUNTRY'
,p_static_id=>'po-shippinginstructions-address-country'
,p_sequence=>13
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100987722699159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_COUNTY'
,p_static_id=>'po-shippinginstructions-address-county'
,p_sequence=>11
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100988912589159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_POSTCODE'
,p_static_id=>'po-shippinginstructions-address-postcode'
,p_sequence=>15
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100987420718159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_STATE'
,p_static_id=>'po-shippinginstructions-address-state'
,p_sequence=>10
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100987946387159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_STREET'
,p_static_id=>'po-shippinginstructions-address-street'
,p_sequence=>12
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100988535632159992)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_ADDRESS_ZIPCODE'
,p_static_id=>'po-shippinginstructions-address-zipcode'
,p_sequence=>14
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100986435652159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_NAME'
,p_static_id=>'po-shippinginstructions-name'
,p_sequence=>7
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100986740236159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SHIPPINGINSTRUCTIONS_PHONE'
,p_static_id=>'po-shippinginstructions-phone'
,p_sequence=>8
,p_column_type=>'DATA'
,p_data_type=>'ARRAY'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100989156317159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_SPECIAL_INSTRUCTIONS'
,p_static_id=>'po-special-instructions'
,p_sequence=>16
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100984666520159991)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'PO_USER'
,p_static_id=>'po-user'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100990326206159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'QUANTITY'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(100991005476159993)
,p_data_profile_id=>wwv_flow_imp.id(100984465053159989)
,p_name=>'TYPE'
,p_static_id=>'type'
,p_sequence=>22
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(100993179680159996)
,p_web_src_module_id=>wwv_flow_imp.id(100992928651159995)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(101180776092596569)
,p_name=>'EBA_REST_STORES'
,p_static_id=>'eba_rest_stores'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'EBA_REST_STORES'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101178707040596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LATITUDE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101179228696596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LOGO'
,p_static_id=>'logo'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101180174783596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LOGO_CHARSET'
,p_static_id=>'logo-charset'
,p_sequence=>10
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101179924476596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LOGO_FILENAME'
,p_static_id=>'logo-filename'
,p_sequence=>9
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101180508259596569)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LOGO_LAST_UPDATED'
,p_static_id=>'logo-last-updated'
,p_sequence=>11
,p_column_type=>'DATA'
,p_data_type=>'DATE'
,p_has_time_zone=>true
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101179598459596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LOGO_MIME_TYPE'
,p_static_id=>'logo-mime-type'
,p_sequence=>8
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101178960551596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'LONGITUDE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101178412031596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'PHYSICAL_ADDRESS'
,p_static_id=>'physical-address'
,p_sequence=>4
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101177477088596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'STORE_ID'
,p_static_id=>'store-id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101177816996596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'STORE_NAME'
,p_static_id=>'store-name'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(101178104848596568)
,p_data_profile_id=>wwv_flow_imp.id(101177271444596568)
,p_name=>'WEB_ADDRESS'
,p_static_id=>'web-address'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101181810375596569)
,p_web_src_module_id=>wwv_flow_imp.id(101180776092596569)
,p_static_id=>'delete'
,p_operation=>'DELETE'
,p_database_operation=>'DELETE'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101180936785596569)
,p_web_src_module_id=>wwv_flow_imp.id(101180776092596569)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101182142001596569)
,p_web_src_module_id=>wwv_flow_imp.id(101180776092596569)
,p_static_id=>'get-2'
,p_operation=>'GET'
,p_database_operation=>'FETCH_SINGLE_ROW'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101181405749596569)
,p_web_src_module_id=>wwv_flow_imp.id(101180776092596569)
,p_static_id=>'post'
,p_operation=>'POST'
,p_database_operation=>'INSERT'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(101182544101596569)
,p_web_src_module_id=>wwv_flow_imp.id(101180776092596569)
,p_static_id=>'put'
,p_operation=>'PUT'
,p_database_operation=>'UPDATE'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(103127185780858933)
,p_name=>'EBA_REST_TASKS'
,p_static_id=>'eba_rest_tasks'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'EBA_REST_TASKS'
,p_format=>'JSON'
,p_row_selector=>'items'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103125047606858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'ASSIGNED_TO'
,p_static_id=>'assigned-to'
,p_sequence=>7
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103125685047858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'BUDGET'
,p_static_id=>'budget'
,p_sequence=>9
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103125359490858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'COST'
,p_static_id=>'cost'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103126015992858932)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'CREATED'
,p_static_id=>'created'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103126271329858932)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'CREATED_BY'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103124485193858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'END_DATE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103123310811858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'ID'
,p_static_id=>'id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103123527174858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'PROJECT'
,p_static_id=>'project'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103124198419858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'START_DATE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103124812034858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'STATUS'
,p_static_id=>'status'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103123828539858931)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'TASK_NAME'
,p_static_id=>'task-name'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103126533191858932)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'UPDATED'
,p_static_id=>'updated'
,p_sequence=>12
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(103126913420858932)
,p_data_profile_id=>wwv_flow_imp.id(103123049926858928)
,p_name=>'UPDATED_BY'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103128219191858936)
,p_web_src_module_id=>wwv_flow_imp.id(103127185780858933)
,p_static_id=>'delete'
,p_operation=>'DELETE'
,p_database_operation=>'DELETE'
,p_url_pattern=>':id'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103127363404858934)
,p_web_src_module_id=>wwv_flow_imp.id(103127185780858933)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103128591823858936)
,p_web_src_module_id=>wwv_flow_imp.id(103127185780858933)
,p_static_id=>'get-2'
,p_operation=>'GET'
,p_database_operation=>'FETCH_SINGLE_ROW'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103127824264858936)
,p_web_src_module_id=>wwv_flow_imp.id(103127185780858933)
,p_static_id=>'post'
,p_operation=>'POST'
,p_database_operation=>'INSERT'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(103128943855858936)
,p_web_src_module_id=>wwv_flow_imp.id(103127185780858933)
,p_static_id=>'put'
,p_operation=>'PUT'
,p_database_operation=>'UPDATE'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(104742933874198222)
,p_name=>'EBA_REST_PRODUCT_WORKFLOWS_POST'
,p_static_id=>'post'
,p_web_source_type=>'NATIVE_ORDS'
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_remote_server_id=>18529060167393527
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104743992156198222)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_name=>'id'
,p_static_id=>'id'
,p_param_type=>'URL_PATTERN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'Post'
,p_format=>'JSON'
,p_row_selector=>'.'
,p_use_raw_json_selectors=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104747293418202904)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'CREATED_DATE'
,p_static_id=>'created-date'
,p_sequence=>4
,p_column_type=>'DATA'
,p_data_type=>'TIMESTAMP WITH TIME ZONE'
,p_format_mask=>'YYYY"-"MM"-"DD"T"HH24":"MI:SS.FF9TZR'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104749249466202904)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'HREF'
,p_static_id=>'href'
,p_sequence=>8
,p_column_type=>'DATA'
,p_parent_column_id=>wwv_flow_imp.id(104746267824202903)
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
,p_selector=>'href'
,p_remote_data_type=>'string'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104745815097202903)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'ID'
,p_static_id=>'id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104746267824202903)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'LINKS'
,p_static_id=>'links'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104748277402202904)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'PRODUCT_DETAILS'
,p_static_id=>'product-details'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104747745507202904)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'PRODUCT_NAME'
,p_static_id=>'product-name'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104748778508202904)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'REL'
,p_static_id=>'rel'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(104746765267202903)
,p_data_profile_id=>wwv_flow_imp.id(104742207418198221)
,p_name=>'USER_ID'
,p_static_id=>'user-id'
,p_sequence=>3
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(104743162235198222)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(104743528167198222)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_static_id=>'post'
,p_operation=>'POST'
,p_database_operation=>'INSERT'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104770947408325539)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_web_src_operation_id=>wwv_flow_imp.id(104743528167198222)
,p_name=>'Content-Type'
,p_static_id=>'content-type'
,p_param_type=>'HEADER'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104751589756219633)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_web_src_operation_id=>wwv_flow_imp.id(104743528167198222)
,p_name=>'PRODUCT_DETAILS'
,p_static_id=>'product-details'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104751216337216350)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_web_src_operation_id=>wwv_flow_imp.id(104743528167198222)
,p_name=>'PRODUCT_NAME'
,p_static_id=>'product-name'
...
wwv_flow_imp_shared.create_web_source_param(
 p_id=>wwv_flow_imp.id(104750762286214613)
,p_web_src_module_id=>wwv_flow_imp.id(104742933874198222)
,p_web_src_operation_id=>wwv_flow_imp.id(104743528167198222)
,p_name=>'USER_ID'
,p_static_id=>'user-id'
...
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(99235036268192979)
,p_name=>'EBA_REST_ODATA_PRODUCT'
,p_static_id=>'prod_odata'
,p_web_source_type=>'NATIVE_ODATA'
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_remote_server_id=>17028453717544882
,p_url_path_prefix=>'Northwind.svc/'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'case_insensitive_filtering', 'none',
  'resource_path', 'Products',
  'return_total_result_count', 'count_none',
  'send_query_options', 'N',
  'supported_odata_filters', 'filter_contains:filter_startswith:filter_in:filter_endswith',
  'supported_odata_options', 'option_orderby:option_select:option_search:option_client_driven_paging')).to_clob
,p_version_scn=>'37743998'
);
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'PROD_ODATA'
,p_format=>'JSON'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99232680047192978)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'CATEGORYID'
,p_static_id=>'categoryid'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99233569257192979)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'DISCONTINUED'
,p_static_id=>'discontinued'
,p_sequence=>6
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99232103679192978)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'PRODUCTID'
,p_static_id=>'productid'
,p_sequence=>1
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99233296733192978)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'PRODUCTNAME'
,p_static_id=>'productname'
,p_sequence=>5
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99234738266192979)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'QUANTITYPERUNIT'
,p_static_id=>'quantityperunit'
,p_sequence=>10
,p_column_type=>'DATA'
,p_data_type=>'VARCHAR2'
,p_max_length=>4000
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99233866797192979)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'REORDERLEVEL'
,p_static_id=>'reorderlevel'
,p_sequence=>7
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99232942792192978)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'SUPPLIERID'
,p_static_id=>'supplierid'
,p_sequence=>4
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99232390391192978)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'UNITPRICE'
,p_static_id=>'unitprice'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99234191965192979)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'UNITSINSTOCK'
,p_static_id=>'unitsinstock'
,p_sequence=>8
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(99234500251192979)
,p_data_profile_id=>wwv_flow_imp.id(99231904585192977)
,p_name=>'UNITSONORDER'
,p_static_id=>'unitsonorder'
,p_sequence=>9
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(99235247002192979)
,p_web_src_module_id=>wwv_flow_imp.id(99235036268192979)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
wwv_flow_imp_shared.create_workflow(
 p_id=>wwv_flow_imp.id(103503422233486251)
,p_name=>'Creating Order'
,p_static_id=>'CREATE_ORDER'
,p_title=>'Creating Order'
);
wwv_flow_imp_shared.create_workflow_variable(
 p_id=>wwv_flow_imp.id(103546324007368609)
,p_workflow_id=>wwv_flow_imp.id(103503422233486251)
,p_label=>'PRODUCT_ID'
...
wwv_flow_imp_shared.create_workflow_version(
 p_id=>wwv_flow_imp.id(19648437109834757)
,p_workflow_id=>wwv_flow_imp.id(103503422233486251)
,p_version=>'1.O'
,p_state=>'ACTIVE'
);
wwv_flow_imp_shared.create_workflow_variable(
 p_id=>wwv_flow_imp.id(19650844570834781)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
wwv_flow_imp_shared.create_workflow_variable(
 p_id=>wwv_flow_imp.id(19650923285834782)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
wwv_flow_imp_shared.create_workflow_variable(
 p_id=>wwv_flow_imp.id(19651022285834783)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
,p_label=>'USER_EMAIL'
...
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19648842815834761)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19649016263834763)
,p_web_src_param_id=>wwv_flow_imp.id(104588925997466022)
,p_workflow_activity_id=>wwv_flow_imp.id(19648842815834761)
,p_value_type=>'ITEM'
,p_value=>'PRODUCT_ID'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19649124036834764)
,p_web_src_param_id=>wwv_flow_imp.id(104591725753472139)
,p_workflow_activity_id=>wwv_flow_imp.id(19648842815834761)
,p_value_type=>'ITEM'
,p_value=>'PRODUCT_DETAILS'
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19649225717834765)
,p_web_src_param_id=>wwv_flow_imp.id(104590761692471266)
,p_workflow_activity_id=>wwv_flow_imp.id(19648842815834761)
,p_value_type=>'ITEM'
,p_value=>'PRODUCT_NAME'
,p_ignore_output=>false
...
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19648504298834758)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
,p_name=>'Start'
,p_static_id=>'New'
...
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19649575174834768)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19649790120834770)
,p_web_src_param_id=>wwv_flow_imp.id(104770947408325539)
,p_workflow_activity_id=>wwv_flow_imp.id(19649575174834768)
,p_value_type=>'DEFAULT'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19649875471834771)
,p_web_src_param_id=>wwv_flow_imp.id(104743992156198222)
,p_workflow_activity_id=>wwv_flow_imp.id(19649575174834768)
,p_value_type=>'ITEM'
,p_value=>'PRODUCT_ID'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19649919414834772)
,p_web_src_param_id=>wwv_flow_imp.id(104751589756219633)
,p_workflow_activity_id=>wwv_flow_imp.id(19649575174834768)
,p_value_type=>'ITEM'
,p_value=>'PRODUCT_DETAILS'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19650012305834773)
,p_web_src_param_id=>wwv_flow_imp.id(104751216337216350)
,p_workflow_activity_id=>wwv_flow_imp.id(19649575174834768)
,p_value_type=>'ITEM'
,p_value=>'PRODUCT_NAME'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(19650108887834774)
,p_web_src_param_id=>wwv_flow_imp.id(104750762286214613)
,p_workflow_activity_id=>wwv_flow_imp.id(19649575174834768)
,p_value_type=>'ITEM'
,p_value=>'USER_EMAIL'
);
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19648748957834760)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
,p_name=>'End'
,p_static_id=>'New_2'
...
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19650234803834775)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
,p_name=>'Send Email'
,p_static_id=>'New_3'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'body_plain_text', 'Order recieved.',
  'from', '&USER_EMAIL.',
  'send_immediately', 'N',
  'subject', 'Order Recieved',
  'to', '&USER_EMAIL.')).to_clob
,p_diagram=>'{"position":{"x":770,"y":100},"z":6}'
);
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19650456916834777)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'compare_variable', 'PRODUCT_NAME',
  'type', 'CHECK_WF_VARIABLE')).to_clob
,p_diagram=>'{"position":{"x":160,"y":100},"z":7}'
);
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19650800390834780)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
,p_activity_type=>'NATIVE_WORKFLOW_END'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'end_state', 'TERMINATED')).to_clob
,p_diagram=>'{"position":{"x":240,"y":-90},"z":8}'
);
wwv_flow_imp_shared.create_workflow_activity(
 p_id=>wwv_flow_imp.id(19649384671834766)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'static_value', 'PT5S',
  'timeout_type', 'STATIC')).to_clob
,p_diagram=>'{"position":{"x":30,"y":100},"z":4}'
);
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19648971378834762)
,p_name=>'New'
,p_transition_type=>'NORMAL'
,p_from_activity_id=>wwv_flow_imp.id(19648842815834761)
,p_to_activity_id=>wwv_flow_imp.id(19649384671834766)
,p_diagram=>'{"source":{},"target":{"name":"topLeft","args":{"dx":"0%","dy":"50%","rotate":true}},"vertices":[],"z":10,"label":{"distance":0.5,"offset":0}}'
);
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19648610940834759)
,p_name=>'New'
,p_transition_type=>'NORMAL'
,p_from_activity_id=>wwv_flow_imp.id(19648504298834758)
,p_to_activity_id=>wwv_flow_imp.id(19648842815834761)
,p_diagram=>'{"source":{},"target":{},"vertices":[],"z":9,"label":{"distance":0.5,"offset":0}}'
);
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19649645657834769)
,p_name=>'New'
,p_transition_type=>'NORMAL'
,p_from_activity_id=>wwv_flow_imp.id(19649575174834768)
,p_to_activity_id=>wwv_flow_imp.id(19650234803834775)
,p_diagram=>'{"source":{},"target":{},"vertices":[],"z":12,"label":{"distance":0.5,"offset":0}}'
);
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19650338890834776)
,p_name=>'New'
,p_transition_type=>'NORMAL'
,p_from_activity_id=>wwv_flow_imp.id(19650234803834775)
,p_to_activity_id=>wwv_flow_imp.id(19648748957834760)
,p_diagram=>'{"source":{},"target":{"name":"topLeft","args":{"dx":"50%","dy":"50%","rotate":true}},"vertices":[],"z":13,"label":{"distance":0.5,"offset":0}}'
);
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19650533082834778)
,p_name=>'Yes'
,p_execution_sequence=>10
,p_transition_type=>'BRANCH'
,p_from_activity_id=>wwv_flow_imp.id(19650456916834777)
,p_to_activity_id=>wwv_flow_imp.id(19649575174834768)
...
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19650658934834779)
,p_name=>'No'
,p_execution_sequence=>10
,p_transition_type=>'BRANCH'
,p_from_activity_id=>wwv_flow_imp.id(19650456916834777)
,p_to_activity_id=>wwv_flow_imp.id(19650800390834780)
...
wwv_flow_imp_shared.create_workflow_transition(
 p_id=>wwv_flow_imp.id(19649492545834767)
,p_name=>'New'
,p_transition_type=>'NORMAL'
,p_from_activity_id=>wwv_flow_imp.id(19649384671834766)
,p_to_activity_id=>wwv_flow_imp.id(19650456916834777)
...
wwv_flow_imp_shared.create_workflow_participant(
 p_id=>wwv_flow_imp.id(19651124410834784)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
wwv_flow_imp_shared.create_workflow_participant(
 p_id=>wwv_flow_imp.id(19651244414834785)
,p_workflow_version_id=>wwv_flow_imp.id(19648437109834757)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98086748451087905)
,p_name=>'Advanced Features'
,p_static_id=>'advanced-features'
,p_version_scn=>'20808695'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(99737365173406877)
,p_list_item_display_sequence=>19
,p_list_item_link_text=>'Invoke API Process'
,p_static_id=>'invoke-api-process'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98399809195940996)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Nested JSON and Dynamic Actions'
,p_static_id=>'nested-json-and-dynamic-actions'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98633007583171546)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'REST Data and PL/SQL'
,p_static_id=>'rest-data-and-pl-sql'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(103329574664285767)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98081679127012774)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98383776287622275)
,p_name=>'Data Display Options'
,p_static_id=>'data-display-options'
,p_version_scn=>'23634224'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98468289315086795)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98398335415790339)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Cards Layout'
,p_static_id=>'cards-layout'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98463804375015904)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98466633259045315)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98398986011796259)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Oracle JET Charts'
,p_static_id=>'oracle-jet-charts'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98397617832782347)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Report with Pagination'
,p_static_id=>'report-with-pagination'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98398103879788376)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Report with Query'
,p_static_id=>'report-with-query'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98397303344779258)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Simple Report'
,p_static_id=>'simple-report'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98067162355584197)
,p_name=>'Home'
,p_static_id=>'home'
,p_version_scn=>'50269995'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98444945327100516)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98444382370068449)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98444671414086745)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98444024897042326)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98084898401057999)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98040375423571992)
,p_name=>'Navigation Bar'
,p_static_id=>'navigation-bar'
,p_version_scn=>'21517321'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(102112745112131564)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98062307503572047)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98060632097572046)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Help'
,p_static_id=>'help'
,p_list_item_link_target=>'f?p=&APP_ID.:600:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-question-circle-o'
,p_required_patch=>wwv_flow_imp.id(98043532679572003)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98062806336572047)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'---'
,p_static_id=>'list_item'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(98062307503572047)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98063176623572047)
,p_list_item_display_sequence=>70
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98039146166571977)
,p_name=>'Navigation Menu'
,p_static_id=>'navigation-menu'
,p_version_scn=>'50269255'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98063816688572047)
,p_list_item_display_sequence=>10000
,p_list_item_link_text=>'Administration'
,p_static_id=>'administration'
,p_list_item_link_target=>'f?p=&APP_ID.:500:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-user-wrench'
,p_security_scheme=>wwv_flow_imp.id(98044374387572004)
,p_list_item_current_type=>'TARGET_PAGE'
,p_sub_list_id=>wwv_flow_imp.id(98064882505572049)
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98074991052810237)
...
,p_list_item_icon=>'fa-ellipsis-h-o'
,p_list_item_current_type=>'TARGET_PAGE'
,p_sub_list_id=>wwv_flow_imp.id(98086748451087905)
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98074133841787951)
...
,p_list_item_icon=>'fa-database-arrow-up'
,p_list_item_current_type=>'TARGET_PAGE'
,p_sub_list_id=>wwv_flow_imp.id(98081494948012773)
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98390610587648313)
...
,p_list_item_icon=>'fa-table'
,p_list_item_current_type=>'TARGET_PAGE'
,p_sub_list_id=>wwv_flow_imp.id(98383776287622275)
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98051329607572020)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98073644146769628)
,p_list_item_display_sequence=>10
...
,p_list_item_current_type=>'TARGET_PAGE'
,p_sub_list_id=>wwv_flow_imp.id(98072952673755492)
);
end;
/
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98072952673755492)
,p_name=>'REST Data Sources'
,p_static_id=>'rest-data-sources'
,p_version_scn=>'16565667'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98081137072984404)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98077364304830128)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98073210053755492)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Simple HTTP'
,p_static_id=>'simple-http'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(98064882505572049)
,p_name=>'User Interface'
,p_static_id=>'user-interface'
,p_required_patch=>wwv_flow_imp.id(98043638650572003)
,p_version_scn=>'4594966'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(101459354820860778)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Network Setup'
,p_static_id=>'network-setup'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(99048412718336218)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(98065236359572049)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(99488377830886390)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(98041790116572002)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(98042091609572002)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(98042411416572003)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(98041427714572001)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(98042625516572003)
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(98044374387572004)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(101552400601772301)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(104688066860187987)
,p_name=>'ODATA_URL'
,p_is_required=>'N'
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(104688265176190332)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(101529280000187794)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(104688465610191867)
,p_name=>'REMOTE_SERVER_SCHEMA_ALIAS'
,p_is_required=>'N'
,p_version_scn=>'75158655'
);
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(19820360525862755)
,p_name=>'TMDB_APIKEY'
,p_value=>'NO'
,p_is_required=>'N'
,p_valid_values=>'YES,NO'
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(98056153045572032)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(20287579398843259)
,p_lov_name=>'EMPLOYEE_POPUP_LOV'
,p_static_id=>'employee-popup-lov'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(20288614329847281)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(20288201603847281)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(20289050418847281)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(98056877493572041)
,p_lov_name=>'USER_THEME_PREFERENCE'
,p_static_id=>'user-theme-preference'
,p_lov_query=>'.'||wwv_flow_imp.id(98056877493572041)||'.'
,p_location=>'STATIC'
,p_version_scn=>'3433405'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(98057170092572041)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(103581793958584874)
,p_lov_name=>'WORKFLOW_CONSOLE.LOV.INITIATED'
,p_static_id=>'workflow-console-lov-initiated'
,p_lov_query=>'.'||wwv_flow_imp.id(103581793958584874)||'.'
,p_location=>'STATIC'
,p_version_scn=>'15347693'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(103582498650584876)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(103583226273584876)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(103582887258584876)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(103582071221584874)
,p_lov_disp_sequence=>1
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(103583642413584876)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(103580297786584872)
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(98044647899572005)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(98038712546571976)
,p_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103280076966012510)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103285583511030421)
,p_parent_id=>wwv_flow_imp.id(103280076966012510)
,p_short_name=>'Application Appearance'
,p_static_id=>'application-appearance'
,p_link=>'f?p=&APP_ID.:501:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>501
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103120798818833153)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103078776950763126)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103011164856842150)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103027458531063312)
,p_parent_id=>wwv_flow_imp.id(103011164856842150)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103104088131780631)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
,p_short_name=>'Faceted Search on REST'
,p_static_id=>'faceted-search-on-rest'
,p_link=>'f?p=&APP_ID.:306:&SESSION.::&DEBUG.:::'
,p_page_id=>306
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(98038915858571976)
,p_short_name=>'Home'
,p_static_id=>'home'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103163737849573572)
,p_parent_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103116576855804165)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
,p_short_name=>'Map'
,p_static_id=>'map'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103257655221896736)
,p_parent_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103304630424098596)
,p_parent_id=>wwv_flow_imp.id(103280076966012510)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102975013538064785)
,p_parent_id=>wwv_flow_imp.id(102987579540257252)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103086980348770705)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102965816245045251)
,p_parent_id=>wwv_flow_imp.id(102987579540257252)
,p_option_sequence=>11
,p_short_name=>'Oracle REST Data Services (ORDS)'
,p_static_id=>'oracle-rest-data-services-ords'
,p_link=>'f?p=&APP_ID.:102:&SESSION.::&DEBUG.:::'
,p_page_id=>102
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103018463057003999)
,p_parent_id=>wwv_flow_imp.id(103011164856842150)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103062257693744975)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103071340808754344)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103291614124048884)
,p_parent_id=>wwv_flow_imp.id(103280076966012510)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103543654133989897)
,p_parent_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103183234077795168)
,p_parent_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103270620190913586)
,p_parent_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102987579540257252)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103157451818549390)
,p_parent_id=>wwv_flow_imp.id(103138934873900917)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(102957756737028816)
,p_parent_id=>wwv_flow_imp.id(102987579540257252)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103056152025696644)
,p_parent_id=>wwv_flow_imp.id(103046297580663358)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103298325633077846)
,p_parent_id=>wwv_flow_imp.id(103280076966012510)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(103578389934584868)
,p_parent_id=>wwv_flow_imp.id(103543654133989897)
,p_short_name=>'Workflow Console'
,p_static_id=>'workflow-console'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(98039544087571979)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(98038031376571974)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(98043532679572003)
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(98043638650572003)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19484395365097427)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19482899289968136)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19496990499372077)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19497161192377384)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19502928423167312)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19497337050392761)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19496633134364358)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19497583554397125)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19483416624020868)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(19494746481294339)
...
wwv_flow_imp_shared.create_email_template(
 p_id=>wwv_flow_imp.id(20294541675099110)
...
'  </head>'))
,p_html_footer=>'</html>'
,p_version_scn=>'SH256:VgdbOCIdLi_cguUM261nfY_N_5DGUUmiVPGTEmqvr_8'
);
end;
/
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(98038332417571975)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(101402593086537146)
,p_plug_name=>'New'
,p_static_id=>'new'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(98411459742379427)
,p_plug_name=>'About'
,p_static_id=>'about'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(98411569081379428)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(98067162355584197)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2069471208528591807
,p_landmark_type=>'navigation'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(98052291671572023)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(98410189717379414)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(98052291671572023)
,p_button_name=>'NEXT'
,p_static_id=>'next'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(101400997766537130)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108913041427631937)
,p_plug_name=>'1. Remote Server Setup'
,p_static_id=>'1-remote-server-setup'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109628062532273131)
,p_plug_name=>'2. OData URL Setup'
,p_static_id=>'2-odata-url-setup'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102118734134178352)
,p_plug_name=>'3. Proxy Setup'
,p_static_id=>'3-proxy-setup'
,p_title=>'Proxy Setup'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109627664527273128)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109627595894273127)
,p_plug_name=>'Guide'
,p_static_id=>'guide'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108915028567631957)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109627540429273126)
,p_plug_name=>'Welcome to Sample REST Services'
,p_static_id=>'welcome-to-sample-rest-services'
,p_parent_plug_id=>wwv_flow_imp.id(108915028567631957)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2675494171183407654
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103345714940356425)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(109627664527273128)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(103350470148356430)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108916512741631944)
,p_name=>'P2_BASE_URL'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(108913041427631937)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(109630713597273136)
,p_name=>'P2_ODATA_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(109628062532273131)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(102118837227178353)
,p_name=>'P2_PROXY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(102118734134178352)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108916600854631945)
,p_name=>'P2_SCHEMA'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(108913041427631937)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(103348895397356429)
,p_validation_name=>'P2_BASE_URL not null'
,p_static_id=>'p2-base-url-not-null'
,p_validation_sequence=>10
,p_validation=>'P2_BASE_URL'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_associated_item=>wwv_flow_imp.id(108916512741631944)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(103349236698356429)
,p_validation_name=>'P2_SCHEMA is not null'
,p_static_id=>'p2-schema-is-not-null'
,p_validation_sequence=>20
,p_validation=>'P2_SCHEMA'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_associated_item=>wwv_flow_imp.id(108916600854631945)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103350021696356429)
,p_process_sequence=>10
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Persist User Data'
,p_static_id=>'persist-user-data'
...
,p_process_when_button_id=>wwv_flow_imp.id(103345714940356425)
,p_process_success_message=>'Connection setup successfully.'
,p_internal_uid=>7518197002094822
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(102118995938178354)
,p_process_sequence=>20
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Set Proxy'
,p_static_id=>'set-proxy'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102115444040178319)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_menu_id=>wwv_flow_imp.id(98038712546571976)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4073839682315169711
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105555758789253827)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(98072952673755492)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2069471208528591807
,p_landmark_type=>'navigation'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102115790225178322)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(102115444040178319)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102115630574178321)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102115444040178319)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(112304441111241133)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(112322410071745912)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(112322510668745913)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112322975279745918)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112323388831745922)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112323146825745919)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112323199580745920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112323563841745923)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112322752630745915)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112322780697745916)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(112322868293745917)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(112340171909011497)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(104003177169825838)
,p_page_id=>101
,p_web_src_param_id=>wwv_flow_imp.id(100456078462896034)
,p_page_plug_id=>wwv_flow_imp.id(112322410071745912)
,p_value_type=>'NULL'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(112643418934872425)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102956727090028815)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(112304441111241133)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102957148230028815)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(112304441111241133)
,p_button_name=>'previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105485878840038158)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105480468217038153)
,p_plug_name=>'Employees Data'
,p_static_id=>'employees-data'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
,p_plug_template=>2102002977963900996
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(105480512638038153)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105483634289038156)
,p_db_column_name=>'COMM'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Commission'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105484020978038156)
,p_db_column_name=>'DEPTNO'
,p_display_order=>8
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105481229784038155)
,p_db_column_name=>'EMPNO'
,p_display_order=>0
,p_is_primary_key=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105481624115038155)
,p_db_column_name=>'ENAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105482891395038155)
,p_db_column_name=>'HIREDATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Hire Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105482057132038155)
,p_db_column_name=>'JOB'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Job'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105482482422038155)
,p_db_column_name=>'MGR'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Manager'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105483306718038156)
,p_db_column_name=>'SAL'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Salary'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(105486511201039390)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(102960560442045248)
,p_page_id=>102
,p_web_src_param_id=>wwv_flow_imp.id(100456078462896034)
,p_page_plug_id=>wwv_flow_imp.id(105480468217038153)
,p_value_type=>'NULL'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105538755089163063)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102963970264045250)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105480468217038153)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102964814659045250)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105485878840038158)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102965195934045251)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105485878840038158)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(102966045489045251)
,p_name=>'Edit Report - Dialog Closed'
,p_static_id=>'edit-report-dialog-closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(105480468217038153)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(102966611547045253)
,p_event_id=>wwv_flow_imp.id(102966045489045251)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(105480468217038153)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105215582914768823)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106273341417627785)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(106348249345864091)
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348564818864095)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106349253125864101)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348275499864092)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348461891864093)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348729811864096)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106349122488864100)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348514316864094)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348792868864097)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106348950243864098)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106349023316864099)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(106366515633879451)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(102115915696178323)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105547868292182598)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102973927166064784)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105215582914768823)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102973560272064784)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105215582914768823)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102116023556178324)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(102115915696178323)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105827050468135504)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2127905476394690047
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105821048515135497)
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103311152854142603)
,p_page_id=>104
,p_web_src_param_id=>wwv_flow_imp.id(100456078462896034)
,p_page_plug_id=>wwv_flow_imp.id(105821048515135497)
,p_value_type=>'NULL'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103311667695142604)
,p_page_id=>104
,p_web_src_param_id=>wwv_flow_imp.id(99750756916369415)
,p_page_plug_id=>wwv_flow_imp.id(105821048515135497)
,p_value_type=>'ITEM'
,p_value=>'P104_EMPNO'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103318087024142607)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105827050468135504)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103319243796142608)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103318442857142607)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105827050468135504)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103318829288142608)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105825458503135504)
,p_name=>'P104_COMM'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(105821048515135497)
,p_item_source_plug_id=>wwv_flow_imp.id(105821048515135497)
,p_prompt=>'Commission'
,p_format_mask=>'FML999G999G999G999G990D00'
,p_source=>'COMM'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105825795777135504)
,p_name=>'P104_DEPTNO'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>80
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105823038194135500)
,p_name=>'P104_EMPNO'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105823447949135502)
,p_name=>'P104_ENAME'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105824605157135504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105823784145135503)
,p_name=>'P104_JOB'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105824234131135504)
,p_name=>'P104_MGR'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>40
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20059425620271433)
,p_name=>'P104_REQ_LC'
,p_item_sequence=>20
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105824967529135504)
,p_name=>'P104_SAL'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(105821048515135497)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(20059193072271431)
,p_computation_sequence=>10
,p_computation_item=>'P104_REQ_LC'
,p_static_id=>'p104-req-lc'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103320269046142608)
,p_name=>'Cancel Dialog'
,p_static_id=>'cancel-dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(103318087024142607)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103320777237142608)
,p_event_id=>wwv_flow_imp.id(103320269046142608)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103319843908142608)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103316931502142607)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(105821048515135497)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103317387595142607)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(105821048515135497)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105594040191993637)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105586973987959950)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(98081494948012773)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2069471208528591807
,p_landmark_type=>'navigation'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103010606213842150)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105594040191993637)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103010138026842149)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105594040191993637)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105261314097711407)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105592570301121814)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20197970375503211)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(19264864516627805)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(19264765765627804)
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19263936333627796)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264676683627803)
,p_db_column_name=>'DEPTNO'
,p_display_order=>10
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264550770627802)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264327059627800)
,p_db_column_name=>'EMPNO'
,p_display_order=>40
,p_column_identifier=>'D'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264190681627798)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264297037627799)
,p_db_column_name=>'ENAME'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264053252627797)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(19264484811627801)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(20182899051118878)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(20217792178324797)
,p_report_id=>wwv_flow_imp.id(20182899051118878)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(20218256947324798)
,p_report_id=>wwv_flow_imp.id(20182899051118878)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103017915687003999)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105261314097711407)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103017442470003999)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105261314097711407)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106454009181079776)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(19263725616627794)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(19263712765627793)
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197217899503203)
,p_db_column_name=>'COMM'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Commission'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197476524503206)
,p_db_column_name=>'DEPTNO'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197351775503204)
,p_db_column_name=>'EMPNO'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Employee ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197462878503205)
,p_db_column_name=>'ENAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197746034503208)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197604633503207)
,p_db_column_name=>'HIREDATE'
,p_display_order=>80
,p_column_identifier=>'H'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20196897441503200)
,p_db_column_name=>'JOB'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Job'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20196991158503201)
,p_db_column_name=>'MGR'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Manager'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20197067214503202)
,p_db_column_name=>'SAL'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Salary'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(20207550966504527)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(19531394664744548)
,p_report_id=>wwv_flow_imp.id(20207550966504527)
,p_static_id=>'ir-condition'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106403605553862632)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102116934022178334)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(106454009181079776)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102116910577178333)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(106454009181079776)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105635269486143562)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105622282178781143)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(98383776287622275)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2069471208528591807
,p_landmark_type=>'navigation'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103045323820663352)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105635269486143562)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103044830301663352)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105635269486143562)
,p_button_name=>'previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105603020127074600)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105630155593814456)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105603685842074603)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(105603808855074603)
,p_no_data_found_message=>'No data found.'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105606970460074607)
,p_db_column_name=>'COMM'
,p_display_order=>26
,p_column_identifier=>'G'
,p_column_label=>'Commission'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105607362829074607)
,p_db_column_name=>'DEPTNO'
,p_display_order=>36
,p_column_identifier=>'H'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105604577640074606)
,p_db_column_name=>'EMPNO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Empno'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105604939620074606)
,p_db_column_name=>'ENAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105606141206074607)
,p_db_column_name=>'HIREDATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Hiredate'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105605343260074607)
,p_db_column_name=>'JOB'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Job'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105605702647074607)
,p_db_column_name=>'MGR'
,p_display_order=>16
,p_column_identifier=>'D'
,p_column_label=>'Manager'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(105606527394074607)
,p_db_column_name=>'SAL'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Salary'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(105609434478091326)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103050934513696636)
,p_page_id=>301
,p_web_src_param_id=>wwv_flow_imp.id(100456078462896034)
,p_page_plug_id=>wwv_flow_imp.id(105603685842074603)
,p_value_type=>'NULL'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103055212736696643)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105603020127074600)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103054746578696643)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105603020127074600)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105617815629161084)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105637459436862794)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103804570932251019)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(103804633542251020)
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103805296579251026)
,p_db_column_name=>'BONUS'
,p_display_order=>70
,p_column_identifier=>'F'
,p_column_label=>'Bonus'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103804949068251023)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103804816603251021)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103805031124251024)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103805164115251025)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103804881945251022)
,p_db_column_name=>'SAL'
,p_display_order=>30
,p_column_identifier=>'B'
,p_column_label=>'Salary'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103805391284251027)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(103832894766275892)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103061321158744975)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(105617815629161084)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103060896897744974)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105617815629161084)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105626029333172673)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105643640063872153)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106705727704905158)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(106705870519905159)
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706578125905166)
,p_db_column_name=>'COMM'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Commission'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706653631905167)
,p_db_column_name=>'DEPTNO'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106705959098905160)
,p_db_column_name=>'EMPNO'
,p_display_order=>10
,p_is_primary_key=>'Y'
,p_column_identifier=>'A'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706036526905161)
,p_db_column_name=>'ENAME'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706358138905164)
,p_db_column_name=>'HIREDATE'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Hiredate'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706148313905162)
,p_db_column_name=>'JOB'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Job'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107625417723932979)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706288857905163)
,p_db_column_name=>'MGR'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Manager'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107625351279932978)
,p_db_column_name=>'RN'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Rn'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106706470150905165)
,p_db_column_name=>'SAL'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Salary'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(106975195228570990)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103066337550754341)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(106705727704905158)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103065582399754340)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105626029333172673)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103065213753754340)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105626029333172673)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103071673524754344)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Enable Debug Process'
,p_static_id=>'enable-debug-process'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103066337550754341)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105637460144183833)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107282539725773933)
,p_plug_name=>'Movies'
,p_static_id=>'movies'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(103075670053763124)
,p_region_id=>wwv_flow_imp.id(107282539725773933)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105655087564880947)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109357726477679825)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103077759109763125)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105637460144183833)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103077347971763125)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105637460144183833)
,p_button_name=>'Previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103076616595763125)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(109357726477679825)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105644966037195536)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107289797528781526)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(103081408468770701)
,p_region_id=>wwv_flow_imp.id(107289797528781526)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(103081865890770702)
,p_chart_id=>wwv_flow_imp.id(103081408468770701)
,p_static_id=>'series'
,p_seq=>10
,p_name=>'Series'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107290319854781531)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107288393673781512)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(103084458099770704)
,p_region_id=>wwv_flow_imp.id(107288393673781512)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(103086145328770705)
,p_chart_id=>wwv_flow_imp.id(103084458099770704)
,p_static_id=>'series'
,p_seq=>10
,p_name=>'Series'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(103084949782770704)
,p_chart_id=>wwv_flow_imp.id(103084458099770704)
,p_static_id=>'x'
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(103085587048770705)
,p_chart_id=>wwv_flow_imp.id(103084458099770704)
,p_static_id=>'y'
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103083633407770704)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105644966037195536)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103083261325770704)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105644966037195536)
,p_button_name=>'previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105720874110516550)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105723338894516561)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105721690737516556)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
,p_filtered_region_id=>wwv_flow_imp.id(105721607045516556)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(107309486304791435)
,p_name=>'P306_COMM'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(105721690737516556)
,p_prompt=>'Commission'
,p_source=>'COMM'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105728931712516566)
,p_name=>'P306_JOB'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(105721690737516556)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106745468450931467)
,p_name=>'P306_SAL'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(105721690737516556)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105728120043516564)
,p_name=>'P306_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(105721690737516556)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(105721607045516556)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103101085486780628)
,p_query_column_id=>7
,p_column_alias=>'COMM'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103101486684780628)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103098636523780627)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103099033501780627)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103100288069780627)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103099440374780627)
,p_query_column_id=>3
,p_column_alias=>'JOB'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103099863826780627)
,p_query_column_id=>4
,p_column_alias=>'MGR'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103100697483780627)
,p_query_column_id=>6
,p_column_alias=>'SAL'
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103098270176780626)
,p_page_id=>306
,p_web_src_param_id=>wwv_flow_imp.id(100456078462896034)
,p_page_plug_id=>wwv_flow_imp.id(105721607045516556)
,p_value_type=>'NULL'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117197022178336)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105720874110516550)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117078962178335)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105720874110516550)
,p_button_name=>'previous'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103097353503780625)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105723338894516561)
,p_button_name=>'RESET'
,p_static_id=>'reset'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105746449865580249)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106757145328955001)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20061178655271451)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(20061128858271450)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20060620792271445)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20060496547271444)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20060672050271446)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20061028773271449)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20060937585271448)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(20120671890299003)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105747143991580253)
...
wwv_flow_imp_page.create_map_region(
 p_id=>wwv_flow_imp.id(103115279996804163)
,p_region_id=>wwv_flow_imp.id(105747143991580253)
,p_height=>640
...
wwv_flow_imp_page.create_map_region_layer(
 p_id=>wwv_flow_imp.id(103115734060804164)
,p_map_region_id=>wwv_flow_imp.id(103115279996804163)
,p_name=>'Stores'
,p_static_id=>'stores'
,p_layer_type=>'POINT'
,p_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117401933178338)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105746449865580249)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117267645178337)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105746449865580249)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105754437135623506)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108125250660224652)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105755193332623506)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117545908178340)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105754437135623506)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117479231178339)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105754437135623506)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105714859250018718)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(98086748451087905)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2069471208528591807
,p_landmark_type=>'navigation'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105725570420282926)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103138343344900917)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(105725570420282926)
,p_button_name=>'Next'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103137993359900917)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(105725570420282926)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(20198948847503220)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103156951613549388)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103499789683486215)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103499877206486216)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(103499938587486217)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500127769486219)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103501146036486229)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500560467486223)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500088753486218)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103501344656486231)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103501301344486230)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500445023486222)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500709429486224)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500916315486226)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500926001486227)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500288370486220)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500371147486221)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103501036460486228)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(103500807877486225)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(103534115814123559)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(104563424013433741)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(104563451434433742)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(104563424013433741)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117847654178343)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(103156951613549388)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117759910178342)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103156951613549388)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20198994099503221)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(20198948847503220)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103501582006486233)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103499877206486216)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(104563284647433740)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Create Table Synchronization definiton'
,p_static_id=>'create-table-synchronization-definiton'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(104563451434433742)
,p_process_success_message=>'Table created successfully.'
,p_internal_uid=>8731459953172133
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103501672282486234)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Trigger Synchronization'
,p_static_id=>'trigger-synchronization'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103501582006486233)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107060923921654264)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(107715680883752171)
,p_plug_name=>'Employees Data'
,p_static_id=>'employees-data'
,p_region_name=>'empIR'
,p_region_template_options=>'#DEFAULT#:t-IRR-region--hideHeader js-addHiddenHeadingRoleDesc'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(107715796179752172)
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107716181188752176)
,p_db_column_name=>'COMM'
,p_display_order=>60
,p_column_identifier=>'D'
,p_column_label=>'Commission'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107716502775752179)
,p_db_column_name=>'DEPTNO'
,p_display_order=>100
,p_column_identifier=>'G'
,p_column_label=>'Department'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107716302984752177)
,p_db_column_name=>'EMPNO'
,p_display_order=>10
,p_column_identifier=>'E'
,p_column_label=>'Employee Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107716411772752178)
,p_db_column_name=>'ENAME'
,p_display_order=>20
,p_column_identifier=>'F'
,p_column_label=>'Employee'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107716588814752180)
,p_db_column_name=>'HIREDATE'
,p_display_order=>90
,p_column_identifier=>'H'
,p_column_label=>'Hiredate'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107715884711752173)
,p_db_column_name=>'JOB'
,p_display_order=>30
,p_column_identifier=>'A'
,p_column_label=>'Job'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107715954425752174)
,p_db_column_name=>'MGR'
,p_display_order=>40
,p_column_identifier=>'B'
,p_column_label=>'Manager'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(107716082913752175)
,p_db_column_name=>'SAL'
,p_display_order=>50
,p_column_identifier=>'C'
,p_column_label=>'Salary'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(107734072521295191)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106798872218724379)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102118083341178345)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(107060923921654264)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102117927378178344)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(107060923921654264)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103162335623573571)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(107715680883752171)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108387349915211801)
,p_name=>'P402_MESSAGE'
,p_item_sequence=>50
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(107832212747865800)
,p_name=>'P402_STATUS'
,p_item_sequence=>60
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103166456711573574)
,p_name=>'Capture Message Value'
,p_static_id=>'capture-message-value'
,p_event_sequence=>30
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103166985245573574)
,p_event_id=>wwv_flow_imp.id(103166456711573574)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'return_item', 'P403_MESSAGE',
  'suppress_change_event', 'N',
  'type', 'DIALOG_RETURN_ITEM')).to_clob
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103164700872573573)
,p_name=>'Capture Status Value '
,p_static_id=>'capture-status-value'
,p_event_sequence=>20
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'document'
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103165216623573573)
,p_event_id=>wwv_flow_imp.id(103164700872573573)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-set-value'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'return_item', 'P403_STATUS',
  'suppress_change_event', 'N',
  'type', 'DIALOG_RETURN_ITEM')).to_clob
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103165601045573573)
,p_name=>'Success Message Display'
,p_static_id=>'success-message-display'
,p_event_sequence=>40
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103166069896573574)
,p_event_id=>wwv_flow_imp.id(103165601045573573)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103805571951251029)
,p_plug_name=>'Button'
,p_static_id=>'button'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2127905476394690047
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103185792447810118)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(103805571951251029)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20199821568503229)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103805571951251029)
,p_button_name=>'Cancel'
,p_static_id=>'cancel'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(107854326845102345)
,p_name=>'P403_MESSAGE'
,p_item_sequence=>60
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108254352551234530)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(107854144229102343)
,p_name=>'P403_STATUS'
,p_item_sequence=>50
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(107637480217961942)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(107637677941961944)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20199948868503230)
,p_name=>'Cancel Dialog'
,p_static_id=>'cancel-dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(20199821568503229)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20200004862503231)
,p_event_id=>wwv_flow_imp.id(20199948868503230)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-dialog-cancel'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103187798930810120)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'type', 'WEB_SOURCE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103185792447810118)
,p_internal_uid=>7355974236548513
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103188290256810120)
,p_page_id=>403
,p_web_src_param_id=>wwv_flow_imp.id(101384271670308340)
,p_page_process_id=>wwv_flow_imp.id(103187798930810120)
,p_value_type=>'ITEM'
,p_value=>'P_DIALOG_EMP_NO'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103188786282810121)
,p_page_id=>403
,p_web_src_param_id=>wwv_flow_imp.id(101386536952335658)
,p_page_process_id=>wwv_flow_imp.id(103187798930810120)
,p_value_type=>'ITEM'
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103189286906810121)
,p_page_id=>403
,p_web_src_param_id=>wwv_flow_imp.id(101384632989314596)
,p_page_process_id=>wwv_flow_imp.id(103187798930810120)
,p_value_type=>'ITEM'
,p_value=>'P_DIALOG_NEW_SALARY'
);
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103189731403810121)
,p_page_id=>403
,p_web_src_param_id=>wwv_flow_imp.id(101386191437334659)
,p_page_process_id=>wwv_flow_imp.id(103187798930810120)
,p_value_type=>'ITEM'
,p_value=>'P403_STATUS'
,p_ignore_output=>false
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103190266981810122)
,p_page_id=>403
,p_web_src_param_id=>wwv_flow_imp.id(101407392091605876)
,p_page_process_id=>wwv_flow_imp.id(103187798930810120)
,p_value_type=>'DEFAULT'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103190667972810122)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'return back'
,p_static_id=>'return-back'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_return', 'P403_STATUS,P403_MESSAGE',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115010208935726120)
,p_plug_name=>'Actions'
,p_static_id=>'actions'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(112759608284856215)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115832637164465535)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(115832724662465536)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115833161536465540)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115833251438465541)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115832840339465537)
,p_db_column_name=>'STORE_ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Store Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115832932101465538)
,p_db_column_name=>'STORE_NAME'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Store Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(115833001181465539)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(115876360920072830)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(113094495949411831)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103177918540795164)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(115010208935726120)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103179766236795166)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(112759608284856215)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103179420242795166)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(112759608284856215)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(115187379825586227)
,p_name=>'P404_EMAIL'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(115010208935726120)
,p_prompt=>'Email'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103183592704795168)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Process_ETL'
,p_static_id=>'process-etl'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103177918540795164)
,p_internal_uid=>7351768010533561
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(19475680083001357)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Truncate Table Before Processing'
,p_static_id=>'truncate-table-before-processing'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108391681421726690)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108468075107534931)
,p_plug_name=>'Number of Line Items per Product in Selected Purchase Order'
,p_static_id=>'number-of-line-items-per-product-in-selected-purchase-order'
...
,p_location=>'WEB_SOURCE'
,p_web_src_module_id=>wwv_flow_imp.id(100992928651159995)
,p_array_column_id=>wwv_flow_imp.id(100985276675159991)
,p_plug_source_type=>'NATIVE_JET_CHART'
,p_ajax_items_to_submit=>'PO_P_NUMBER'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(103248347682896732)
,p_region_id=>wwv_flow_imp.id(108468075107534931)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(103250671107896733)
,p_chart_id=>wwv_flow_imp.id(103248347682896732)
,p_static_id=>'series'
,p_js_static_id=>'chart-region'
,p_seq=>10
,p_name=>'Series'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(103248877374896732)
,p_chart_id=>wwv_flow_imp.id(103248347682896732)
,p_static_id=>'x'
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(103249521346896732)
,p_chart_id=>wwv_flow_imp.id(103248347682896732)
,p_static_id=>'y'
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(103250093604896732)
,p_chart_id=>wwv_flow_imp.id(103248347682896732)
,p_static_id=>'y-2'
,p_axis=>'y2'
,p_is_rendered=>'off'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108468550940534936)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108317511288321162)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(108317601047321163)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(108317817662321165)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(108318021176321167)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(108318160840321168)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(108317707137321164)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(108414785700805523)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102118278474178347)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(108391681421726690)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102118210990178346)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(108391681421726690)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108429309056813473)
,p_name=>'PO_P_NUMBER'
,p_item_sequence=>40
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103258307454896737)
,p_name=>'Set Page Item'
,p_static_id=>'set-page-item'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103258765681896737)
,p_event_id=>wwv_flow_imp.id(103258307454896737)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106064619739857974)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105843146158031403)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106791270356227713)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(106791372628227714)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106791589647227716)
,p_db_column_name=>'ADULT'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Adult'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106792567370227726)
,p_db_column_name=>'BACKDROP_PATH'
,p_display_order=>120
,p_column_identifier=>'L'
,p_column_label=>'Backdrop Path'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(20198290469503214)
,p_db_column_name=>'GENRE_IDS'
,p_display_order=>150
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106791443817227715)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106820188802440378)
,p_db_column_name=>'ORIGINAL_LANGUAGE'
,p_display_order=>140
,p_column_identifier=>'N'
,p_column_label=>'Original Language'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106820067131440377)
,p_db_column_name=>'ORIGINAL_TITLE'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'Original Title'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106791870137227719)
,p_db_column_name=>'OVERVIEW'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Overview'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106792134252227721)
,p_db_column_name=>'POPULARITY'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Popularity'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106792282965227723)
,p_db_column_name=>'POSTER_PATH'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'Poster Path'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106792374086227724)
,p_db_column_name=>'RELEASE_DATE'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'Release Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106791712639227717)
,p_db_column_name=>'TITLE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Title'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106791800334227718)
,p_db_column_name=>'VIDEO'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Video'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106792506380227725)
,p_db_column_name=>'VOTE_AVERAGE'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'Vote Average'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(106792195540227722)
,p_db_column_name=>'VOTE_COUNT'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Vote Count'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(106835671408440737)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_shared.create_web_source_comp_param(
 p_id=>wwv_flow_imp.id(103265198847913582)
,p_page_id=>406
,p_web_src_param_id=>wwv_flow_imp.id(100374336415537532)
,p_page_plug_id=>wwv_flow_imp.id(106791270356227713)
,p_value_type=>'NULL'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108833304466189112)
,p_plug_name=>'Web Credentials Not provided'
,p_static_id=>'web-credentials-not-provided'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--warning'
,p_plug_template=>2042159785845301134
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102118450185178349)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(106064619739857974)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(102118366890178348)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(106064619739857974)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103263495616913579)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(108833304466189112)
,p_button_name=>'Set_API_Key'
,p_static_id=>'set-api-key'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106832215693440429)
,p_name=>'P406_MOVIE'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103543148910989895)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103806199086251035)
,p_plug_name=>'Button'
,p_static_id=>'button'
,p_parent_plug_id=>wwv_flow_imp.id(103548033754368627)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2127905476394690047
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103805883234251032)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103548033754368627)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103548877394368635)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103805793888251031)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(103543148910989895)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103548991035368636)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103548877394368635)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103805631080251030)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103543148910989895)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103548199748368628)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103806199086251035)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103548791038368634)
,p_name=>'P407_PRODUCT_ID'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(103548033754368627)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103548254066368629)
,p_name=>'P407_WF_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(103548033754368627)
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103548421688368630)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WORKFLOW'
,p_process_name=>'Start a new workflow'
,p_static_id=>'start-a-new-workflow'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'return_workflow_id_item', 'P407_WF_ID',
  'type', 'START',
  'workflow_definition_id', wwv_flow_imp.id(103503422233486251))).to_clob
...
wwv_flow_imp_shared.create_workflow_comp_param(
 p_id=>wwv_flow_imp.id(103548476276368631)
,p_page_process_id=>wwv_flow_imp.id(103548421688368630)
,p_workflow_variable_id=>wwv_flow_imp.id(103546324007368609)
,p_page_id=>407
,p_value_type=>'ITEM'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103577924269584868)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103579041888584870)
...
,p_query_order_by=>'{    "orderBys": [        {            "key": "CREATED_ON",            "expr": "created_on desc"        },        {            "key": "LAST_UPDATED_ON",            "expr": "last_updated_on desc"        }    ],    "itemName": "P408_SORT_BY"}'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103590148182584883)
,p_name=>'BADGE_STATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103589634289584882)
,p_name=>'BADGE_TEXT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103588201018584882)
,p_name=>'CREATED_AGO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103588653520584882)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103587659613584881)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103586709662584881)
,p_name=>'INITIATOR'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103589137287584882)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103587195861584881)
,p_name=>'STATE_CODE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103586224661584881)
,p_name=>'TITLE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103585692760584881)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103585203718584880)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103584676042584879)
,p_name=>'WORKFLOW_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(103590666024584883)
,p_region_id=>wwv_flow_imp.id(103579041888584870)
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(103591205428584884)
,p_region_id=>wwv_flow_imp.id(103579041888584870)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103578950073584870)
,p_plug_name=>'My Workflows - Smart Filters'
,p_static_id=>'my-workflows-smart-filters'
,p_parent_plug_id=>wwv_flow_imp.id(103577924269584868)
,p_region_template_options=>'#DEFAULT#'
...
,p_filtered_region_id=>wwv_flow_imp.id(103579041888584870)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'compact_numbers_threshold', '10000',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103580890241584874)
,p_name=>'P408_APPLICATION'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(103578950073584870)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103581650634584874)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103581290622584874)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103579351717584872)
,p_name=>'P408_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(103578950073584870)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103580170685584872)
,p_name=>'P408_STATE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(103578950073584870)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103579796854584872)
,p_name=>'P408_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(103578950073584870)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103806045059251034)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(103577924269584868)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103805936077251033)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103577924269584868)
,p_button_name=>'PREVIOUS'
,p_static_id=>'previous'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103591668519584885)
,p_name=>'P408_SORT_BY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(103579041888584870)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103578607466584868)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103594945951584889)
,p_name=>'Refresh - My Workflows - Report'
,p_static_id=>'refresh-my-workflows-report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(103579041888584870)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosecanceldialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103595349802584889)
,p_event_id=>wwv_flow_imp.id(103594945951584889)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-refresh'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(103579041888584870)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103595890871584889)
,p_event_id=>wwv_flow_imp.id(103594945951584889)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(103578950073584870)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103592097762584886)
,p_name=>'Terminate'
,p_static_id=>'terminate'
,p_event_sequence=>30
,p_triggering_element_type=>'JQUERY_SELECTOR'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103593024387584888)
,p_event_id=>wwv_flow_imp.id(103592097762584886)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P408_WORKFLOW_ID',
  'language', 'PLSQL',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103593472672584888)
,p_event_id=>wwv_flow_imp.id(103592097762584886)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103593971804584888)
,p_event_id=>wwv_flow_imp.id(103592097762584886)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103594471791584889)
,p_event_id=>wwv_flow_imp.id(103592097762584886)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103592479936584887)
,p_event_id=>wwv_flow_imp.id(103592097762584886)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103601717242584894)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103602095368584894)
,p_name=>'ACTIVITY_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103607099670584896)
,p_name=>'BADGE_STATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BADGE_STATE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103606601474584896)
,p_name=>'BADGE_TEXT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BADGE_TEXT'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103604528028584895)
,p_name=>'DUE_ON'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103606114123584896)
,p_name=>'END_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103604120697584895)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103607572585584896)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103603104545584895)
,p_name=>'NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103605047331584895)
,p_name=>'RETRY_COUNT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103605584745584896)
,p_name=>'START_TIME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103603579075584895)
,p_name=>'STATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103602586603584894)
,p_name=>'TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(103608091055584897)
,p_region_id=>wwv_flow_imp.id(103601717242584894)
,p_position_id=>350199314123390058
,p_display_sequence=>10
,p_static_id=>'action'
,p_link_target_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(103608596713584897)
,p_region_id=>wwv_flow_imp.id(103601717242584894)
,p_position_id=>350199314123390058
,p_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103609087592584897)
,p_plug_name=>'Activity Audit'
,p_static_id=>'activity-audit'
,p_parent_plug_id=>wwv_flow_imp.id(103601717242584894)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103610425330584899)
,p_name=>'ACTION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103609466811584898)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103609981205584899)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_ON'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103611002575584899)
,p_name=>'DISPLAY_MSG'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103620760701584903)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103614243942584900)
,p_plug_name=>'Edit Variable'
,p_static_id=>'edit-variable'
,p_parent_plug_id=>wwv_flow_imp.id(103611831549584899)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103618467005584902)
,p_plug_name=>'History'
,p_static_id=>'history'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103619406439584903)
,p_name=>'CREATED_BY'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_BY'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103619885934584903)
,p_name=>'CREATED_ON'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_ON'
,p_data_type=>'DATE'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103618837517584903)
,p_name=>'DISPLAY_MSG'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DISPLAY_MSG'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103617083710584902)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103617942793584902)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103617483190584902)
,p_name=>'LABEL'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103598321525584892)
,p_plug_name=>'Subject'
,p_static_id=>'subject'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103601132642584894)
,p_name=>'BADGE_STATE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BADGE_STATE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103600722507584893)
,p_name=>'BADGE_TEXT'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'BADGE_TEXT'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103600125815584893)
,p_name=>'CREATED_AGO'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'CREATED_AGO'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103599723940584893)
,p_name=>'INITIATOR'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'INITIATOR'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103598695742584893)
,p_name=>'TITLE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'TITLE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103599166312584893)
,p_name=>'WORKFLOW_DEF_NAME'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'WORKFLOW_DEF_NAME'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103611831549584899)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103613272453584900)
,p_name=>'DISPLAY_VALUE'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'DISPLAY_VALUE'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103612748201584900)
,p_name=>'LABEL'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'LABEL'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(103612244599584899)
,p_name=>'STATIC_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_component_action(
 p_id=>wwv_flow_imp.id(103613726706584900)
,p_region_id=>wwv_flow_imp.id(103611831549584899)
,p_position_id=>363792341120765662
,p_display_sequence=>10
,p_template_id=>363792942797796791
,p_label=>'Edit'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103620407719584903)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103621169584584904)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103620760701584903)
,p_button_name=>'CANCEL'
,p_static_id=>'cancel'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103611451093584899)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103609087592584897)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103616314277584901)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103614243942584900)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103622015619584904)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(103620760701584903)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103622750790584904)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(103620760701584903)
,p_button_name=>'RETRY'
,p_static_id=>'retry'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103621598895584904)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103620760701584903)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103622402693584904)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(103620760701584903)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103597835300584891)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103616699493584902)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(103614243942584900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103597107928584890)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103615490647584901)
,p_name=>'P409_CURRENT_VALUE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(103614243942584900)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103615920693584901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103597487412584890)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103614710094584901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103615083427584901)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103596680090584890)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103623180265584905)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103623621290584905)
,p_event_id=>wwv_flow_imp.id(103623180265584905)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(103609087592584897)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103624574697584905)
,p_event_id=>wwv_flow_imp.id(103623180265584905)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103624088857584905)
,p_event_id=>wwv_flow_imp.id(103623180265584905)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103625088239584905)
,p_name=>'Cancel Activity Audit'
,p_static_id=>'cancel-activity-audit'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(103611451093584899)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103625477512584905)
,p_event_id=>wwv_flow_imp.id(103625088239584905)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103630737871584908)
,p_name=>'Cancel Dialog'
,p_static_id=>'cancel-dialog'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(103621169584584904)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103631187218584908)
,p_event_id=>wwv_flow_imp.id(103630737871584908)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-dialog-cancel'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103629361261584907)
,p_name=>'Cancel Edit Variable'
,p_static_id=>'cancel-edit-variable'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(103616314277584901)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103630276659584907)
,p_event_id=>wwv_flow_imp.id(103629361261584907)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_static_id=>'native-close-region'
,p_action=>'NATIVE_CLOSE_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(103614243942584900)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103629809248584907)
,p_event_id=>wwv_flow_imp.id(103629361261584907)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103631706178584908)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103632573540584908)
,p_event_id=>wwv_flow_imp.id(103631706178584908)
...
,p_affected_button_id=>wwv_flow_imp.id(103616699493584902)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103632037116584908)
,p_event_id=>wwv_flow_imp.id(103631706178584908)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103625989933584905)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103626840260584906)
,p_event_id=>wwv_flow_imp.id(103625989933584905)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_static_id=>'native-disable'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103626333350584906)
,p_event_id=>wwv_flow_imp.id(103625989933584905)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103628828265584907)
,p_event_id=>wwv_flow_imp.id(103625989933584905)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103627350910584906)
,p_event_id=>wwv_flow_imp.id(103625989933584905)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103627910853584907)
,p_event_id=>wwv_flow_imp.id(103625989933584905)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103628392762584907)
,p_event_id=>wwv_flow_imp.id(103625989933584905)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103635035029584909)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103633899304584909)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'type', 'RESUME',
  'workflow_id_item', 'P409_WORKFLOW_ID')).to_clob
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103622015619584904)
,p_process_success_message=>'Workflow resumed'
,p_internal_uid=>7802074610323302
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103634718152584909)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WORKFLOW'
...
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103622750790584904)
,p_process_success_message=>'Workflow retried'
,p_internal_uid=>7802893458323302
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103633450069584909)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WORKFLOW'
...
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103621598895584904)
,p_process_success_message=>'Workflow suspended'
,p_internal_uid=>7801625375323302
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103634305954584909)
...
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103622402693584904)
,p_process_success_message=>'Workflow terminated'
,p_internal_uid=>7802481260323302
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103633118995584908)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103616699493584902)
...
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_imp.id(98044647899572005)
,p_step_template=>4073832297226169690
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_imp.id(98044374387572004)
,p_protection_level=>'C'
,p_deep_linking=>'N'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105512626424322951)
,p_plug_name=>'Administration Settings'
,p_static_id=>'administration-settings'
,p_parent_plug_id=>wwv_flow_imp.id(105512200375322951)
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(98064882505572049)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2069471208528591807
,p_required_patch=>wwv_flow_imp.id(98043638650572003)
,p_landmark_type=>'navigation'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105510808027322949)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105512200375322951)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103285098468030420)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(105503710145340838)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103283575665030418)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103285098468030420)
,p_button_name=>'Save'
,p_static_id=>'save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(103287697431030423)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(105508636759340843)
,p_name=>'P501_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(105503710145340838)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103285899711030422)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106504064693082017)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106526669073842184)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103290540620048883)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(106504064693082017)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(103292379905048885)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103291906701048884)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103290540620048883)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106933544255217879)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106857353990604690)
,p_plug_name=>'Overview'
,p_static_id=>'overview'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(106857426708604691)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103296808768077845)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(106933544255217879)
,p_button_name=>'Save'
,p_static_id=>'save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(103299525721077846)
,p_branch_name=>'goback'
,p_branch_action=>'f?p=&APP_ID.:&P304_SOURCE.:&SESSION.:&SESSION.:&DEBUG.:&DEBUG.::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(103296808768077845)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103805494919251028)
,p_name=>'P304_SOURCE'
,p_item_sequence=>30
,p_item_default=>'500'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106937086116228648)
,p_name=>'P3_API_KEY'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(106857426708604691)
,p_prompt=>'API Key'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106937054101228647)
,p_name=>'P3_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(106857426708604691)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103299086636077846)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Mark As Provided'
,p_static_id=>'mark-as-provided'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103296808768077845)
,p_internal_uid=>7467261941816239
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103298678248077846)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Set Web Credentials'
,p_static_id=>'set-web-credentials'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108914707705712395)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(109584178188015294)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(104563622687433743)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(104563636515433744)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108869159460374099)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103304048590098596)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(108914707705712395)
,p_button_name=>'Save'
,p_static_id=>'save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(103305865647098597)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108869762167374101)
,p_name=>'P504_BASE_URL'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(108869159460374099)
,p_prompt=>'Base URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(104563750386433745)
,p_name=>'P504_ODATA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(104563622687433743)
,p_item_default=>'apex_app_setting.get_value(p_name =>''ODATA_URL'')'
,p_item_default_type=>'EXPRESSION'
,p_item_default_language=>'PLSQL'
,p_prompt=>'OData Endpoint URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(104563917814433746)
,p_name=>'P504_PROXY_SERVER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(104563636515433744)
,p_prompt=>'Proxy Server'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>80
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(108873122622374134)
,p_name=>'P504_SCHEMA'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(108869159460374099)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103304925129098597)
,p_process_sequence=>10
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Set Remote Server'
,p_static_id=>'set-remote-server'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    ',
'begin ',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(103304048590098596)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108894977959506855)
,p_plug_name=>'About this application'
,p_static_id=>'about-this-application'
,p_parent_plug_id=>wwv_flow_imp.id(108894812564506854)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4502917002193490937
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(108895212854506858)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103325118719231314)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103324301572231314)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(103324636807231314)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108895140741506857)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108894812564506854)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(108895088138506856)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(98045231568572010)
,p_plug_name=>'Sample REST Services'
,p_static_id=>'sample-rest-services'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(98046929918572017)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(98045231568572010)
,p_button_name=>'LOGIN'
,p_static_id=>'login'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98046189850572016)
,p_name=>'P9999_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(98045231568572010)
,p_prompt=>'Password'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98046564975572016)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98045800931572015)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(98051098898572020)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(98050631647572019)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(98047244576572017)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(98048279384572019)
,p_page_process_id=>wwv_flow_imp.id(98047244576572017)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(98048784027572019)
,p_page_process_id=>wwv_flow_imp.id(98047244576572017)
,p_page_id=>9999
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(98047774740572018)
,p_page_process_id=>wwv_flow_imp.id(98047244576572017)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(98049141973572019)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(98050214012572019)
,p_page_process_id=>wwv_flow_imp.id(98049141973572019)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
,p_data_type=>'BOOLEAN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(98049636479572019)
,p_page_process_id=>wwv_flow_imp.id(98049141973572019)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(98147010612807695)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(104906539661500975)
,p_install_id=>wwv_flow_imp.id(98147010612807695)
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(104906660828500978)
,p_script_id=>wwv_flow_imp.id(104906539661500975)
...
'/ ';
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(20673846164919857)
,p_install_id=>wwv_flow_imp.id(98147010612807695)
,p_name=>'ETLProcess'
,p_sequence=>130
,p_script_type=>'INSTALL'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(20673946155919862)
,p_script_id=>wwv_flow_imp.id(20673846164919857)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
'';
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(101442072797479269)
,p_install_id=>wwv_flow_imp.id(98147010612807695)
...
'';
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(102299258363082584)
,p_install_id=>wwv_flow_imp.id(98147010612807695)
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102299373131082586)
,p_script_id=>wwv_flow_imp.id(102299258363082584)
,p_object_owner=>'#OWNER#'
...
'end;';
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(102335663679777708)
,p_install_id=>wwv_flow_imp.id(98147010612807695)
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102335753859777708)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
,p_object_name=>'EBA_DEMO_REST_ASSIGNEES'
);
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102335989122777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102336158378777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102336424128777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102336611742777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102336816732777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102336957367777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102337176119777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102337331865777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102337613935777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102338018171777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102338130202777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102338387384777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102338568727777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(102338741584777709)
,p_script_id=>wwv_flow_imp.id(102335663679777708)
,p_object_owner=>'#OWNER#'
,p_object_type=>'TABLE'
