...
,p_default_id_offset=>8712768845312800
,p_default_owner=>'APEXPDB'
);
end;
/
 
prompt APPLICATION 311 - Sample Vector Search
--
-- Application Export:
--   Application:     311
--   Name:            Sample Vector Search
--   Date and Time:   13:00 Monday July 27, 2026
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'SAMPLE-VECTOR-SEARCH109311')
...
,p_authentication_id=>wwv_flow_imp.id(47167319243843845)
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(65533574589837171)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(65534410370837201)
...
begin
wwv_imp_workspace.create_credential(
 p_id=>33742198086384517
,p_name=>'OpenAI Credentials'
,p_static_id=>'EBA_CREDENTIALS_OPENAI'
,p_authentication_type=>'HTTP_HEADER'
,p_prompt_on_install=>false
,p_updated_on=>wwv_flow_imp.dz('20260519130611Z')
,p_updated_by=>'GONZALEZFJU'
);
end;
/
prompt --workspace/credentials/keycloak_creds
begin
wwv_imp_workspace.create_credential(
 p_id=>27330405049034077
,p_name=>'Keycloak_Creds'
,p_static_id=>'KEYCLOAK_CREDS'
,p_authentication_type=>'OAUTH2_CLIENT_CREDENTIALS'
,p_valid_for_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
'http://10.0.2.218:8080/',
''))
,p_prompt_on_install=>true
,p_oauth_token_request_type=>'BASIC'
,p_updated_on=>wwv_flow_imp.dz('20260521143503Z')
,p_updated_by=>'GONZALEZFJU'
);
end;
/
...
,p_credential_id=>33741620262359595
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>33742437120384517
,p_name=>'OpenAI GenAI Service'
,p_static_id=>'EBA_GENAI_OPENAI'
,p_base_url=>nvl(wwv_flow_application_install.get_remote_server_base_url('EBA_GENAI_OPENAI'),'https://generativelanguage.googleapis.com/v1beta/openai')
,p_https_host=>nvl(wwv_flow_application_install.get_remote_server_https_host('EBA_GENAI_OPENAI'),'')
,p_server_type=>'GENERATIVE_AI'
,p_credential_id=>33742198086384517
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65530054961837165)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>'50290795'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65528831034837165)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65530386937837166)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65530622351837166)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65528561401837165)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65532181370837166)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65529177159837165)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65529443847837165)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65531866876837166)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65529797147837165)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65528293859837163)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65530960364837166)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65531578221837166)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>'50290795'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(65531272253837166)
,p_plugin_type=>'WEB SOURCE TYPE'
...
/
prompt --application/shared_components/ai_agent/oci
begin
wwv_flow_imp_shared.create_ai_agent(
 p_id=>wwv_flow_imp.id(71252295559370935)
,p_name=>'OCI'
,p_static_id=>'oci'
,p_remote_server_id=>33741858505359600
,p_version_scn=>'160025741'
);
end;
/
prompt --application/shared_components/ai_agent/openai
begin
wwv_flow_imp_shared.create_ai_agent(
 p_id=>wwv_flow_imp.id(71252043008369821)
,p_name=>'OPENAI'
,p_static_id=>'openai'
,p_remote_server_id=>33742437120384517
,p_version_scn=>'160025597'
,p_agent_comment=>'Not used in the application, but needed to connect the application to the AI Service.'
);
end;
/
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(65850476759035031)
,p_name=>'Administration'
,p_static_id=>'administration'
,p_version_scn=>'124380376'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65851076968035033)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65850697224035032)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(70626317338460313)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(53155456779941579)
,p_name=>'AI Generated Data Progress'
,p_static_id=>'ai-generated-data-progress'
,p_version_scn=>'124383924'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53815259304523520)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53155610666941583)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Enter Prompt'
,p_static_id=>'enter-prompt'
,p_list_item_link_target=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.::::'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53156436919941584)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53156014757941584)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Preview and Upload Data'
,p_static_id=>'preview-and-upload-data'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53631285739816978)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53811540929427901)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53811259859420081)
,p_list_item_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(71114779569713889)
,p_name=>'Home Page List'
,p_static_id=>'home-page-list'
,p_version_scn=>'126221802'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(71116111794713891)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(71115757398713891)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Custom Data'
,p_static_id=>'custom-data'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(71115331336713891)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Movie Data'
,p_static_id=>'movie-data'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53813599103479000)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53813256343474510)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53527956572357679)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Prepare Data'
,p_static_id=>'prepare-data'
,p_list_item_link_target=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53812909790460793)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Vector and Oracle Text'
,p_static_id=>'vector-and-oracle-text'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53812664543456781)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Vector vs. Oracle Text'
,p_static_id=>'vector-vs-oracle-text'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(65534410370837201)
,p_name=>'Navigation Bar'
,p_static_id=>'navigation-bar'
,p_version_scn=>'50291004'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65546533037837264)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65547011231837265)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'---'
,p_static_id=>'list_item'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(65546533037837264)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65547487843837265)
,p_list_item_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(65533574589837171)
,p_name=>'Navigation Menu'
,p_static_id=>'navigation-menu'
,p_version_scn=>'124400979'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65821759977145098)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(66446155215606110)
,p_list_item_display_sequence=>170
,p_list_item_link_text=>'Application Theme Style'
,p_static_id=>'application-theme-style'
,p_list_item_link_target=>'f?p=&APP_ID.:52:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-design'
,p_parent_list_item_id=>wwv_flow_imp.id(65821759977145098)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53598765393789073)
...
,p_list_item_disp_cond_type=>'EXISTS'
,p_list_item_disp_condition=>'select 1 from EBA_VECTOR_MOVIEDATA where embedding_vector is not null'
,p_parent_list_item_id=>wwv_flow_imp.id(53525666822281326)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'15'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53620997256607415)
...
,p_list_item_disp_cond_type=>'EXISTS'
,p_list_item_disp_condition=>'select 1 from EBA_VECTOR_DATATABLE where embedding_vector is not null'
,p_parent_list_item_id=>wwv_flow_imp.id(53526186863293748)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'31'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53526186863293748)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65545029950837245)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53630035652791685)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53525666822281326)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53629748274788811)
,p_list_item_display_sequence=>300
,p_list_item_link_text=>'Movie Recommendations'
,p_static_id=>'movie-recommendations'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53595403075700633)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53620253635563146)
,p_list_item_display_sequence=>250
,p_list_item_link_text=>'Prepare Data'
,p_static_id=>'prepare-data-2'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(66426280426481878)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(70436791845937525)
,p_list_item_display_sequence=>150
,p_list_item_link_text=>'Set AI Provider'
,p_static_id=>'set-ai-provider'
,p_list_item_link_target=>'f?p=&APP_ID.:54:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53599398149797824)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53621576162629380)
,p_list_item_display_sequence=>290
,p_list_item_link_text=>'Vector and Oracle Text'
,p_static_id=>'vector-and-oracle-text-2'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53599009510794151)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53621267072614213)
,p_list_item_display_sequence=>280
,p_list_item_link_text=>'Vector vs. Oracle Text'
,p_static_id=>'vector-vs-oracle-text-2'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53159130077989524)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Generate Vector Embeddings'
,p_static_id=>'generate-vector-embeddings'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53158732071989524)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53158369707989524)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53626152148699309)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Vector and Oracle Text'
,p_static_id=>'vector-and-oracle-text'
,p_list_item_link_target=>'f?p=&APP_ID.:33:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(53625791043699309)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Vector vs. Oracle Text'
,p_static_id=>'vector-vs-oracle-text'
,p_list_item_link_target=>'f?p=&APP_ID.:32:&SESSION.::&DEBUG.::::'
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(65855718355070318)
,p_name=>'Vector Search (Movie Data)'
,p_static_id=>'vector-search-movie-data'
,p_version_scn=>'115119551'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65855930992070318)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Basic Vector Search'
,p_static_id=>'basic-vector-search'
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65856773178070319)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'Vector and Oracle Text'
,p_static_id=>'vector-and-oracle-text'
,p_list_item_link_target=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(65856395659070319)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Vector vs. Oracle Text'
,p_static_id=>'vector-vs-oracle-text'
,p_list_item_link_target=>'f?p=&APP_ID.:16:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(60701799944842811)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(65535885308837213)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(65536144245837213)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(65536500490837214)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(65535575683837211)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(65536765843837214)
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(65538096741837215)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(67012455317109331)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(60927048499967748)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(71125904253965462)
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(67013028350119086)
,p_computation_sequence=>10
,p_computation_item=>'CURRENT_AI_PROVIDER'
,p_static_id=>'current-ai-provider'
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(60927372171983389)
,p_computation_sequence=>10
,p_computation_item=>'INITIALIZED_AI_PROVIDER'
,p_static_id=>'initialized-ai-provider'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'EXPRESSION'
,p_computation_language=>'PLSQL'
,p_computation_processed=>'REPLACE_EXISTING'
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(71126841845998501)
,p_computation_sequence=>10
,p_computation_item=>'WEB_CREDENTIALS_ENTERED'
,p_static_id=>'web-credentials-entered'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'EXPRESSION'
,p_computation_language=>'PLSQL'
,p_computation_processed=>'REPLACE_EXISTING'
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(66605256261643853)
,p_name=>'AI_PROVIDER'
,p_value=>'OCI'
,p_is_required=>'N'
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(60927726179996079)
...
wwv_flow_imp_shared.create_app_setting(
 p_id=>wwv_flow_imp.id(71126243881981237)
,p_name=>'WC_STATUS'
,p_value=>'VOID'
,p_is_required=>'N'
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(65538388752837217)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(65533078756837169)
,p_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(65822664141145099)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(66439102936508789)
,p_parent_id=>wwv_flow_imp.id(65822664141145099)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53635273242907741)
,p_parent_id=>wwv_flow_imp.id(53641812130101583)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53636904924932105)
,p_parent_id=>wwv_flow_imp.id(53636652551927927)
,p_short_name=>'Basic Vector Search'
,p_static_id=>'basic-vector-search-2'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53636407254923842)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(65533301244837169)
,p_short_name=>'Home'
,p_static_id=>'home'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(65821318985138167)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(65820059831134476)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53527076996323437)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(66058498142577078)
,p_parent_id=>wwv_flow_imp.id(65822664141145099)
,p_option_sequence=>5
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(54154380934600345)
,p_parent_id=>wwv_flow_imp.id(65822664141145099)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53637272989943975)
,p_parent_id=>wwv_flow_imp.id(53636652551927927)
,p_option_sequence=>40
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53635930172911545)
,p_parent_id=>wwv_flow_imp.id(53641812130101583)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53636652551927927)
,p_parent_id=>wwv_flow_imp.id(53636407254923842)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53641812130101583)
,p_parent_id=>wwv_flow_imp.id(53527076996323437)
,p_short_name=>'Vector Search'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53637102499941777)
,p_parent_id=>wwv_flow_imp.id(53636652551927927)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(53635786683909899)
,p_parent_id=>wwv_flow_imp.id(53641812130101583)
,p_option_sequence=>30
,p_short_name=>'Vector vs. Oracle Text Search'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(65533970791837173)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(65532460450837167)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(63990302249298069)
...
/
prompt --application/shared_components/security/authentications/keycloak_sso
begin
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(47167319243843845)
,p_name=>'Keycloak SSO'
,p_static_id=>'keycloak-sso'
,p_scheme_type=>'NATIVE_SOCIAL'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'authentication_provider', 'OPENID_CONNECT',
  'credential_store', 27330405049034077,
  'discovery_url', 'http://10.0.2.218:8080/realms/master/.well-known/openid-configuration',
  'scope', 'openid profile email',
  'uppercase_username', 'N',
  'username', '#preferred_username#',
  'verify_attributes', 'Y')).to_clob
,p_invalid_session_type=>'LOGIN'
,p_use_secure_cookie_yn=>'N'
,p_ras_mode=>0
,p_version_scn=>'181704139'
,p_created_on=>wwv_flow_imp.dz('20260519121748Z')
,p_updated_on=>wwv_flow_imp.dz('20260519121748Z')
,p_created_by=>'APEX_260100'
,p_updated_by=>'APEX_260100'
);
end;
/
...
begin
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(65532782753837167)
...
,p_ras_mode=>0
,p_version_scn=>'50290795'
,p_created_on=>wwv_flow_imp.dz('20260519121749Z')
,p_updated_on=>wwv_flow_imp.dz('20260519121749Z')
,p_created_by=>'APEX_260100'
,p_updated_by=>'APEX_260100'
);
end;
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(65830157951795438)
,p_name=>'GenAI CSV Load'
,p_static_id=>'genai_csv_load'
,p_target_type=>'TABLE'
,p_table_name=>'EBA_VECTOR_MOVIEDATA'
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'GenAI CSV Load'
,p_format=>'CSV'
,p_encoding=>'utf-8'
,p_csv_enclosed=>'"'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65828267495795436)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'ACTORS'
,p_static_id=>'actors'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65829801597795437)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'EMBEDDING_VECTOR'
,p_static_id=>'embedding-vector'
,p_sequence=>18
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65828583414795436)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'GENRE'
,p_static_id=>'genre'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65827955561795436)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'MOVIEDESCRIPTION'
,p_static_id=>'moviedescription'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'CLOB'
,p_selector_type=>'NAME'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65829488726795437)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'RATING'
,p_static_id=>'rating'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65829194856795437)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'RELEASE_DATE'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65827613497795435)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'TITLE'
,p_static_id=>'title'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65828905415795437)
,p_data_profile_id=>wwv_flow_imp.id(65827586098795429)
,p_name=>'VOTES'
,p_static_id=>'votes'
,p_sequence=>6
...
begin
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(65836723645795442)
,p_name=>'Manual CSV Load'
,p_static_id=>'manual_csv_load'
,p_target_type=>'TABLE'
,p_table_name=>'EBA_VECTOR_DATATABLE'
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'Manual CSV Load'
,p_format=>'CSV'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65833400735795440)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL1'
,p_static_id=>'col'
,p_sequence=>2
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65836084720795442)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL10'
,p_static_id=>'col-10'
,p_sequence=>11
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65833662597795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL2'
,p_static_id=>'col-2'
,p_sequence=>3
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65834004690795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL3'
,p_static_id=>'col-3'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65834224599795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL4'
,p_static_id=>'col-4'
,p_sequence=>5
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65834585033795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL5'
,p_static_id=>'col-5'
,p_sequence=>6
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65834842328795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL6'
,p_static_id=>'col-6'
,p_sequence=>7
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65835161090795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL7'
,p_static_id=>'col-7'
,p_sequence=>8
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65835454758795441)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL8'
,p_static_id=>'col-8'
,p_sequence=>9
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65835748722795442)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'COL9'
,p_static_id=>'col-9'
,p_sequence=>10
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(65836407202795442)
,p_data_profile_id=>wwv_flow_imp.id(65833304697795440)
,p_name=>'EMBEDDING_VECTOR'
,p_static_id=>'embedding-vector'
,p_sequence=>21
...
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(65845958309939837)
...
,p_vector_provider_id=>35144204792434793
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(65844066051923993)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(65842357635845596)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(71169285684818165)
...
,p_query_table=>'EBA_VECTOR_DATATABLE'
,p_oratext_index_column_name=>'EMBEDDING_VECTOR'
,p_vector_provider_id=>34770494478360867
,p_vector_search_type=>'EXACT'
,p_vector_distance_metric=>'DOT'
,p_return_max_results=>10
,p_pk_column_name=>'ID'
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(71169647413821391)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(71168614192809868)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(65843533336906768)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(65843083780882145)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(53669905314501992)
...
begin
wwv_flow_imp_shared.create_search_config(
 p_id=>wwv_flow_imp.id(53672065833590994)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70804825279486337)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65545984610837251)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70805423984486343)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(71114779569713889)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(60735863603983711)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(53526595952323433)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_menu_id=>wwv_flow_imp.id(65533078756837169)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77059738794534932)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(53527730424357679)
,p_plug_source_type=>'NATIVE_LIST'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77062400201599178)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77061719075599171)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(61246974851167255)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(53155456779941579)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2010149141494510257
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53532902615432238)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(77062400201599178)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(53534667279432252)
,p_branch_name=>'Go To Data Preview'
,p_branch_action=>'f?p=&APP_ID.:12:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(53532902615432238)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73629845927752049)
,p_name=>'P11_EXE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(77061719075599171)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(77062888086599191)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53159102293593221)
,p_validation_name=>'P11_PROMPT_INPUT not null'
,p_static_id=>'p11-prompt-input-not-null'
,p_validation_sequence=>10
,p_validation=>'P11_PROMPT_INPUT'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(53532902615432238)
,p_associated_item=>wwv_flow_imp.id(77062888086599191)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53533482377432247)
,p_process_sequence=>20
,p_parent_process_id=>wwv_flow_imp.id(53533818743432250)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53533818743432250)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
,p_process_name=>'Generate Sample Data'
,p_static_id=>'generate-sample-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'executions_limit', '1',
  'return_id_into_item', 'P11_EXE_ID',
  'run_in_background', 'Y',
  'serialize', 'N',
  'submit_immediately', 'N',
  'temporary_file_handling', 'IGNORE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(53532902615432238)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79778777473777280)
,p_plug_name=>'Button Bar'
,p_static_id=>'button-bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(71603615245202045)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79778713439777279)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73633429156756770)
,p_plug_name=>'Generating Data...'
,p_static_id=>'generating-data'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72137531596339260)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53538875364436962)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(79778777473777280)
,p_button_name=>'PREV'
,p_static_id=>'prev'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53538419774436962)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(53548544830436973)
,p_branch_name=>'Go To Vector Generation'
,p_branch_action=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:11,12::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(53538419774436962)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(79782690107777292)
,p_name=>'P12_AI_OUTPUT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(79778713439777279)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73635767736756779)
,p_name=>'P12_SOFAR'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(79778713439777279)
,p_item_default=>'-1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(73635833177756780)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(53541212473436965)
,p_name=>'Generation Running Update'
,p_static_id=>'generation-running-update'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53541735061436967)
,p_event_id=>wwv_flow_imp.id(53541212473436965)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_name=>'Get Execution Progress'
,p_static_id=>'get-execution-progress'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53542289516436968)
,p_event_id=>wwv_flow_imp.id(53541212473436965)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_name=>'Show Execution Progress'
,p_static_id=>'show-execution-progress'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', '$("#status").text( apex.lang.formatMessage( "EBA_VECTOR.STATUS_UPDATE_AI_GENERATION", $v("P12_SOFAR"), $v("P12_TOTALWORK") ) );')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53542785567436969)
,p_event_id=>wwv_flow_imp.id(53541212473436965)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'N'
,p_name=>'Trigger "Finished" When All Done'
,p_static_id=>'trigger-finished-when-all-done'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'apex.event.trigger( document, "generationFinished" )')).to_clob
,p_client_condition_type=>'JAVASCRIPT_EXPRESSION'
,p_client_condition_expression=>'$v("P12_SOFAR") === $v("P12_TOTALWORK")'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(53545072427436971)
,p_name=>'Toggle Generation Finished Indicator'
,p_static_id=>'toggle-generation-finished-indicator'
,p_event_sequence=>40
,p_triggering_element_type=>'JAVASCRIPT_EXPRESSION'
,p_triggering_element=>'document'
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53546092066436971)
,p_event_id=>wwv_flow_imp.id(53545072427436971)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_name=>'Get the Generated Content'
,p_static_id=>'get-the-generated-content'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53548053900436973)
,p_event_id=>wwv_flow_imp.id(53545072427436971)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'N'
,p_name=>'Hide the Execution Progress Text Area'
,p_static_id=>'hide-the-execution-progress-text-area'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(73633429156756770)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53547059310436972)
,p_event_id=>wwv_flow_imp.id(53545072427436971)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
,p_name=>'Show the Button Bar with CSV '
,p_static_id=>'show-the-button-bar-with-csv'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(79778777473777280)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53547526711436972)
,p_event_id=>wwv_flow_imp.id(53545072427436971)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
,p_name=>'Show the Success Text Area'
,p_static_id=>'show-the-success-text-area'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(71603615245202045)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53546565549436972)
,p_event_id=>wwv_flow_imp.id(53545072427436971)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
,p_name=>'Show the Text Area with CSV '
,p_static_id=>'show-the-text-area-with-csv'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(79778713439777279)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53545528774436971)
,p_event_id=>wwv_flow_imp.id(53545072427436971)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Stop the Refresh Timer'
,p_static_id=>'stop-the-refresh-timer'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', 'window.clearInterval( gInterval );')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(53543192116436969)
,p_name=>'Toggle Text Field Visibility on Page Load'
,p_static_id=>'toggle-text-field-visibility-on-page-load'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53543624156436970)
,p_event_id=>wwv_flow_imp.id(53543192116436969)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53544187219436970)
,p_event_id=>wwv_flow_imp.id(53543192116436969)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53544684230436971)
,p_event_id=>wwv_flow_imp.id(53543192116436969)
,p_event_result=>'TRUE'
,p_action_sequence=>30
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53540209193436964)
,p_process_sequence=>80
,p_parent_process_id=>wwv_flow_imp.id(53539839502436964)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Clean Data'
,p_static_id=>'clean-data'
,p_process_sql_clob=>'eba_sample_vector_search_pkg.delete_invalid_movie_data'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>11266803279609088
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53475539642471316)
,p_process_sequence=>90
,p_parent_process_id=>wwv_flow_imp.id(53539839502436964)
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Clear Success Message'
,p_static_id=>'clear-success-message'
,p_process_sql_clob=>'apex_application.g_print_success_message := null;'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>11202133728643440
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53539491687436963)
,p_process_sequence=>60
,p_parent_process_id=>wwv_flow_imp.id(53539839502436964)
,p_process_type=>'NATIVE_DATA_LOADING'
,p_process_name=>'Data Load'
,p_static_id=>'data-load'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'data_load_definition_id', wwv_flow_imp.id(65830157951795438),
  'source_data_type', 'TEXT',
  'source_textarea_item', 'P12_AI_OUTPUT')).to_clob
,p_internal_uid=>11266085773609087
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53539839502436964)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(53538419774436962)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79783122172717151)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(81615171826272911)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(53551317457446057)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(53551718206446058)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(53475642830471317)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72151635429349418)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53550176342446054)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(79783122172717151)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53550532121446054)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(79783122172717151)
,p_button_name=>'PREV'
,p_static_id=>'prev'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(53474950749471310)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53552795266446058)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Clean Helper Table'
,p_static_id=>'clean-helper-table'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(53550176342446054)
,p_internal_uid=>11279389352618182
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53553178709446059)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Generate Vectors Embeddings'
,p_static_id=>'generate-vectors-embeddings'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'    l_vector vector;',
'',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77126934675888673)
,p_plug_name=>'Movie Vector Search Navigation'
,p_static_id=>'movie-vector-search-navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges'
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(65855718355070318)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_landmark_label=>'Movie Vector Search'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(87002991065803899)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77126867567890178)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72019741493682969)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(99643329158259090)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72019854661682970)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72019982680682971)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(72019854661682970)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77091240916694120)
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53558701491527133)
,p_region_id=>wwv_flow_imp.id(77091240916694120)
,p_search_config_id=>wwv_flow_imp.id(65844066051923993)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OCI'
,p_static_id=>'basic-vector-search-oci'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(82089930463185607)
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53559560880527133)
,p_region_id=>wwv_flow_imp.id(82089930463185607)
,p_search_config_id=>wwv_flow_imp.id(71169647413821391)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI'
,p_static_id=>'basic-vector-search-openai'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(77092317473694120)
,p_name=>'P15_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72019982680682971)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80875189903209138)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(99643613500261160)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80881126226251214)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84931323435035137)
,p_plug_name=>'Oracle Text'
,p_static_id=>'oracle-text'
,p_parent_plug_id=>wwv_flow_imp.id(80881126226251214)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72023316160687145)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80886551008299594)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(80881126226251214)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(85328964836501784)
,p_plug_name=>'Search Results'
,p_static_id=>'search-results'
,p_parent_plug_id=>wwv_flow_imp.id(84931323435035137)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53566226125531320)
,p_region_id=>wwv_flow_imp.id(85328964836501784)
,p_search_config_id=>wwv_flow_imp.id(53672065833590994)
,p_use_as_initial_result=>false
,p_display_sequence=>22
,p_name=>'Oracle Text Search'
,p_static_id=>'oracle-text-search'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84930870607035133)
,p_plug_name=>'Search Results OCI'
,p_static_id=>'search-results-oci'
,p_parent_plug_id=>wwv_flow_imp.id(84931238231035136)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53564930989531319)
,p_region_id=>wwv_flow_imp.id(84930870607035133)
,p_search_config_id=>wwv_flow_imp.id(65844066051923993)
,p_use_as_initial_result=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(82094691316189795)
,p_plug_name=>'Search Results OPENAI'
,p_static_id=>'search-results-openai'
,p_parent_plug_id=>wwv_flow_imp.id(84931238231035136)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53564097841531318)
,p_region_id=>wwv_flow_imp.id(82094691316189795)
,p_search_config_id=>wwv_flow_imp.id(71169647413821391)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(84931238231035136)
,p_plug_name=>'Vector'
,p_static_id=>'vector'
,p_parent_plug_id=>wwv_flow_imp.id(80881126226251214)
,p_region_template_options=>'#DEFAULT#:t-Region--noUI:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85336013835501801)
,p_name=>'P16_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(80886551008299594)
,p_prompt=>'Search'
,p_placeholder=>'Enter your search term, e.g. Subconscious Mind or Darth Vader'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80882189741213043)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(99643885838262517)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80888237204255622)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79957824026021270)
,p_plug_name=>'Oracle Text not available'
,p_static_id=>'oracle-text-not-available'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--danger'
,p_plug_template=>2040683448887306517
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80894907798318511)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(80888237204255622)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(82101707060192507)
,p_plug_name=>'Search Results'
,p_static_id=>'search-results'
,p_parent_plug_id=>wwv_flow_imp.id(80888237204255622)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53570362950534026)
,p_region_id=>wwv_flow_imp.id(82101707060192507)
,p_search_config_id=>wwv_flow_imp.id(65843083780882145)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Oracle Text And Vector'
,p_static_id=>'oracle-text-and-vector'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85546843581270773)
,p_name=>'P17_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(80894907798318511)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(99644562204267538)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(88419347096558506)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(53631035358816976)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_landmark_type=>'navigation'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74024495664840639)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76034235687529900)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79832314138141209)
,p_plug_name=>'Loaded File'
,p_static_id=>'loaded-file'
,p_parent_plug_id=>wwv_flow_imp.id(74024712055840641)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60876202005736998)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(53158132431989524)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2010149141494510257
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74024673432840640)
,p_plug_name=>'RDS'
,p_static_id=>'rds'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74025287033840646)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74024712055840641)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66031448087403525)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(76034235687529900)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66828141951632873)
,p_branch_name=>'Go To Data Preview'
,p_branch_action=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(66031448087403525)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(74029169883840685)
,p_name=>'P25_FILE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(74025287033840646)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(74029230872840686)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(79841924100141261)
,p_name=>'P25_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(79832314138141209)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(67040961319019821)
,p_computation_sequence=>5
,p_computation_item=>'P25_FILE_NAME'
,p_static_id=>'p25-file-name'
,p_computation_point=>'BEFORE_HEADER'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(78772043977773868)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76763489938084618)
,p_plug_name=>'Loaded File'
,p_static_id=>'loaded-file'
,p_parent_plug_id=>wwv_flow_imp.id(76762520346084609)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(77621094854656355)
,p_name=>'Preview'
,p_static_id=>'preview'
,p_parent_plug_id=>wwv_flow_imp.id(76762520346084609)
,p_template=>4072358936313175081
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66717775925202298)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66715317204202296)
,p_query_column_id=>4
,p_column_alias=>'COL4'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66715746835202297)
,p_query_column_id=>5
,p_column_alias=>'COL5'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66716165719202297)
,p_query_column_id=>6
,p_column_alias=>'COL6'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66716533071202297)
,p_query_column_id=>7
,p_column_alias=>'COL7'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66716974879202297)
,p_query_column_id=>8
,p_column_alias=>'COL8'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(66717364949202298)
,p_query_column_id=>9
,p_column_alias=>'COL9'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(53475389272471314)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(53475417035471315)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(53475127929471312)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60876481268738158)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76762481723084608)
,p_plug_name=>'RDS'
,p_static_id=>'rds'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>3371237801798025892
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(76762520346084609)
,p_plug_name=>'Upload File'
,p_static_id=>'upload-file'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66718600772202299)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(78772043977773868)
,p_button_name=>'NEXT'
,p_static_id=>'next'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66652593584933427)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(78772043977773868)
,p_button_name=>'PREV'
,p_static_id=>'prev'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66733301173584047)
,p_branch_name=>'Go Back To File Upload'
,p_branch_action=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(66652593584933427)
,p_branch_sequence=>20
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(67627169979515943)
,p_branch_name=>'Go To File Vector Embeddings'
,p_branch_action=>'f?p=&APP_ID.:27:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(66718600772202299)
,p_branch_sequence=>30
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76772793593084666)
,p_name=>'P26_FILE_NAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(76763489938084618)
,p_item_default=>'''EBA_VECTOR_DATATABLE'''
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(66719226577202299)
,p_computation_sequence=>10
,p_computation_item=>'P26_FILE_NAME'
,p_static_id=>'p26-file-name'
,p_computation_type=>'QUERY'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select filename',
'  from apex_application_temp_files ',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(66719988549202300)
,p_process_sequence=>90
,p_parent_process_id=>wwv_flow_imp.id(67663848042785449)
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Clear File Cache'
,p_static_id=>'clear-file-cache'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'pages', '25,26',
  'type', 'CLEAR_CACHE_FOR_PAGES')).to_clob
,p_internal_uid=>2748778281243980
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53475764662471318)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(67665129689792932)
,p_process_sequence=>80
,p_parent_process_id=>wwv_flow_imp.id(67663848042785449)
,p_process_type=>'NATIVE_DATA_LOADING'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'data_load_definition_id', wwv_flow_imp.id(65836723645795442),
  'source_data_type', 'FILE',
  'source_file_browse_item', 'P25_FILE')).to_clob
,p_internal_uid=>3693919421834612
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(67663848042785449)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_EXECUTION_CHAIN'
,p_process_name=>'Upload Sample Data'
,p_static_id=>'upload-sample-data'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'run_in_background', 'N')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(66718600772202299)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(78742876240643666)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(64908308291029062)
,p_plug_name=>'Data Uploaded Successfully'
,p_static_id=>'data-uploaded-successfully'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>3371237801798025892
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60876737996739715)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(66655614785933458)
,p_name=>'Summary'
,p_static_id=>'summary'
,p_template=>4072358936313175081
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(67626909247515940)
,p_query_column_id=>1
,p_column_alias=>'ROW_COUNT'
,p_column_display_sequence=>10
,p_column_heading=>'Loaded Row Count'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(67626979315515941)
,p_query_column_id=>2
,p_column_alias=>'VECTOR_COUNT'
,p_column_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66668857914054415)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(78742876240643666)
,p_button_name=>'GENERATE_VECTOR_EMBEDDINGS'
,p_static_id=>'generate-vector-embeddings'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(67625211876515924)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(78742876240643666)
,p_button_name=>'PREV'
,p_static_id=>'prev'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(53475061353471311)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(66669485689054421)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Generate Vectors Embeddings'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(66668857914054415)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(88477531477744675)
,p_plug_name=>'Custom Vector Search Navigation'
,p_static_id=>'custom-vector-search-navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges'
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(53625165565699307)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_landmark_label=>'Custom Vector Search'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75730666775214633)
,p_plug_name=>'Progress'
,p_static_id=>'progress'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-WizardSteps--displayCurrentLabelOnly'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(88478258854748347)
,p_plug_name=>'Ready for Vector Search'
,p_static_id=>'ready-for-vector-search'
,p_region_template_options=>'#DEFAULT#:t-Alert--wizard:t-Alert--defaultIcons:t-Alert--success'
,p_plug_template=>2040683448887306517
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60736543069983718)
,p_plug_name=>'About Basic Vector Search'
,p_static_id=>'about-basic-vector-search'
,p_region_template_options=>'#DEFAULT#:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65798755607977376)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80977610795066727)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80983021441116860)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(80977610795066727)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(86997724154158618)
,p_plug_name=>'Search Results OCI'
,p_static_id=>'search-results-oci'
,p_parent_plug_id=>wwv_flow_imp.id(80977610795066727)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53659238435344029)
,p_region_id=>wwv_flow_imp.id(86997724154158618)
,p_search_config_id=>wwv_flow_imp.id(65845958309939837)
,p_use_as_initial_result=>false
,p_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(82190928081002493)
,p_plug_name=>'Search Results OPENAI'
,p_static_id=>'search-results-openai'
,p_parent_plug_id=>wwv_flow_imp.id(80977610795066727)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(53658382956344027)
,p_region_id=>wwv_flow_imp.id(82190928081002493)
,p_search_config_id=>wwv_flow_imp.id(71169285684818165)
,p_use_as_initial_result=>false
,p_display_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86999939621158641)
,p_name=>'P31_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(80983021441116860)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69587437688505701)
,p_plug_name=>'About Vector vs. Oracle Text Search'
,p_static_id=>'about-vector-vs-oracle-text-search'
,p_region_template_options=>'#DEFAULT#:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74040508315798342)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69593374011547777)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73643571220331700)
,p_plug_name=>'Oracle Text'
,p_static_id=>'oracle-text'
,p_parent_plug_id=>wwv_flow_imp.id(69593374011547777)
,p_region_template_options=>'#DEFAULT#:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_plug_new_grid_row=>false
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60735563945983708)
,p_plug_name=>'Oracle Text not available'
,p_static_id=>'oracle-text-not-available'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--danger'
,p_plug_template=>2040683448887306517
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69598798793596157)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(69593374011547777)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74041212621798347)
,p_plug_name=>'Search Results'
,p_static_id=>'search-results'
,p_parent_plug_id=>wwv_flow_imp.id(73643571220331700)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(66068884350718662)
,p_region_id=>wwv_flow_imp.id(74041212621798347)
,p_search_config_id=>wwv_flow_imp.id(65843533336906768)
,p_use_as_initial_result=>false
,p_display_sequence=>22
,p_name=>'Oracle Text Search'
,p_static_id=>'oracle-text-search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73643118392331696)
,p_plug_name=>'Search Results OCI'
,p_static_id=>'search-results-oci'
,p_parent_plug_id=>wwv_flow_imp.id(73643486016331699)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>1555738898046108210
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(66067212150718657)
,p_region_id=>wwv_flow_imp.id(73643118392331696)
,p_search_config_id=>wwv_flow_imp.id(65845958309939837)
,p_use_as_initial_result=>false
,p_display_sequence=>20
,p_name=>'Basic Vector Search OCI Datatable'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70806939101486358)
,p_plug_name=>'Search Results OPENAI'
,p_static_id=>'search-results-openai'
,p_parent_plug_id=>wwv_flow_imp.id(73643486016331699)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(70807094097486359)
,p_region_id=>wwv_flow_imp.id(70806939101486358)
,p_search_config_id=>wwv_flow_imp.id(71169285684818165)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Basic Vector Search OPENAI Datatable'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(73643486016331699)
,p_plug_name=>'Vector'
,p_static_id=>'vector'
,p_parent_plug_id=>wwv_flow_imp.id(69593374011547777)
,p_region_template_options=>'#DEFAULT#:t-Region--noUI:t-Region--scrollBody'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(74046513029798361)
,p_name=>'P32_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(69598798793596157)
,p_prompt=>'Search'
,p_placeholder=>'Enter your search term, e.g. Testing'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69587691605506896)
,p_plug_name=>'About Vector and Oracle Text Search'
,p_static_id=>'about-vector-and-oracle-text-search'
,p_region_template_options=>'#DEFAULT#:t-Region--textContent:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74248268874564612)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69593739068549475)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(68663325890315123)
,p_plug_name=>'Oracle Text not available'
,p_static_id=>'oracle-text-not-available'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--danger'
,p_plug_template=>2040683448887306517
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69600409662612364)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(69593739068549475)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70807208924486360)
,p_plug_name=>'Search Results'
,p_static_id=>'search-results'
,p_parent_plug_id=>wwv_flow_imp.id(69593739068549475)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(70807227563486361)
,p_region_id=>wwv_flow_imp.id(70807208924486360)
,p_search_config_id=>wwv_flow_imp.id(53669905314501992)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Oracle Text And Vector Datatable'
,p_static_id=>'oracle-text-and-vector-datatable'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(74250626250564624)
,p_name=>'P33_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(69600409662612364)
,p_prompt=>'Search'
,p_placeholder=>'Enter your search term, e.g. Testing'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69611527567912190)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65819515600134476)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69607750226878911)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69608111818880660)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(69607750226878911)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(66086412445907623)
,p_plug_name=>'Search Results OCI'
,p_static_id=>'search-results-oci'
,p_parent_plug_id=>wwv_flow_imp.id(69607750226878911)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(66086573941907624)
,p_region_id=>wwv_flow_imp.id(66086412445907623)
,p_search_config_id=>wwv_flow_imp.id(65842357635845596)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Movie Recommendation'
,p_static_id=>'movie-recommendation'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70807533524486364)
,p_plug_name=>'Search Results OPENAI'
,p_static_id=>'search-results-openai'
,p_parent_plug_id=>wwv_flow_imp.id(69607750226878911)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(70807695391486365)
,p_region_id=>wwv_flow_imp.id(70807533524486364)
,p_search_config_id=>wwv_flow_imp.id(71168614192809868)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Movie Recommendation'
,p_static_id=>'movie-recommendation'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(66086240910907621)
,p_name=>'P41_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(69608111818880660)
,p_prompt=>'Search'
,p_source_type=>'ALWAYS_NULL'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(66086914559907628)
,p_name=>'Submit Page'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(66087032947907629)
,p_event_id=>wwv_flow_imp.id(66086914559907628)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Refresh Search Results OCI'
,p_static_id=>'refresh-search-results-oci'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(66086412445907623)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53160721377746433)
,p_event_id=>wwv_flow_imp.id(66086914559907628)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_name=>'Refresh Search Results OpenAI'
,p_static_id=>'refresh-search-results-openai'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(70807533524486364)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'maintain_pagination', 'N')).to_clob
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69611840864913137)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65820907737138166)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69609746349902083)
,p_plug_name=>'Content'
,p_static_id=>'content'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69609079750892011)
,p_plug_name=>'Search'
,p_static_id=>'search'
,p_parent_plug_id=>wwv_flow_imp.id(69609746349902083)
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--noUI:t-Region--scrollBody'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(66086725882907626)
,p_plug_name=>'Search Results OCI'
,p_static_id=>'search-results-oci'
,p_parent_plug_id=>wwv_flow_imp.id(69609746349902083)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(66086825040907627)
,p_region_id=>wwv_flow_imp.id(66086725882907626)
,p_search_config_id=>wwv_flow_imp.id(65844066051923993)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Vector Comparison'
,p_static_id=>'vector-comparison'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(70807734648486366)
,p_plug_name=>'Search Results OPENAI'
,p_static_id=>'search-results-openai'
,p_parent_plug_id=>wwv_flow_imp.id(69609746349902083)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_search_region_source(
 p_id=>wwv_flow_imp.id(70807891980486367)
,p_region_id=>wwv_flow_imp.id(70807734648486366)
,p_search_config_id=>wwv_flow_imp.id(71169647413821391)
,p_use_as_initial_result=>false
,p_display_sequence=>10
,p_name=>'Vector Comparison'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(66086696870907625)
,p_name=>'P42_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(69609079750892011)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1632339827977343920)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38971890036248619)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(38972618549248626)
,p_region_id=>wwv_flow_imp.id(38971890036248619)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53786692471488959)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1632339827977343920)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(53800509039520993)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(53799459829520982)
,p_name=>'P49_SEARCH_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38971890036248619)
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
,p_protection_level=>'S'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53800448497520992)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(53786692471488959)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65804047767994829)
...
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_list_id=>wwv_flow_imp.id(65850476759035031)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
,p_landmark_type=>'navigation'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65822185880145099)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(69986238063801846)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75561748106388116)
,p_plug_name=>'Buttons'
,p_static_id=>'buttons'
,p_parent_plug_id=>wwv_flow_imp.id(75561641102388115)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75561641102388115)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66055986694577075)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(75561748106388116)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66055559129577075)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(75561748106388116)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66059612175577079)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(66058805280577078)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(66055559129577075)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3945215700717667690)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5926101476354756160)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(66436752411508773)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(5926101476354756160)
,p_button_name=>'SAVE'
,p_static_id=>'save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(66439873575508795)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(66436752411508773)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2523330000170227418)
,p_name=>'P52_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(5926101476354756160)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(66439385366508793)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(66436752411508773)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(54153960995600336)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72603654465756099)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65669657464293394)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72603498012756097)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72603592922756098)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(72603382270756096)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(90440113688576848)
,p_plug_name=>'Web Credentials'
,p_static_id=>'web-credentials'
,p_parent_plug_id=>wwv_flow_imp.id(72603498012756097)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(54153440136600334)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(72603654465756099)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(54142441319600305)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(65669657464293394)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(54165716226600364)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97367319570399964)
,p_name=>'P54_AI_PROVIDER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(72603382270756096)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98372751173083394)
,p_name=>'P54_OCI_COMPARTMENT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72603498012756097)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97404485924500905)
,p_name=>'P54_OCI_FINGERPRINT'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(90440113688576848)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97404257801500903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(98372676302083393)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97404360849500904)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97404181596500902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90447765420576908)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97410057400502409)
,p_name=>'P54_OPENAI_API_KEY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(72603592922756098)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(79510959991868824)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(90443466020576901)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54157470891600353)
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(54153440136600334)
,p_associated_item=>wwv_flow_imp.id(98372751173083394)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54157019497600353)
...
,p_when_button_pressed=>wwv_flow_imp.id(54153440136600334)
,p_associated_item=>wwv_flow_imp.id(97404485924500905)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54155861575600352)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(54153440136600334)
,p_associated_item=>wwv_flow_imp.id(97404257801500903)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54156281768600353)
...
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(54153440136600334)
,p_associated_item=>wwv_flow_imp.id(98372676302083393)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54156685098600353)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(54153440136600334)
,p_associated_item=>wwv_flow_imp.id(97404360849500904)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54155463947600352)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(54153440136600334)
,p_associated_item=>wwv_flow_imp.id(97404181596500902)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(54157840630600354)
...
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(54142441319600305)
,p_associated_item=>wwv_flow_imp.id(97410057400502409)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(54160804216600360)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54164724421600362)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>40
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(72603654465756099)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54161205982600360)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(65669657464293394)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54164235535600362)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(72603498012756097)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54163749495600362)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(72603592922756098)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54162727092600361)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54165258881600363)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54161783364600360)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54163252455600362)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54162286705600361)
,p_event_id=>wwv_flow_imp.id(54160804216600360)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(54159380180600357)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54160363933600359)
,p_event_id=>wwv_flow_imp.id(54159380180600357)
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(90440113688576848)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(54159899834600359)
,p_event_id=>wwv_flow_imp.id(54159380180600357)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53572473461776274)
,p_process_sequence=>100
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(54153440136600334)
,p_internal_uid=>11528594944693131
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53572607400776275)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(54142441319600305)
,p_internal_uid=>11528461005693130
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(54158549213600355)
,p_process_sequence=>90
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(54158203612600354)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53572376227776273)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60735224132983705)
,p_plug_name=>'Button OCI'
,p_static_id=>'button-oci'
,p_parent_plug_id=>wwv_flow_imp.id(40923587417427954)
,p_region_css_classes=>'step-container'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>60
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(53801227131521000)
,p_plug_name=>'Button OPENAI'
,p_static_id=>'button-openai'
,p_parent_plug_id=>wwv_flow_imp.id(40923587417427954)
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60735067679983703)
,p_plug_name=>'Enter OCI Web Credentials'
,p_static_id=>'enter-oci-web-credentials'
,p_title=>'Enter Web Credentials'
,p_parent_plug_id=>wwv_flow_imp.id(40923587417427954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60735162589983704)
,p_plug_name=>'Enter OpenAI Web Credentials'
,p_static_id=>'enter-openai-web-credentials'
,p_title=>'Enter Web Credentials'
,p_parent_plug_id=>wwv_flow_imp.id(40923587417427954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60734810794983700)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(40923587417427954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60734951937983702)
,p_plug_name=>'Select Provider'
,p_static_id=>'select-provider'
,p_title=>'Select AI Provider'
,p_parent_plug_id=>wwv_flow_imp.id(40923587417427954)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(40923693057427955)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(78571683355804454)
,p_plug_name=>'Web Credentials'
,p_static_id=>'web-credentials'
,p_parent_plug_id=>wwv_flow_imp.id(60735067679983703)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader js-removeLandmark:t-Region--noBorder:t-Region--hiddenOverflow'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>40
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(60734822309983701)
,p_plug_name=>'Welcome to Sample Vector Search'
,p_static_id=>'welcome-to-sample-vector-search'
,p_parent_plug_id=>wwv_flow_imp.id(60734810794983700)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(60735380276983706)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(60735224132983705)
,p_button_name=>'COMPLETE_OCI'
,p_static_id=>'complete-oci'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(53801367081521001)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(53801227131521000)
,p_button_name=>'COMPLETE_OPENAI'
,p_static_id=>'complete-openai'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(60735515001983707)
,p_branch_name=>'Go to Home Page'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85496624278627523)
,p_name=>'P100_AI_PROVIDER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(60734951937983702)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86501397949310950)
,p_name=>'P100_OCI_COMPARTMENT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(60735067679983703)
,p_prompt=>'Compartment ID'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>80
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85530837500728456)
,p_name=>'P100_OCI_FINGERPRINT'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(78571683355804454)
,p_prompt=>'OCI Public Key Fingerprint'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>80
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85530609377728454)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(86501323078310949)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85530712425728455)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85530533172728453)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(78574116996804459)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(85531988283729955)
,p_name=>'P100_OPENAI_API_KEY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(60735162589983704)
,p_prompt=>'OpenAI API Key'
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_PASSWORD'
,p_cSize=>80
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(67632890875096370)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(78572112796804457)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53473129572471292)
,p_validation_name=>'P100_OCI_COMPARTMENT_ID not null'
,p_static_id=>'p100-oci-compartment-id-not-null'
,p_validation_sequence=>20
,p_validation=>'P100_OCI_COMPARTMENT_ID'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(60735380276983706)
,p_associated_item=>wwv_flow_imp.id(86501397949310950)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53473053659471291)
,p_validation_name=>'P100_OCI_FINGERPRINT not null'
,p_static_id=>'p100-oci-fingerprint-not-null'
,p_validation_sequence=>70
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(60735380276983706)
,p_associated_item=>wwv_flow_imp.id(85530837500728456)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53472558870471286)
,p_validation_name=>'P100_OCI_PRIVATE_KEY not null'
,p_static_id=>'p100-oci-private-key-not-null'
,p_validation_sequence=>50
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(60735380276983706)
,p_associated_item=>wwv_flow_imp.id(85530609377728454)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53473290637471293)
,p_validation_name=>'P100_OCI_REGION not null'
,p_static_id=>'p100-oci-region-not-null'
,p_validation_sequence=>30
,p_validation=>'P100_OCI_REGION'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(60735380276983706)
,p_associated_item=>wwv_flow_imp.id(86501323078310949)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53472963247471290)
,p_validation_name=>'P100_OCI_TENANCY_ID not null'
,p_static_id=>'p100-oci-tenancy-id-not-null'
,p_validation_sequence=>60
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(60735380276983706)
,p_associated_item=>wwv_flow_imp.id(85530712425728455)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53472490465471285)
,p_validation_name=>'P100_OCI_USER_ID not null'
,p_static_id=>'p100-oci-user-id-not-null'
,p_validation_sequence=>10
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_imp.id(60735380276983706)
,p_associated_item=>wwv_flow_imp.id(85530533172728453)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(53473372982471294)
,p_validation_name=>'P100_OPENAI_API_KEY not null'
,p_static_id=>'p100-openai-api-key-not-null'
,p_validation_sequence=>40
,p_validation=>'P100_OPENAI_API_KEY'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'#LABEL# must have a value.'
,p_when_button_pressed=>wwv_flow_imp.id(53801367081521001)
,p_associated_item=>wwv_flow_imp.id(85531988283729955)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(56054031755934471)
,p_name=>'Change AI Provider'
,p_static_id=>'change-ai-provider'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53474177178471302)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
,p_name=>'Hide Complete Button OCI'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(60735224132983705)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53801449978521002)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(53801227131521000)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53473796354471298)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(60735067679983703)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53474028987471301)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(60735162589983704)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(56053966172934470)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'items_to_submit', 'P100_AI_PROVIDER',
  'language', 'PLSQL',
  'plsql_code', wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53474263620471303)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53801547467521003)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>90
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53473979047471300)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(53473868766471299)
,p_event_id=>wwv_flow_imp.id(56054031755934471)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(60804360280654715)
,p_name=>'Toggle Switch Visibility'
,p_static_id=>'toggle-switch-visibility'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(60805227695654718)
,p_event_id=>wwv_flow_imp.id(60804360280654715)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_static_id=>'native-hide'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(78571683355804454)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(60804798714654717)
,p_event_id=>wwv_flow_imp.id(60804360280654715)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(60735651301983709)
,p_process_sequence=>90
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Complete OCI'
...
,p_process_error_message=>'Invalid web credentials: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(60735380276983706)
,p_process_success_message=>'Success: Web credentials verified successfully.'
,p_internal_uid=>7713632804735014
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(53801640334521004)
,p_process_sequence=>100
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Complete Open AI'
...
,p_process_error_message=>'Invalid web credentials: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(53801367081521001)
,p_process_success_message=>'Success: Web credentials verified successfully.'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(65538959428837230)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(65540629727837240)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(65538959428837230)
,p_button_name=>'LOGIN'
,p_static_id=>'login'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65539857806837239)
,p_name=>'P9999_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(65538959428837230)
,p_prompt=>'Password'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65540255301837239)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(65539489262837238)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(65544748451837243)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(65544332636837243)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(65540988930837241)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(65541969444837242)
,p_page_process_id=>wwv_flow_imp.id(65540988930837241)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(65542428257837242)
,p_page_process_id=>wwv_flow_imp.id(65540988930837241)
,p_page_id=>9999
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(65541412917837241)
,p_page_process_id=>wwv_flow_imp.id(65540988930837241)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(65542857423837242)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(65543905690837243)
,p_page_process_id=>wwv_flow_imp.id(65542857423837242)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
,p_data_type=>'BOOLEAN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(65543392107837243)
,p_page_process_id=>wwv_flow_imp.id(65542857423837242)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(71020414480087221)
,p_deinstall_script_clob=>wwv_flow_imp.varchar2_to_clob(wwv_flow_imp.g_varchar2_table)
,p_last_updated_on=>wwv_flow_imp.dz('20260519121751Z')
);
end;
/
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(71025524072079072)
,p_install_id=>wwv_flow_imp.id(71020414480087221)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(54320001117121007)
,p_install_id=>wwv_flow_imp.id(71020414480087221)
...
wwv_flow_imp_shared.create_install_check(
 p_id=>wwv_flow_imp.id(71027027835334745)
,p_install_id=>wwv_flow_imp.id(71020414480087221)
...
wwv_flow_imp_shared.create_install_check(
 p_id=>wwv_flow_imp.id(60682690817613511)
,p_install_id=>wwv_flow_imp.id(71020414480087221)
