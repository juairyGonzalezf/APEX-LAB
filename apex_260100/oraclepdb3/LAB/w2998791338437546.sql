...
wwv_flow_fnd_user_api.create_fnd_user (
  ...
  p_account_locked               => 'N',
  p_account_expiry               => to_date('202605151302','YYYYMMDDHH24MI'),
...
begin
  wwv_imp_workspace.create_preferences$ (
    p_id => 4164469222203649,
    p_user_id => 'GONZALEZFJU',
    p_preference_name => 'APEX$SHOW_ENABLE_AI_ALERT',
    p_attribute_value => 'N',
    p_tenant_id => '');
end;
/
...
begin
  wwv_imp_workspace.create_preferences$ (
    p_id => 2564637327064797,
    p_user_id => 'GONZALEZFJU',
    p_preference_name => 'APEX_THEME_STYLE_A4320T3',
    p_attribute_value => '560457475065358618',
    p_tenant_id => '');
end;
/
begin
  wwv_imp_workspace.create_preferences$ (
    p_id => 2564743801064797,
    p_user_id => 'GONZALEZFJU',
...
begin
  wwv_imp_workspace.create_preferences$ (
    p_id => 4380709709293319,
    p_user_id => 'GONZALEZFJU',
    p_preference_name => 'EXPORT_MODE',
    p_attribute_value => 'MIG',
    p_tenant_id => '');
end;
/
begin
  wwv_imp_workspace.create_preferences$ (
    p_id => 4380622738293319,
    p_user_id => 'GONZALEZFJU',
    p_preference_name => 'EXPORT_TYPE',
    p_attribute_value => 'APEXLANG',
    p_tenant_id => '');
end;
/
begin
  wwv_imp_workspace.create_preferences$ (
    ...
    p_attribute_value => '304',
    p_tenant_id => '');
end;
/
begin
  wwv_imp_workspace.create_preferences$ (
    p_id => 5587508769457185,
    p_user_id => 'GONZALEZFJU',
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 304,
    p_owner => 'APEXPDB',
    p_access_date => to_date('202605190644','YYYYMMDDHH24MI'),
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_240100',
    p_access_date => to_date('202605111034','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.150',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_240100',
    p_access_date => to_date('202605151302','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.150',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 3,
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_260100',
    p_access_date => to_date('202605181701','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.150',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_260100',
    p_access_date => to_date('202605181826','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.150',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_260100',
    p_access_date => to_date('202605190640','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.150',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log1$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_260100',
    p_access_date => to_date('202605181402','YYYYMMDDHH24MI'),
    p_ip_address => '10.0.2.150',
    p_remote_user => 'APEX_PUBLIC_USER',
    p_auth_result => 0,
    p_custom_status_text => '');
...
begin
  wwv_imp_workspace.create_user_access_log2$ (
    ...
    p_app => 4100,
    p_owner => 'APEX_240100',
    p_access_date => to_date('202604271007','YYYYMMDDHH24MI'),
...
--
-- Import using sqlplus as the Oracle user: APEX_260100
-- Exported 06:50 Tuesday May 19, 2026 by: 
--
